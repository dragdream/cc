...
public class NoClobRowProcessor implements RowProcessor {
     ...
     * @return
     */
    protected Object filterClob(Object object){
    	try{
        	if(object instanceof Clob){
    			...
    			return b;
    		}else if(object instanceof oracle.sql.DATE){
    			oracle.sql.DATE date=(oracle.sql.DATE)object;
    			Calendar c = Calendar.getInstance();
    			Timestamp timestamp = date.timestampValue();
    			c.setTimeInMillis(timestamp.getTime());
    			return c;
    		}else if(object instanceof oracle.sql.TIMESTAMP){
    			oracle.sql.TIMESTAMP date=(oracle.sql.TIMESTAMP)object;
    			Calendar c = Calendar.getInstance();
    			Timestamp timestamp = date.timestampValue();
    			c.setTimeInMillis(timestamp.getTime());
    			return c;
    			...
    			java.sql.Time date=(java.sql.Time)object;
    			Calendar c = Calendar.getInstance();
    			c.setTimeInMillis(date.getTime());
    			return c;
    ...
    public Map<String, Object> toMap(ResultSet rs) throws SQLException {
        ...
        for (int i = 1; i <= cols; i++) {
            result.put(rsmd.getColumnLabel(i),filterClob(rs.getObject(i)));
        }
