...
public class ImageHunter
{
  ...
  public State captureRemoteData(String urlStr)
  {
    ...
    try
    {
      ...
      TeeAttachment attachment = baseUpload.singleAttachUpload(connection.getInputStream(), maxSize, this.filename+"."+suffix, "", TeeAttachmentModelKeys.imgupload, null);
      State state = new BaseState();

      if (state.isSuccess()) {
        state.putInfo("url", "/attachmentController/downFile.action?id="+attachment.getSid());
