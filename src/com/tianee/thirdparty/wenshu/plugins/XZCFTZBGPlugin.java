 ...
 * 行政处罚听证报告(23)
 * */
public class XZCFTZBGPlugin extends TeeWenShuPlugin{
...
//		data.put("其他人员", "小红、小米");
//		//案件基本情况
//		data.put("案件基本情况", "关于XXX案情");
//		//办理人员意见
//		data.put("办理人员意见", "同意");
//		//陈述理由要求
//		data.put("陈述理由要求", "关于XXX要求");
//		//行政机关处理意见
//		data.put("行政机关处理意见", "同意");
//		//主持人签名
//		data.put("主持人签名", img);
//		//签名时间
//		data.put("签名时间", "2018年10月16日");
		//主持人签名
		String zcrqm = data.get("主持人签名");
		data.remove("主持人签名");
		...
		//判断签名是否存在
		if(!TeeUtility.isNullorEmpty(zcrqm)){
			String scriptRun = "jacob.setBookMarksPicture(\"主持人签名\",\""+zcrqm+"\",6,-1,30)";
