 ...
 * 案件处理呈批表 (31)
 * */
public class AJCLCPBPlugin extends TeeWenShuPlugin{
...
//		data.put("当事人名称", "王小明");
//	    //证件号码
//		data.put("证件号码", "976567899");
//		//当事人类型
//		data.put("当事人类型", "职员");
//		//当事人联系电话
//		data.put("当事人联系电话", "0998776");
//		//当事人住址
//		data.put("当事人住址", "北京海淀区");
//		//案件来源
//		data.put("案件来源", "群众");
//		//案由
//		data.put("案由", "XXX案由");
//		//检查日期
//		data.put("检查日期", "2018年10月16日");
//		//立案日期
//		data.put("立案日期", "2018年10月16日");
//		//情况内容
//		data.put("情况内容", "XXX情况内容");
//		//申辩情况
//		data.put("申辩情况", "XXX申辩情况");
//		//处罚情况
//		data.put("处罚情况", "XXX处罚情况");
//		//承办人意见
//		data.put("承办人意见", "同意");
//		//主办人签名
//		data.put("主办人签名", img);
...
//		data.put("协办人签名", img);
//		//承办人签名日期
//		data.put("承办人签名日期", "2018年10月16日");
//		//承办部门意见
//		data.put("承办部门意见", "同意");
//		//承办部门签名
//		data.put("承办部门签名", img);
//		//承办部门签名日期
//		data.put("承办部门签名日期", "2018年10月16日");
//		//法制部门意见
//		data.put("法制部门意见", "同意");
//		//法制部门签名 
//		data.put("法制部门签名", img);
//		//法制部门签字日期
//		data.put("法制部门签字日期", "2018年10月16日");
//		//主管领导意见
//		data.put("主管领导意见", "同意同意同意同意同意同意同意同意同意同意同意同意同意同意同意同意同意同意同意同意同意");
//		//主管领导签名
//		data.put("主管领导签名", img);
//		//主管领导签名日期
//		data.put("主管领导签名日期", "2018年10月16日");
		
		//主办人签名
		String zbrqm = data.get("主办人签名");
		data.remove("主办人签名");
		//协办人签名
	    String xbrqm = data.get("协办人签名");
		data.remove("协办人签名");
		//承办部门签名
	    String cbbuqm = data.get("承办部门签名");
		data.remove("承办部门签名");
		//法制部门签名 
	    String fzbuqm = data.get("法制部门签名");
		data.remove("法制部门签名");
		//主管领导签名
	    String zgldqm = data.get("主管领导签名");
		data.remove("主管领导签名");
		...
		if(!TeeUtility.isNullorEmpty(zbrqm)){
			String scriptRun = "jacob.setBookMarksPicture(\"主办人签名\",\""+zbrqm+"\",6,-1,30)";
			response = jacobRequest.scriptRun(scriptRun, newWordId);
			newWordId = response.fileId;
		}
		
		if(!TeeUtility.isNullorEmpty(xbrqm)){
		    String scriptRun = "jacob.setBookMarksPicture(\"协办人签名\",\""+xbrqm+"\",6,-1,30)";
			response = jacobRequest.scriptRun(scriptRun, newWordId);
			newWordId = response.fileId;
		}
		
		if(!TeeUtility.isNullorEmpty(cbbuqm)){
			String scriptRun = "jacob.setBookMarksPicture(\"承办部门签名\",\""+cbbuqm+"\",6,-1,30)";
			response = jacobRequest.scriptRun(scriptRun, newWordId);
			newWordId = response.fileId;
		}
		
		if(!TeeUtility.isNullorEmpty(fzbuqm)){
			String scriptRun = "jacob.setBookMarksPicture(\"法制部门签名\",\""+fzbuqm+"\",6,-1,30)";
			response = jacobRequest.scriptRun(scriptRun, newWordId);
			newWordId = response.fileId;
		}
		
		if(!TeeUtility.isNullorEmpty(zgldqm)){
			String scriptRun = "jacob.setBookMarksPicture(\"主管领导签名\",\""+zgldqm+"\",6,-1,30)";
			response = jacobRequest.scriptRun(scriptRun, newWordId);
			newWordId = response.fileId;
		}
