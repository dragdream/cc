 ...
 * 行政处罚事先告知书(14)
 * */
public class XZCFSXGZSPlugin extends TeeWenShuPlugin{
...
//		data.put("案由", "违法");
//		//违法行为发生期间
//		data.put("违法行为发生期间", "2018年10月16日");
//		//违法行为
//		data.put("违法行为", "盗窃");
//		//法规条款
//		data.put("法规条款", "人民法律条款");
//		//处罚条款
//		data.put("处罚条款", "100元");
//		//处罚内容
//		data.put("处罚内容", "罚款");
...
//		//当事人签名时间
//		data.put("当事人签名时间", "2018年10月16日");
//		//行政机构盖章时间
//		data.put("行政机构盖章时间", "2018年10月16日");
		//主办人签名
		String zbrqm = data.get("当事人签名");
		data.remove("当事人签名");
		...
		if(!TeeUtility.isNullorEmpty(zbrqm)){
			String scriptRun = "jacob.setBookMarksPicture(\"当事人签名\",\""+zbrqm+"\",6,-1,30)";
