 ...
 * 证据材料移送清单(27)
 * */
public class ZJCLYSQDPlugin extends TeeWenShuPlugin{
...
//		data.put("文件内容", "关于XXX");
//		//文件备注
//		data.put("文件备注", "关于XXX备注");
//		//资产内容
//		data.put("资产内容", "关于XXX资产内容");
//		//资产备注
//		data.put("资产备注", "关于XXX资产备注");
//		//其他类内容
//		data.put("其他类内容", "关于XXX其他类内容");
//		//其他类备注
//		data.put("其他类备注", "关于XXX其他类备注");
//		//移送人签名
//		data.put("移送人签名", img);
//		//移送单位
//		data.put("移送单位", "XXX单位");
//		//移送人签字日期
//		data.put("移送人签字日期", "2018年10月16日");
//		//接收人签名
//		data.put("接收人签名", img);
//		//接收单位
//		data.put("接收单位", "XXX单位");
//		//接收人签字日期
//		data.put("接收人签字日期", "2018年10月16日");
		//移送人签名
		String ysrqm = data.get("移送人签名");
		data.remove("移送人签名");
		//接收人签名
		...
		//判断签名是否存在
		if(!TeeUtility.isNullorEmpty(ysrqm)){
			String scriptRun = "jacob.setBookMarksPicture(\"移送人签名\",\""+ysrqm+"\",6,-1,30)";
