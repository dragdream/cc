 ...
 * 案件移送单  (25)
 * */
public class AJYSDPlugin extends TeeWenShuPlugin{
...
//		data.put("当事人姓名", "王小明");
//		data.put("当事人类型", "职工");
//		data.put("联系电话", "0000000000000");
//		data.put("当事人住址", "北京海淀区");
//		data.put("案由", "关于XXX");
//		data.put("案件来源", "群众");
//		data.put("案情概要", "关于XXX案情");
//		data.put("移送清单文号", "001文2018年001号");
//		data.put("移送单位意见", "同意");
//		data.put("移送主办人签名", img);
//		data.put("移送协办人签名", img);
//		data.put("移送单位联系电话", "99999999999");
//		data.put("移送单位", "中国政府");
//		data.put("移送单位签字日期", "2018年10月16日");
//		data.put("接收人签名", img);
//		data.put("接收人联系电话", "333333333333");
//		data.put("接收单位", "人民法院");
//		data.put("接收单位签字日期", "2018年10月16日");
		
		//移送主办人签名
		String yszbrqm = data.get("移送主办人签名");
		data.remove("移送主办人签名");
		//移送协办人签名
	    String ysxbrqm = data.get("移送协办人签名");
		data.remove("移送协办人签名");
		//接收人签名
	    String jsrqm = data.get("接收人签名");
		data.remove("接收人签名");
		...
		if(!TeeUtility.isNullorEmpty(yszbrqm)){
			String scriptRun = "jacob.setBookMarksPicture(\"移送主办人签名\",\""+yszbrqm+"\",6,-1,30)";
			response = jacobRequest.scriptRun(scriptRun, newWordId);
			newWordId = response.fileId;
		}
		
		if(!TeeUtility.isNullorEmpty(ysxbrqm)){
			String scriptRun = "jacob.setBookMarksPicture(\"移送协办人签名\",\""+ysxbrqm+"\",6,-1,30)";
			response = jacobRequest.scriptRun(scriptRun, newWordId);
			newWordId = response.fileId;
		}
		
		if(!TeeUtility.isNullorEmpty(jsrqm)){
			String scriptRun = "jacob.setBookMarksPicture(\"接收人签名\",\""+jsrqm+"\",6,-1,30)";
			response = jacobRequest.scriptRun(scriptRun, newWordId);
			newWordId = response.fileId;
		}
