package com.tianee.thirdparty.newcapec.supwisdom;
...
import com.tianee.thirdparty.newcapec.supwisdom.CommonUtils.Base64Utils;
import com.tianee.thirdparty.newcapec.supwisdom.CommonUtils.BooleanUtils;
import com.tianee.thirdparty.newcapec.supwisdom.CommonUtils.HttpRequestUtils;
import com.tianee.thirdparty.newcapec.supwisdom.CommonUtils.StringUtils;
...
public class CASUtils {
	...
	public static String getTargetUrl(HttpServletRequest request) {
		...
		if (StringUtils.isEmpty(targetUrl)) {
			...
			targetUrl = TeeSysCustomerProps.getString("SSO_ADDR_");
		} else {
			// 判断target是否编码
