...
public class TeeWeather {
    ...
    public TeeWeather(String Cityid) throws IOException ,NullPointerException{ 
        // 解析本机ip地址 
        ...
        try { 
           ...
           // datas = new String(datas.getBytes("iso-8859-1") , "GBK");
...
break;
    ...
    public static void main(String[] args) { 
        try { 
            new TeeWeather("101010100"); // 101010100(北京)就是你的城市代码
        } catch (Exception e) { 
            e.printStackTrace(); 
        } 
    } 
