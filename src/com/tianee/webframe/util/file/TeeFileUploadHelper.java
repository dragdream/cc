...
// * @desc
// */
//public class TeeFileUploadHelper {
//
//	/**
//	 * 文件列表
//	 */
...
//		// 设置允许用户上传文件大小,单位:字节
//		 fu.setSizeMax(maxSize * TeeConst.M);
//		// maximum size that will be stored in memory?
//		// 设置最多只允许在内存中存储的数据,单位:字节
//		fu.setSizeThreshold(buffSize);
//		// 设置一旦文件大小超过getSizeThreshold()的值时数据存放在硬盘的目录
//		 if (!TeeUtility.isNullorEmpty(tempPath)) {
...
//	    return TeeFileUtility.getFileExtName(fileItem.getName());
//	  }
//	  
//	  /**
//	   * 取得文件的扩展名
...
//	    return TeeFileUtility.getFileNameNoExt(fileName);
//	  }
//	  
//	  /**
//	   * 取得文件的名称
...
//	    return TeeFileUtility.getFileName(fileItem.getName());
//	  }
//	  
//	  /**
//	   * 取得文件的名称
