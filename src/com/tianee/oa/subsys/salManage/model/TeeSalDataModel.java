...
public class TeeSalDataModel extends TeeBaseModel{
...
private double s81;
	...
	public int getSalFlowId() {
		return salFlowId;
	}

	public void setSalFlowId(int salFlowId) {
		this.salFlowId = salFlowId;
	}
