...
@Entity
@Table(name = "HR_SAL_DATA_PERSON")
public class TeeSalDataPerson {
	
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator="HR_SAL_DATA_P_seq_gen")
	@SequenceGenerator(name="HR_SAL_DATA_P_seq_gen", sequenceName="HR_SAL_DATA_P_seq")
	...
	@ManyToOne()
	@Index(name="IDX9210e022034b4fc7a3e15e378e8")
	@JoinColumn(name="USER_ID")
	private TeePerson user;//上报人
	...
	@Column(name="INSURANCE_OTHER" ,columnDefinition="INT default 0" ,nullable=false)
	private int insuranceOther ;//是否投保
	
	@Column(name="IS_DEPT_INPUT" ,columnDefinition="INT default 0" ,nullable=false)
	private int isDeptInput ;//是否已经部门上报(1-是,0-否)
	
	@Column(name="IS_FINA_INPUT" ,columnDefinition="INT default 0" ,nullable=false)
