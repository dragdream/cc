 ...
 */
@Entity
@Table(name = "DOCUMENT_VIEW_REC")
public class TeeDocumentViewRecord {
	@Id
	...
	@Column(name="is_read_remind")
	private int isReadRemind;//是否进行签阅消息提醒  0不提醒  1提醒
	...
	public int getIsReadRemind() {
		return isReadRemind;
	}

	public void setIsReadRemind(int isReadRemind) {
		this.isReadRemind = isReadRemind;
	}
