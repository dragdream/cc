...
public class TeeDocumentView {
	...
	private TeeDocumentViewRecord record;
	...
	public TeeDocumentViewRecord getRecord() {
		return record;
	}

	public void setRecord(TeeDocumentViewRecord record) {
		this.record = record;
	}
