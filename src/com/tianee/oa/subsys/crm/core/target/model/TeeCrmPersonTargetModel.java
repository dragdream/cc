...
public class TeeCrmPersonTargetModel {
	  ...
	  private String crUserId;// 创建人
      private String crUserName;// 创建人名称
	  private String targetUserName;//部门名称
      private int targetUserId;//部门排序号(用户同一级次部门排序)
	...
	public void setCrUserId(String string) {
		this.crUserId = string;
	}
