package com.tianee.oa.subsys.crm.setting;
...
public class TeeCrmCodeManager {
	public static final String codeSettingPath = "类型值可在“客户管理”->“维护设置”->参数类型设置中设置。";
	public static Cache cache;
	public TeeCrmCodeManager() {
		// TODO Auto-generated constructor stub
		
	}
	static {
		cache = TeeCacheManager.getCache("crmCode");
	}
	...
	public static  void createSysCodeCache(Connection conn ){
		...
		if(cache != null && conn != null ){
			...
			ResultSet rs = null;
			String sql = "select * FROM  CRM_CODE  order by PARENT_ID , CODE_ORDER";
			try{
	 ...
	 */
	public  void updateChildSysCodeElement(String oldParentCodeNo ,String parentCodeNo , String oldCodeNo , TeeCrmCode code){
		if(cache != null ){
