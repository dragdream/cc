...
@Entity
@Table(name = "CRM_CODE")
public class TeeCrmCode {

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator="CRM_CODE_seq_gen")
	@SequenceGenerator(name="CRM_CODE_seq_gen", sequenceName="CRM_CODE_seq")
	@Column(name="SID")
	private int sid;
