...
public class TeeXFlowDataSelCtrl extends TeeCtrl{
	...
	public String getCtrlHtml4Design(TeeFormItem formItem) {
	    ...
	    return "<input  value='"+formItem.getTitle()+"'   type=\"button\"  title='"+formItem.getTitle()+"' name='"+formItem.getName()+"' id='"+formItem.getName()+"' flowid="+attrs.get("flowid")+"  mappingstr='"+attrs.get("mappingstr")+"'  onclick=\"selectFlowDataSource(this);\" />";
	}
