...
/**
 * 
 * @author zhp desc:处理文件基本下载 等业务
 * 
 */
@Service
public class TeeBaseDownloadService {
	...
	static{
		...
		contentTypes.put(".xlsx","application/x-xls");
	...
	public TeeBaseStream getTeeBaseStream(int aid) throws FileNotFoundException {
		TeeAttachment attach = loadAttachById(aid);
		return getTeeBaseStream(attach);
	}
	
	@Transactional(readOnly = false)
	public TeeBaseStream getTeeBaseStream(TeeAttachment attach) throws FileNotFoundException {
		return new TeeBaseStream(attach);
	}
	...
	public String getContentType(String fileName) {
		...
		return contentTypes.get(extName.toLowerCase());
	}
	...
	public boolean isEditableFile(String fileName) {
		...
		if(extName.indexOf("doc")!=-1 
				|| extName.indexOf("ppt")!=-1 
				|| extName.indexOf("xls")!=-1){
