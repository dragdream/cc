 ...
 * */
public class TeeFlowRunNumberByDBuMenPlugin extends TeeWfPlugin {
	...
	public void afterTurnnext() {
		...
		if(("事假".equals(qjType) || "病假".equals(qjType)) && double1<3){
			object.put("flag", "2");
			...
			if(find2!=null && find2.size()>0){
				for(TeeFlowRunCtrlFeedback fb:find2){
					...
					obj.put("KQ1702", fb.getCreateUser().getUserId());//审批人
