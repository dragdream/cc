...
@Entity
@Table(name = "SYS_CODE")
public class TeeSysCode {

	@Id
	@GeneratedValue(strategy = GenerationType.AUTO, generator="SYS_CODE_seq_gen")
	@SequenceGenerator(name="SYS_CODE_seq_gen", sequenceName="SYS_CODE_seq")
	@Column(name="SID")
	private int sid;
