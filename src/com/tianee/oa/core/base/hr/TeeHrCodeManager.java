package com.tianee.oa.core.base.hr;
...
public class TeeHrCodeManager {
	public static final String hrCodeSettingPath = "类型值可在“人事管理”->“设置”->HR代码中设置。";
	public static Cache cache;
	public TeeHrCodeManager() {
		// TODO Auto-generated constructor stub
		
	}
	static {
		cache = TeeCacheManager.getCache("hrCode");
	}
	...
	public static  void createSysCodeCache(Connection conn ){
		...
		if(cache != null && conn != null ){
			...
			ResultSet rs = null;
			String sql = "select * FROM  HR_CODE  order by PARENT_ID , CODE_ORDER";
			try{
	 ...
	 * @return
	 */
	public static List<Map> getChildSysCodeListByParentCodeNo(String parentCodeNo){
	 ...
	 */
	public  void updateChildSysCodeElement(String oldParentCodeNo ,String parentCodeNo , String oldCodeNo , TeeHrCode code){
		if(cache != null ){
			if(!TeeUtility.isNullorEmpty(oldParentCodeNo) && !oldParentCodeNo.equals(parentCodeNo)){//更改主编号
				...
				Element element  = cache.get(parentCodeNo);
				if(element==null){
					element = new Element(parentCodeNo, new HashMap<String,Object>());
				}
