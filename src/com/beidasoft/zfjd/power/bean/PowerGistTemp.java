 ...
 */
@Entity
@Table(name="TBL_POWER_GIST_TEMP")
public class PowerGistTemp {
    // 主键
    @Id
    @Column(name = "ID")
    private String id;
    ...
    private PowerTemp powerGistTemp;
    ...
    public PowerTemp getPowerGistTemp() {
        return powerGistTemp;
    }

    public void setPowerGistTemp(PowerTemp powerGistTemp) {
        this.powerGistTemp = powerGistTemp;
    }
