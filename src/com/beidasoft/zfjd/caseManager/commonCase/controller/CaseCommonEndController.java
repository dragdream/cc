...
*/
@Controller
@RequestMapping("caseCommonEndCtrl")
public class CaseCommonEndController {
    
    /**
     * 
    * @Function: commonCaseAddEnd()
    ...
    *
     */
    @RequestMapping("/commonCaseAddEnd")
    public void commonCaseAddEnd(HttpServletRequest request, HttpServletResponse response, CaseCommonEndModel endModel) throws Exception{
        try {
            ...
            request.setAttribute("end", endModel);
            request.getRequestDispatcher("/supervise/caseManager/commonCase/common_case_addEnd.jsp").forward(request, response);
        }catch (Exception e) {
