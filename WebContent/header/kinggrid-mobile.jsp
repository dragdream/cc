...
<script type="text/javascript" src="<%=request.getContextPath() %>/common/kinggrid/zepto.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/common/kinggrid/zepto.fx.js"></script>

<script type="text/javascript" src="<%=request.getContextPath() %>/common/kinggrid/jquery-1.8.3.min.js"></script>
...
<link rel="stylesheet" href="<%=request.getContextPath() %>/common/kinggrid/core/kinggrid.plus.mobile.css">
...
<script type="text/javascript" src="<%=request.getContextPath() %>/common/kinggrid/dialog/artDialog/dialog-min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/common/kinggrid/signature.min.js"></script>
<script type="text/javascript" src="<%=request.getContextPath() %>/common/kinggrid/signature.mobile.min.js"></script>
