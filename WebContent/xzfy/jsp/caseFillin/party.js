...
var applicant_tpl = [
    ...
    '<td class="funcTd"><i class="iconfont icon-shanchu" onclick="deleteRow(this);"></i></td>',
    '</tr>',
    '{@/each}'
...
$(document).ready(function() {
    updateIndex();
    if (applicant_listdata.isShowColumn.length > 0) { $('.applicant-agent-div').show(); } else { $('.applicant-agent-div').hide(); }
});
