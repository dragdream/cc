...
<body onload="doInit();"
	style="overflow: hidden; padding-left: 10px; padding-right: 10px;">
	<div class="tab">
		<ul>
	...
	<div class="content" id="d1">
		<%@ include file="/xzfy/jsp/caseRegister/caseRecpinfo.jsp"%>
	</div>
	<div class="content" id="d1">
		<%@ include file="/xzfy/jsp/caseRegister/clientInfo.jsp"%>
	</div>
	<div class="content" id="d1">
		<%-- <%@ include file="/xzfy/jsp/caseRegister/clientInfo.jsp"%> --%>
	</div>
	<div class="content" id="d1">
		<ul class="material">
			<li><span class="material-title">申请书</span><span
	...
	<div id="rp_btn" class="fr">
		<input id="back" class="btn-win-white" type="button" value="上一步"
			title="上一步" onclick="back();" /> <input id="save"
			class="btn-win-white" type="button" value="暂  存" title="暂存"
			onclick="save();" /> <input id="forward" class="btn-win-white"
			type="button" value="下一步" title="下一步" onclick="forward();" />
	</div>
	<script type="text/javascript"
		src="/xzfy/js/caseRegister/caseRegister.js"></script>
</body>
</html>