                    ...
                    <tr class="common-tr-border">
                        ...
                        <td class="case-common-td-class2">
                            <input style="width: 15px; height: 15px;" class="easyui-checkbox" labelAlign="left" labelPosition="after" 
	                            name="personNo" id="personNo0" value="1" labelWidth="100px" label="无"/>
	                        <input style="width: 15px; height: 15px;" class="easyui-checkbox" labelAlign="left" labelPosition="after" 
	                            name="personNo" id="personNo1" value="2" labelWidth="100px" label="1-5"/>
	                        <input style="width: 15px; height: 15px;" class="easyui-checkbox" labelAlign="left" labelPosition="after" 
	                            name="personNo" id="personNo2" value="3" labelWidth="100px" label="6-10"/>
	                        <input style="width: 15px; height: 15px;" class="easyui-checkbox" labelAlign="left" labelPosition="after" 
	                            name="personNo" id="personNo3" value="4" labelWidth="100px" label="大于10"/>
	                        <input style="width: 15px; height: 15px;" class="easyui-checkbox" labelAlign="left" labelPosition="after" 
...
<script type="text/javascript" src="/xzfy/js/common/common.js"></script>
	<script type="text/javascript" src="/common/My97DatePicker/WdatePicker.js"></script>
<script type="text/javascript" src="/xzfy/js/caseList/caselist1.js"></script>
</body>
</html>