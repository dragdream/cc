...
<link rel="stylesheet" type="text/css" href="/xzfy/css/common/table_narrow.css" />
...
<div class="base_layout_top" style="position:static">
	...
	<span class="title" style="padding-top: 4px;">恢复</span>
...
<table align="center" width="100%" class="TableBlock_page">
	...
	<tr calss="common-tr-border">
		<td nowrap class="case-common-filing-td-class1" >恢复日期：</td>
		<td class="case-common-filing-td-class2">
			<input type="text" id="caseSubRestoreTime" name="caseSubRestoreTime" class="BigInput" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly >
		</td>
	</tr>
	<tr calss="common-tr-border">
		<td nowrap class="case-common-filing-td-class1" >恢复理由：</td>
		<td colspan="5" class="case-common-filing-td-class2">
			<textarea class="textstyle" style="height:60px;width:98%" data-options="multiline:true" name="caseSubRestoreReason" id="caseSubRestoreReason"></textarea>
		</td>
	</tr>
	<!-- 这两行是文件上传和回显必须用到的tr -->
...
<script type="text/javascript" src="<%=contextPath %>/xzfy/js/caseTrial/auxiliaryOperation/recovery/recovery.js"></script>
