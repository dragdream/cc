...
<body style=" overflow: hidden; padding: 10px;">
    <div class="main">
        <div class="main-up">
            <!-- 待办提醒 -->
            <div class="info">
                <p class="moheader infoheader">您好，xxx！您所在复议机关：xxx</p>
                <table id="dg" class="easyui-datagrid"
		                       url="/xzfy/homepage/caseSummary/listByStatus.action"
		                       toolbar="#toolbar"
		                       rownumbers="true" fitColumns="true" singleSelect="true"
		                       class="infocontent">
	                 <thead>
		                 <tr>
			             <th field="caseStatus" width="50">任务类型</th>
            ...
            <!-- 通知公告 -->
            <div class="notice">
                <p class="moheader noticeheader">通知公告<span class="noticemore">更多 ></span></p>
                <ul class="noticeUl">
