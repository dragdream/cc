...
function doSave(){
	if (checkForm()){
		var url = "<%=contextPath%>/teeAddressGroupController/updateAddressGroup.action";
...
<div class="topbar clearfix" style='padding:0!important;border-bottom:none!important;'>
	<table style="width:100%;">
		<tr>
			<td>
				<b><i class="glyphicon glyphicon-sound-stereo"></i>编辑分组</b>
			</td>
			<td align=right>
			</td>
		</tr>
		...
		<table class="none-table">
		   ...
		   <tr>
		    ...
		    <td nowrap class="TableData" align="left">
		        <input type='text' name="orderNo" class="easyui-validatebox BigInput"  maxlength='5' size='5' required="true"  validType='positivIntege[]'/>
		    </td>
		   </tr>
		   <tr>
