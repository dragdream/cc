...
// 	getDeptParent();
	datagrid = $('#datagrid').datagrid({
		url:contextPath+"/teeFixedAssetsRecordController/getRecordDatagrid.action?optType=0&priv=1",
		pagination:true,
		singleSelect:false,
 ...
 */
function apply(){
	 $.MsgBox.Confirm ("提示", "是否发起资产领用申请？",function(){
		createNewWork(40);
	});
}
...
<div id="toolbar" class="clearfix" style="padding-top: 10px;">
    <div class="fl" style="position:static;">
		<img id="img1" class = 'title_img' src="<%=contextPath %>/common/zt_webframe/imgs/xzbg/gdzc/icon_zcly.png">&nbsp;&nbsp;
		<span class="title">资产领用</span>
	</div>
