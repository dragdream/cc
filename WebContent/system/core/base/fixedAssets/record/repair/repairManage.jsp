...
// 	getDeptParent();
	datagrid = $('#datagrid').datagrid({
		url:contextPath+"/teeFixedAssetsRecordController/getRecordDatagrid.action?optType=2",
		pagination:true,
		singleSelect:false,
...
<div id="toolbar" class="clearfix" style="padding-top: 10px;">
    <div class="fl" style="position:static;">
		<img id="img1" class = 'title_img' src="<%=contextPath %>/common/zt_webframe/imgs/xzbg/gdzc/icon_zcwx.png">&nbsp;&nbsp;
		<span class="title">资产维修</span>
	</div>
	 ...
	 <table>
	  <tr>
	    ...
	    <td nowrap class="TableData" style="width: 180px;">
	     ...
	     <td class="TableData TableBG">申请日期范围：</td>
		<td class="TableData">
