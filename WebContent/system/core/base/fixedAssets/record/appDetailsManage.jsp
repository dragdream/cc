<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%
 	String optType = TeeStringUtil.getString(request.getParameter("optType"), "0");
 %>
...
// 	getDeptParent();
	datagrid = $('#datagrid').datagrid({
		url:contextPath+"/teeFixedAssetsRecordController/getRecordDatagrid.action?optType=0",
		pagination:true,
		singleSelect:false,
		...
		columns:[[
			...
			{field:'userName',title:'领用人',width:200},
			{field:'deptName',title:'领用人部门',width:200},
			{field:'optDateDesc',title:'领用日期',width:200}
		]]
	});
}
	...
	<table>
	  <tr>
	    ...
	    <td nowrap class="TableData" align="left" style="width:200px;">
		   <input class="BigInput" type="text" id ='assetCode' name='assetCode' style="height: 25px;font-family: MicroSoft YaHei;"/>
	    </td>
		...
		<td style="padding-left: 30px;">
		   <input type="button" class="btn-win-white" onclick="doSearch();" value="查询" title="查询" style="width:45px;height:25px;">
		</td>
	</tr>
	</table>
