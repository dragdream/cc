...
function getAssetsInfo(){
	if(fixedAssetsId!="" && fixedAssetsId!=null && fixedAssetsId!="null"){
		...
		if(json.rtState){
			...
			deptName=json.rtData.useDeptName;	
			$("#useDeptName").val(json.rtData.useDeptName);
		}else{
			alert(json.rtMsg);
		}
	}
...
function doSaveOrUpdate(callback){
	if(checkFrom()){
		var url = contextPath + "/teeFixedAssetsRecordController/addOrUpdate.action";
...
<form method="post" name="form1" id="form1"  >
	<table class="TableBlock" style="width:800px;font-size:12px;margin:0 auto;" >
		...
		<tr>
			<td class="TableData" nowrap="nowrap" width='20%'>
				<b>资产编号：</b>
				</td>
			...
			<td colspan="3" class="TableData" width='30%'>
		...
		<tr>
			...
			<td  class="TableData">
				...
				<span id="useDeptName" name="useDeptName" ></span>
			</td>
			<td class="TableData">
				<b>返库人：</b>
			</td>
