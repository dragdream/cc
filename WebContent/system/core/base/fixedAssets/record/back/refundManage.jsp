...
// 	getAssetsType();
	datagrid = $('#datagrid').datagrid({
		url:contextPath+"/teeFixedAssetsRecordController/getRecordDatagrid.action?optType=1&priv=1",
		pagination:true,
		singleSelect:false,
		...
		columns:[[
			...
			{field:'userName',title:'归还人',width:200},
			{field:'deptName',title:'归还人部门',width:200},
			{field:'optDateDesc',title:'归还日期',width:200}
		]]
	});
}
 ...
 */
function apply(sid){
	 $.MsgBox.Confirm ("提示","是否发起资产归还申请？",function(){
		 createNewWork(41);
		});
}
...
<body onload="doInit()" style="overflow: hidden; font-size: 12px; padding-left: 10px; padding-right: 10px;">
	...
	<div id="toolbar" class="clearfix" style="padding-top: 10px;">
		<div class="fl" style="position: static;">
			<img id="img1" class='title_img' src="<%=contextPath %>/common/zt_webframe/imgs/xzbg/gdzc/icon_zcfk.png">&nbsp;&nbsp;
				<span class="title">资产返库</span>
		</div>
			...
			<div style="padding: 0px;" id="searchDiv">
				<table>
					<tr>
						...
						<td nowrap class="TableData" style="width: 180px;">
						<input class="BigInput" type='text' id='assetName' name='assetName' style="height: 25px;font-family:MicroSoft YaHei;" /></td>

						<td class="TableData TableBG">归还日期范围：</td>
						<td class="TableData">
					    ...
					    <input type='text' id='time2' name='time2' readonly onclick="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'#F{$dp.$D(\'time1\')}'})" class="Wdate BigInput" style="height: 25px" /></td>
						<td style="padding-left: 10px;">
						<input type="button" class="btn-win-white" onclick="doSearch();" value="查询" style="width:45px;height:25px;">&nbsp;
						<input type="button" class="btn-win-white" onclick="apply();" value="新建" style="width:45px;height:25px;"></td>
					</tr>
				</table>
			</div>
