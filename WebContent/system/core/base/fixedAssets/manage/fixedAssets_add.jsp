...
function commitInfo(){
	...
	if($("#form1").valid() && checkForm()){
		$("#form1").doUpload({
			url:"<%=contextPath%>/TeeFixedAssetsInfoController/addAssetsInfo.action",
...
<div class=" fl ">
   ...
   <div class=" fr">
			...
			<input type="reset" id="reset" name="reset"  value="重填" class="btn-win-white" onclick="$('.reset').click();" title="重填" style="width:45px;height:25px;" />&nbsp;
...
<form method="post" name="form1" id="form1"  enctype="multipart/form-data">
	<table class="TableBlock_page">
		...
		<tr>
			...
			<td  class="TableData">
				<input type="text"  type='text' name="assetsVersion" class="BigInput"  maxlength="200" style="width:165px;font-family:MicroSoft YaHei;">
			</td>
			<td style="text-indent:10px;" class="TableData ">
				所属部门：
				</td>
			<td  class="TableData">
				...
				<input style="font-family:MicroSoft YaHei;" type="text" id="deptName" name="deptName" readonly/>
				<span class='addSpan'>
		...
		<tr>
			...
			<td  class="TableData">
				<input type="text"  type='text' name="madein" class="BigInput"  maxlength="200" style="width:165px;font-family:MicroSoft YaHei;">
			</td>
			<td style="text-indent:10px;" class="TableData ">
			...
			<td colspan="3" class="TableData" style="vertical-align: bottom;">
				...
				<input style="font-family:MicroSoft YaHei;" type="text" id="keeperName" name="keeperName" readonly/>
				<span class='addSpan'>
		...
		<tr>
			...
			<td  class="TableData">
				<input type="text"  name="dealer" type='text' class="BigInput"  maxlength="200" style="width:165px;font-family:MicroSoft YaHei;">
			</td>
			<td style="text-indent:10px;" class="TableData ">
				使用年限：
			</td>
		...
		<tr>
			...
			<td  class="TableData">
				<input type='text'  name="receiptDateStr" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" class="BigInput Wdate" style="width:165px;font-family:MicroSoft YaHei;" />
			</td>
		</tr>
		<tr>
			<td style="text-indent:10px;" class="TableData ">
		...
		<tr>
			...
			<td colspan="3" class="TableData">
				<select class="BigSelect"  id="depreciation" name="depreciation" style="width:165px;height: 30px;font-family:MicroSoft YaHei;">
		...
		<tr>
			...
			<td   class="TableData">
				<input style="width:165px;" type="text" id='valideTimeDesc' onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" name='valideTimeDesc' class="Wdate BigInput easyui-validatebox" required/>
			</td>
		...
		<tr>
			...
			<td colspan="3" class="TableData">
				<textarea class="BigTextarea" id="remark" name="remark" style="width:600px;height:100px;font-family:MicroSoft YaHei;"></textarea>
			</td>
		</tr>
	</table>
