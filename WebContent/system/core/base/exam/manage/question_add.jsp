...
function commit(){
	if(checkForm()){
		...
		para["model"] = "exam";
		$("#form1").doUpload({
				url:"<%=contextPath%>/TeeExamQuestionController/addExamQuestion.action",
...
<form method="post" name="form1" id="form1"  enctype="multipart/form-data">
	<table class="TableBlock" style="width:100%;font-size:12px;margin:0 auto;" >
		...
		<tr>
			...
			<td  class="TableData">
				<textarea class="easyui-validatebox BigTextarea"  id="content" name="content" style='width:400px;height:60px;' required="true"></textarea>
			</td>
		</tr>
		<tr>
			<td class="TableData" style="text-indent: 10px;width: 100px">
			...
			<td  class="TableData">
				<input type='text' class="BigInput easyui-validatebox" id="score" name="score" style="width: 300px;height: 23px" validType='integeBetweenLength[1,1000]'/>(注：要求录入整数) 
			</td>
		</tr>
		<tr>
			<td class="TableData" style="text-indent: 10px;width: 100px">
