...
var sid='<%=sid%>';
function doInit(){
	var url = contextPath+"/TeeExamStoreController/getExamStore.action?sid="+sid;
...
function commit(){
	if(check()){
		...
		var url = contextPath+"/TeeExamStoreController/editExamStore.action";
		var json = tools.requestJsonRs(url,param);
		/* if(json.rtState){
			$.MsgBox.Alert_auto(json.rtMsg);
			//location.href=contextPath+"/system/core/base/exam/manage/storeList.jsp";
		}else{
			$.MsgBox.Alert_auto(json.rtMsg);
		} */
		return json;
