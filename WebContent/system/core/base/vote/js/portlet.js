...
(function($, undefined){
    $.widget("ui.portlet", {
        ...
        _createSinglePortlet: function(portlet, _ele, column, positon, pattrs) {
            ...
            // event element
            title.prepend("<a href='javascript:void(0);' id='del_"+i+"' title='删除' style='float:left;' class='ui-corner-all ui-portlet-event'><span class='ui-icon ui-icon-closethick ui-portlet-close'></span></a>");
            title.prepend("<a href='javascript:void(0);' id='add_"+i+"' title='添加选项' style='float:left;' class='ui-corner-all ui-portlet-event'><span class='ui-icon ui-icon-plusthick ui-portlet-toggle'></span></a>");
            title.prepend("<a href='javascript:void(0);' id='edit_"+i+"' title='修改标题' style='float:left;' class='ui-corner-all ui-portlet-event'><span class='ui-icon ui-icon-refresh ui-portlet-refresh ui-portlet-gear ui-icon-gear'></span></a>");
        ...
        _regSingleView: function() {
            ...
            $(_ele).find('.ui-portlet-header').dblclick(function() {
                ...
                var title = $("#span_"+p.attrs.id.split("_")[1]).html();
                //alert(p.attrs.id.split("_")[1]+","+title+","+p.attrs.type);
                //changeTitle(p.attrs.id.split("_")[1],title,p.attrs.type);
                //alert(p.attrs.id);
        ...
        _initEvents: function(element) {
            ...
            var toggle = $(".ui-portlet-toggle", _ele).click(function(event, type) {
                ...
                //alert(pio.attrs.type+","+pio.attrs.id.split("_")[1]+","+j);
                addItem(pio.attrs.type,pio.attrs.id.split("_")[1],j);
        ...
        refresh: function(event) {
            ...
            var title = $("#span_"+pio.attrs.id.split("_")[1]).html();
            //alert($("#span_"+pio.attrs.id.split("_")[1]).html());
            if($("#span_"+pio.attrs.id.split("_")[1]).html()!=null){
            	changeTitle(pio.attrs.id.split("_")[1],title,pio.attrs.type);
            }
