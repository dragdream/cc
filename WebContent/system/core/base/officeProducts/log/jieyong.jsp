...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/officeRecordController/datagrid4.action',
		pagination:true,
		singleSelect:true,
		...
		columns:[[
			...
			{field:'regUserName',title:'借用人',width:100}
		]]
	});
...
<body onload="doInit()" style="font-size:12px;padding-left: 10px;padding-right: 10px;">
	...
	<div id="toolbar" class = "topbar clearfix">
		<!-- <div class="base_layout_top" style="position:static">
			<span class="easyui_h1">借用记录</span>
		</div> -->
		<div class="fl" style="position:static;">
		    <img id="img1" class = 'title_img' src="<%=contextPath %>/common/zt_webframe/imgs/ypjl/icon_借用记录.png">
		    <span class="title">借用记录</span>
	    </div>
