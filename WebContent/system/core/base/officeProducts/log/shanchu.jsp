...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/officeRecordController/datagrid8.action',
		pagination:true,
		singleSelect:true,
		...
		columns:[[
			...
			{field:'actionDesc',title:'操作描述',width:100},
			...
			{field:'actionTimeDesc',title:'操作时间',width:100}
		]]
	});
...
<!-- 		<div class="base_layout_top" style="position:static">
			<span class="easyui_h1">删除记录</span>
		</div> -->
		<div class="fl" style="position:static;">
		    <img id="img1" class = 'title_img' src="<%=contextPath %>/common/zt_webframe/imgs/ypjl/icon_删除记录.png">
