...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/officeRecordController/datagrid2.action',
		pagination:true,
		singleSelect:true,
		...
		columns:[[
			...
			{field:'regCount',title:'报废数量',width:100},
			{field:'originStock',title:'原库存',width:100},
			{field:'regUserName',title:'操作人员',width:100},
			{field:'actionTimeDesc',title:'报废时间',width:100}
		]]
	});
...
<body onload="doInit()" style="font-size:12px;padding-left: 10px;padding-right: 10px;">
	...
	<div id="toolbar" class = "topbar clearfix">
		<!-- <div class="base_layout_top" style="position:static">
			<span class="easyui_h1">报废记录</span>
		</div> -->
		<div class="fl" style="position:static;">
		    <img id="img1" class = 'title_img' src="<%=contextPath %>/common/zt_webframe/imgs/ypjl/icon_报废记录.png">
		    <span class="title">报废记录</span>
	    </div>
