...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/officeRecordController/datagrid.action',
		pagination:true,
		singleSelect:true,
		...
		columns:[[
			...
			{field:'regCount',title:'入库数量',width:100},
			{field:'originStock',title:'原库存',width:100},
			{field:'regUserName',title:'入库人员',width:100},
			{field:'actionTimeDesc',title:'入库时间',width:100}
		]]
	});
...
<body onload="doInit()" style="font-size:12px;padding-left: 10px;padding-right: 10px;">
	...
	<div id="toolbar" class = "topbar clearfix">
		<!--<div class="base_layout_top" style="position:static">
			<span class="easyui_h1">入库记录</span>
		</div>-->
		<div class="fl" style="position:static;">
		    <img id="img1" class = 'title_img' src="<%=contextPath %>/common/zt_webframe/imgs/ypjl/icon_入库记录.png">
