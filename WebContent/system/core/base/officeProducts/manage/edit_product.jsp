...
function doInit(){
	...
	//根据所属库读取分类
	fetchCategory(document.getElementById("depositoryId"));
	bindJsonObj2Cntrl(json.rtData);
}
...
// 		top.$.jBox.tip("请选择用品类型","info");
	...
	var url = contextPath+"/officeProductController/updateProduct.action";
...
<form id="form1" name="form1">
	<table style="width:100%;font-size:12px" class="TableBlock">
		...
		<tr>
			...
			<td class="TableData">
				<select class="BigSelect" id="depositoryId" onchange="fetchCategory(this)">
					<option></option>
				</select>
			</td>
			<td class="TableData">
