...
function query(){
	...
	var jsonObj = tools.requestJsonRs(url , {selfType:1});
	if(jsonObj.rtState){
		...
		if(prcs.length > 0){
			...
			for(var i = 0;i<prcs.length ; i++){
				...
				tableStr = tableStr + "<tr class=''>"
				      	 ...
				      	 +"<td nowrap align='center' width='50px'><font color='" + fontStr + "'>未自评</font></td>"
						 +"<td nowrap align='center' width='50px'>"
				      	 + "<a href='javascript:void(0);' onclick='toSelf(" + id  + "," + groupId+ ");'> 自评</a>"
				      	 +"</td>"
				         +"</tr>";
			}
			...
			$("#listDiv").append(tableStr);	
		 	...
		 	messageMsg("没有相关自评考核信息", "listDiv" ,'' ,380);
		}
	}else{
		alert(jsonObj.rtMsg);
	}
...
<body class="" topmargin="5" onload="doOnload();">
	<table border="0" width="100%" cellspacing="0" cellpadding="3"
		class="small">
		<tr>
			 <td class="Big"><span class="Big3">&nbsp;&nbsp; 未自评的考核任务</span><br>
			</td> 
