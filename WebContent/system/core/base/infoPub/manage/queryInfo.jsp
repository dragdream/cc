  ...
  */
    function loadDetail(seqId){
        ...
        //var seqId = 0;// rows[rowIndex].sid;
         var url = contextPath + "/system/core/base/infoPub/person/readInfo.jsp?id="+seqId+"&isLooked=0";
	   ...
	   <tr>
	    ...
	    <td nowrap class="" > 标题：</td>
			...
			<td nowrap class="" colspan="">
				<textarea rows="2" cols="50" name="content" class="BigTextarea"></textarea>
