...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			url : contextPath + '/teeNewsController/getReadNews.action?state=-1&typeId=<%=infoType%>',
		//	toolbar : '#toolbar',
			title : '',
			iconCls : 'icon-save',
			pagination : true,
    ...
    function loadDetail(seqId){
        ...
        //var seqId = 0;// rows[rowIndex].sid;
         var url = contextPath + "/system/core/base/infoPub/person/readInfoReplay.jsp?id="+seqId+"&isLooked=1";
...
<div id="toolbar">
	<div class="base_layout_top" style="position:static">
		<span class="easyui_h1">全部<%=infoTypeDesc %></span>
	</div>
	<br/>
</div>
