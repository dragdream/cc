		        ...
		        quickDetail.setCallbacks({
		            ...
		            'delete': function()
		            {
		               /* if( confirm('删除后无法恢复，确认删除？'))
		                ...
		                $.MsgBox.Confirm("提示", "删除后无法恢复，确认删除？", function(){
		                	deleteCal(cal_id ,calendar ); 
		        	  });
		            },
		            'detail': function()
		            {   
		            	var buttons =  "<input type=\"button\" value=\"关闭\" class=\"btn btn-alert-gray fr\" onclick=\"top.$.jBox.close();\">&nbsp;&nbsp;"
	...
	bsWindow(url ,"日程安排详情",{width:"560px",height:"180px",buttons:
		...
		/* {name:"修改",classStyle:"btn btn-primary"},
		 {name:"删除",classStyle:"btn btn-danger"},*/
	 	 {name:"关闭",classStyle:"btn btn-alert-gray"}
		 ]
	,submit:function(v,h){
...
function getAddUpdateCalFrom(){
	...
	var form =  ""+
	 "<table class=\"TableBlock\" width=\"100%\" align=\"center\">"+
		"<tr class=\"TableData\">"+
			"<td nowrap style=\"padding-left:20px\">事务内容：</td>"+
       ...
       " </td>"+
		...
		"<tr class=\"TableData\">"+
			"<td nowrap style=\"padding-left:20px\">事务类型：</td>"+
			"<td nowrap align=\"left\">"+
           ...
           "</td>"+
			"</tr>"+
		"<tr class=\"TableData\">"+
			"<td nowrap style=\"padding-left:20px\">优先级：</td>"+
			"<td nowrap align=\"left\">"+
...
//           "<input id=\"calLevel\" name=\"calLevel\" value=\"0\" type=\"hidden\">"+
       ...
       "</span>"+
		...
		"</tr>"+
		"<tr class=\"TableData\">"+
			"<td nowrap style=\"padding-left:20px\">是否重复：</td>"+
			"<td nowrap align=\"left\">"+
	     ...
	     "<tr class=\"TableData\" id=\"remindTypeTr\" style=\"display:none;\">"+
			"<td nowrap style=\"padding-left:20px\">提醒类型：</td>"+
			"<td nowrap align=\"left\">"+
       ...
       "</td>"+
	     ...
	     "<tr class=\"TableData\" id=\"remindTimeTr\" style=\"display:none;\">"+
			"<td nowrap style=\"padding-left:20px\">提醒时间：</td>"+
			"<td nowrap align=\"left\">"+
			 	"<span id='day' >"+
			 		"</span>"+
	    ...
	    "</tr>"+
		"<tr class=\"TableData\">"+
		"<td nowrap style=\"padding-left:20px\">参与者：</td>"+
		"<td nowrap align=\"left\">"+
       ...
       "</tr>"+
		"<tr class=\"TableData\" id=\"beforeRemindTr\"  style=\"border-bottom:none;\">"+
		"<td nowrap style=\"padding-left:20px\">提前时间：</td>"+
		"<td nowrap align=\"left\">"+
