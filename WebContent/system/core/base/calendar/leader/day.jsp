...
function createNullCalendarTr(value,name){
  	...
  	if(!$("#tr_" + value)[0]){//如果不存在
        ...
        if(date==currSimpDateStr){//如果是当天
  	    ...
  	    tmp = tmp  +"<td id='td_"+value+"_"+ dateList[0].simpDate +"' class='"+tdClass+"' style='"+tdClassStyle+"' title='双击建立事务' ondblclick='toNewCalendarByDay("+value+",\""+(dateList[0].simpDate)+"\")'></td>";
