...
function getFileTree(){
	var url =  "<%=contextPath %>/saveFileToPublicFolderController/getPublicFolderTree.action";
	var config = {
...
function doSubmit(){
	if(checkForm()){
		var url = "<%=contextPath %>/saveFileToPublicFolderController/saveToPublicFolder.action";
