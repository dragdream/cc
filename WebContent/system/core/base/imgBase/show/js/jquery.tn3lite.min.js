(function(i) {
    ...
    if (function(g) {
        ...
        i.fn.tn3.config = {
            ...
            skin: null,
            skinDir: "skins",
            skinDefault: '<div class="tn3-gallery"><div class="tn3-image"><div class="tn3-text-bg"><div class="tn3-image-title"></div><div class="tn3-image-description"></div></div><div class="tn3-next tn3_v tn3_o"></div><div class="tn3-prev tn3_v tn3_o"></div><div class="tn3-preloader tn3_h tn3_v"><img src="preload.gif"/></div><div class="tn3-timer"></div></div><div class="tn3-controls-bg tn3_rh"><div class="tn3-sep1"></div><div class="tn3-sep2"></div><div class="tn3-sep3"></div></div><div class="tn3-thumbs"></div><div class=""></div><div class="tn3-show-albums"></div><div class="tn3-next-page"></div><div class="tn3-prev-page"></div><div class="tn3-play"></div><div class="tn3-count"></div><div class="tn3-albums"><div class="tn3-inalbums"><div class="tn3-album"></div></div><div class="tn3-albums-next"></div><div class="tn3-albums-prev"></div><div class="tn3-albums-close"></div></div></div>',
            cssID: null
        };
...
(function(i) {
    ...
    i.extend(i.easing, {
        ...
        easeInOutElastic: function(b, a, c, e, d) {
            ...
            if (a < 1) return -.5 * j * Math.pow(2, 10 * (a -= 1)) * Math.sin((a * d - b) * 2 * Math.PI / h) + c;
            return j * Math.pow(2, -10 * (a -= 1)) * Math.sin((a * d - b) * 2 * Math.PI / h) * .5 + e + c;
        },
        ...
        easeOutBounce: function(b, a, c, e, d) {
            return (a /= d) < 1 / 2.75 ? e * 7.5625 * a * a + c : a < 2 / 2.75 ? e * (7.5625 * (a -= 1.5 / 2.75) * a + .75) + c : a < 2.5 / 2.75 ? e * (7.5625 * (a -= 2.25 / 2.75) * a + .9375) + c : e * (7.5625 * (a -= 2.625 / 2.75) * a + .984375) + c;
        },
        easeInOutBounce: function(b, a, c, e, d) {
            if (a < d / 2) return i.easing.easeInBounce(b, a * 2, 0, e, d) * .5 + c;
            return i.easing.easeOutBounce(b, a * 2 - d, 0, e, d) * .5 + e * .5 + c;
        }
    });
})(jQuery);
...
(function(i) {
    ...
    i.fn.tn3.Gallery.prototype = {
        ...
        rebuild: function(d, h) {
            if (this.items.thumbs) if (this.thumbnailer) this.thumbnailer.rebuild(d); else this.thumbnailer = new i.fn.tn3.Thumbnailer(this.items.thumbs, d, this.config.thumbnailer);
        ...
        fullscreen: function(d) {
            if (this.config.isFullScreen) {
                ...
                if (this.config.responsive !== false) this.initResponsive(this.config.responsive); else this.config.width !== null || this.config.height !== null ? this.resize(this.config.width, this.config.height) : this.resize(this.config.initValues.width, this.config.initValues.height);
...
(function(i, b, a) {
    ...
    function d(q, p, r, s) {
        ...
        w = w && "-" + w + "-" || "";
        return l[v] || (m.insertRule("@" + w + "keyframes " + v + "{0%{opacity:" + s + "}" + r + "%{opacity:" + q + "}" + (r + .01) + "%{opacity:1}" + (r + p) % 100 + "%{opacity:" + q + "}100%{opacity:" + s + "}}", m.cssRules.length), 
        l[v] = 1), v;
    }
    function h(q, p) {
        var r = q.style, s, v;
    ...
    f(u.prototype, {
        ...
        stop: function() {
            var q = this.el;
            return q && (clearTimeout(this.timeout), q.parentNode && q.parentNode.removeChild(q), 
            this.el = a), this;
        },
        lines: function(q, p) {
            function r(w, y) {
    ...
    (function() {
        ...
        !h(p, "transform") && p.adj ? (m.addRule(".spin-vml", "behavior:url(#default#VML)"), 
        u.prototype.lines = function(r, s) {
            function v() {
                return j(q("group", {
                    coordsize: z + " " + z,
                    coordorigin: -y + " " + -y
    ...
    i.fn.tn3.Imager.prototype = {
        ...
        initTransition: function() {
            ...
            if (this.$active != false) {
                ...
                this.unbindMouseEvents();
                if (this.mouseIsOver) i(document).mousemove(i.proxy(this.onMouseMove, this)); else this.mouseCoor = {
                    x: 0,
                    y: 0
                };
        ...
        resizeContent: function(b) {
            ...
            if (this.config.stretch) {
                ...
                e.left = (this.cDim.w - a) * .5;
                e.top = (this.cDim.h - c) * .5;
    ...
    i.fn.tn3.Thumbnailer.prototype = {
        ...
        centerActive: function(b) {
            if (this.active != -1) {
                ...
                if (c + e > this.containerSize || c + e < 0) {
                    ...
                    c = {};
                    c[this.edge] = a;
                    if (this.isTouch) this.$oc["scroll" + this.edge.substring(0, 1).toUpperCase() + this.edge.substring(1)](-a); else b ? this.$ul.css(c) : this.$ul.animate(c, 200);
                }
            }
        },
        ...
        centerList: function(b) {
            if (this.listSize < this.containerSize) {
                ...
                this.centerActive(b);
                if (this.$ul.position()[this.edge] > 0) this.$ul.css(this.edge, 0); else this.$ul.position()[this.edge] + this.listSize < this.containerSize && this.$ul.css(this.edge, -(this.listSize - this.containerSize));
            }
        },
    ...
    var b = i.fn.tn3.Transitions = function(c, e, d, h, j) {
        ...
        animateGrid: function(c, e, d, h, j, f, n) {
            ...
            for (d = 0; d < c.length; d++) {
                ...
                if (i.isArray(c[d])) for (var k in c[d]) c[d][k].delay(h).animate(e[d], g); else c[d].delay(h).animate(e[d], g);
            }
        },
