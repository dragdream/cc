...
function save(){
	if(checkForm()){
		//获取值班人员id字符串
		var userUuidStr=$("#userUuidStr").val();
		var url = "<%=contextPath %>/onDutyController/addOrUpdateBatch.action?userUuidStr="+userUuidStr;
	...
	<table class="TableBlock" width="100%" align="center" style="margin-top:10px;">
		...
		<tr class="TableData" id="userIdTr">
			...
			<td nowrap align="left" colspan="3" >
				<input id="userUuidStr" name="userUuidStr" type="hidden" value=''> 
				<textarea name="userName" id="userName" class="SmallStatic BigTextarea easyui-validatebox" rows="2" cols="40"readonly="readonly" required="true"></textarea> &nbsp;&nbsp;
				<a href="javascript:void(0);" class="orgAdd" onClick="selectUser(['userUuidStr','userName'],'19')">选择</a>&nbsp;&nbsp; 
				<a href="javascript:void(0);" class="orgClear"onClick="clearData('userUuidStr','userName')">清空</a>
			</td>
