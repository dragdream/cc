...
function commit(callback){
	if(checkForm() && $("#form1").valid()){
		...
		param["isDel"]=0;
		parent.$.MsgBox.Confirm ("提示", "是否将关联OA用户设置为禁止登录？",function(){
			    param["isDel"]=1;
			    var url = contextPath+"/TeeHumanLeaveController/updateHumanLeave.action";
...
<div class="topbar clearfix" id="toolbar">
   <div class="fl" style="position:static;">
		...
		<span class="title">新增/编辑  <%= personName %> 的离职信息</span>
	</div>
</div>
<form id="form1" name="form1">
	<table class="TableBlock" width="100%" align="center">
		...
		<tr class='TableData' align='left'>
			...
			<td>
				<select style="height: 23px;width: 200px;" class="BigSelect" id="leaveType" name="leaveType" >
				</select>
			</td>
		 </tr>
		<tr class='TableData' align='left'>
		...
		<tr class='TableData' align='left'>
			...
			<td>
				<input style="height: 23px;width: 350px;" type="text" class="BigInput" id="leaveDept" name="leaveDept" />
			</td>
		 </tr>
		<tr class='TableData' align='left'>
			<td class="TableData" width="150" style="text-indent:15px">
