...
function commit(){
	if(check()&&$("#form1").valid()){
		...
		var url = contextPath+"/humanDocController/addHumanDoc.action";
	...
	<table style="width:100%;font-size:12px" class='TableBlock_page'>
	   ...
	   <tr id="addSpan2">
			...
			<td class="TableData">
				...
				<input name="userName" id="userName" style="height:23px;width:350px;border: 1px solid #dadada;"  wrap="yes" readonly />
					   <span class='addSpan'>
			               <img src="<%=contextPath %>/common/zt_webframe/imgs/rsdagl/dagl/icon_select.png" onClick="selectSingleUser(['userId', 'userName'])" value="选择"/>
				           &nbsp;&nbsp;
				           <img src="<%=contextPath %>/common/zt_webframe/imgs/rsdagl/dagl/icon_select.png" onclick="clearData('userId', 'userName')" value="清空"/>
			       </span>
				<br/>
				<span style="color: red;">（不选择关联用户则自动创建OA用户）</span>
			</td>
		</tr>
		<tr class='TableData'>
			...
			<td>
				...
				<input style="width: 350px;height: 23px;" id="deptIdName" name="deptIdName"  type="text" value="<%=request.getParameter("deptName")%>" class="BigInput" required readonly="readonly"/>
			</td>
		</tr>
		<tr class='TableData' align="left">
			<td class='TableData' width="150" style="text-indent: 15px;">
...
<table class="TableBlock_page" width="100%" align="center" id="customTable">
  ...
  <tbody id="customTbody" >
	...
	<div align="center" style="padding-top: 10px;">
	     <input style="width: 45px;height: 25px;" class="btn-win-white" type="button" value="保存" onclick="commit();" />&nbsp;&nbsp;&nbsp;&nbsp;
	     <input style="width: 45px;height: 25px;" class="btn-win-white" type="reset" value="重置"/>
	</div>
	</br>
</form>
</body>
