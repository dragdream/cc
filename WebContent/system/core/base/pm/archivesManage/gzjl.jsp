...
function add(){
	var title="添加工作经历信息";
	var url = contextPath+"/system/core/base/pm/archivesManage/gzjl_add.jsp?humanDocSid="+humanDocSid+"&personName="+personName;
	bsWindow(url ,title,{width:"700",height:"300",buttons:
		[
...
function edit(sid){
	var title="修改学习经历信息";
	var url = contextPath+"/system/core/base/pm/archivesManage/gzjl_edit.jsp?sid="+sid+"&humanDocSid="+humanDocSid+"&personName="+personName;
	bsWindow(url ,title,{width:"700",height:"300",buttons:
		[
		 {name:"确定",classStyle:"btn-alert-blue"},
	 	 {name:"关闭",classStyle:"btn-alert-gray"}
...
<body onload="doInit();" style="overflow:hidden;font-size:12px;padding-left: 10px;padding-right: 10px;">
   ...
   <div class="fl">
      <input type="button" value="添加工作经历" class="btn-win-white" onclick="add();"/>
   </div>
</div>
</body>
</html>