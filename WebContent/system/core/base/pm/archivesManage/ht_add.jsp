...
function commit(callback){
	if($("#form1").valid() && checkForm()){
		...
		var url = contextPath+"/TeeHumanContractController/addHumanContract.action";
...
<form id="form1" name="form1">
	<table class="TableBlock" width="100%" align="center">
		...
		<!-- <tr class='TableData' align="left">
			...
			<td>
				<input style="height: 23px;width: 200px;"  type="text" id='renewDateDesc' name='renewDateDesc' class="BigInput readonly Wdate"    onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  readonly="readonly"/>
			</td>
		</tr>
		<tr class='TableData' align="left">
			<td class="TableData" width="150" style="text-indent:15px">
			...
			<td>
				<input  style="height: 23px;width: 200px;"  type="text" id='lastRemindDateDesc' name='lastRemindDateDesc' class="BigInput readonly Wdate"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" readonly="readonly"/>
			</td>
		</tr> -->
		<tr class='TableData' align="left">
			<td  class="TableData" width="150" style="text-indent:15px">
