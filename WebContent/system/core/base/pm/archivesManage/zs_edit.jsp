...
function checkForm(){
	  if($("#validTimeDesc").val() && $("#endTimeDesc").val()){
		    if(document.getElementById("validTimeDesc").value > document.getElementById("endTimeDesc").value){
		    	$.MsgBox.Alert_auto(json.rtMsg);("生效时间不能大于结束时间！");
		      return false;
			 }
	  }
	return true;
...
<form id="form1" name="form1">
	<table class="TableBlock" width="100%" align="center">
		...
		<tr class='TableData' align='left'>
			...
			<td>
				<input style="height: 23px;width: 350px;" type="text" id="certCode" name="certCode" required="true" class="easyui-validatebox BigInput"/>
			</td>
		</tr>
		<tr class='TableData' align='left'>
			<td class="TableData" width="150" style="text-indent:15px">
			...
			<td>
				<select style="height: 23px;width: 200px;" class="BigSelect" id="certType" name="certType">
				</select>
			</td>
		</tr>
		<tr class='TableData' align='left'>
			...
			<td>
				<input style="height: 23px;width: 350px;" type="text" class="BigInput" id="certName" name="certName"/>
			</td>
	    </tr>
		<tr class='TableData' align='left'>
			<td class="TableData" width="150" style="text-indent:15px">
			...
			<td>
				<input style="height: 23px;width: 200px;" type="text" id='getTimeDesc' onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" name='getTimeDesc' class="Wdate BigInput" />
			</td>
		</tr>
		<tr class='TableData' align='left'>
			<td class="TableData" width="150" style="text-indent:15px">
		...
		<tr class='TableData' align='left'>
			...
			<td>
				<select style="height: 23px;width: 200px;" class="BigSelect" id="certAttr" name="certAttr">
				</select>
			</td>
		</tr>
		<tr class='TableData' align='left'>
