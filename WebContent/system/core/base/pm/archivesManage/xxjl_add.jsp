...
function commit(callback){
	if(checkForm()&& $("#form1").valid()){
		...
		var url = contextPath+"/TeeHumanEducationController/addHumanEducation.action";
...
<form id="form1" name="form1">
	<table class="TableBlock" width="100%" align="center">
		...
		<tr class='TableData' align='left'>
			...
			<td>
				<input style="height: 23px;width: 350px;"style="height: 23px;width: 250px;" type="text" class="BigInput" id="eduDegree" name="eduDegree"/>
			</td>
		</tr>
		<tr class='TableData' align='left'>
			<td class="TableData" width="150" style="text-indent:15px">
