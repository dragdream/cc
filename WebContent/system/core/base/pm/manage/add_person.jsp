...
<body onload="doInit();" style="font-size:12px" style="margin:0 auto;padding:0 auto;">
<form id="form1" name="form1">
	<table style="width:100%;font-size:12px" class='TableBlock'>
		...
		<tr class='TableData'>
			...
			<td>
				<input type="text" class="BigInput easyui-validatebox" name="nativePlace" id="nativePlace" />
			</td>
			<td>
				档案编号：
				</td>
		...
		<tr class='TableData' id="addSpan">
			...
			<td>
				...
				<input cols="45" name="userName" id="userName" rows="1" style="overflow-y: auto;"  class="BigInput" wrap="yes" readonly />
		...
		<tr class='TableData'>
			...
			<td>
				...
				<input id="deptIdName" name="deptIdName"  type="text" value="<%=request.getParameter("deptName")%>" class="BigInput readonly easyui-validatebox" required readonly/>
			</td>
			<td>
				工号：
			</td>
