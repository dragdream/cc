...
<form id="form1" name="form1">
	<table  style="width:100%;font-size:12px" class="TableBlock">
		...
		<tr class='TableData'>
			...
			<td>
				<input type="text" id='getTimeDesc' onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" name="getTimeDesc" class="Wdate BigInput" />
			</td>
		</tr>
		<tr class='TableData'>
			<td>
			...
			<td>
				<input type="text" id='validTimeDesc' onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" name='validTimeDesc' class="Wdate BigInput" />
			</td>
			<td>
				<b>结束日期：</b>
			</td>
			<td>
				<input type="text" id='endTimeDesc' onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" name='endTimeDesc' class="Wdate BigInput" />
			</td>
		</tr>
			<tr class='TableData'>
			<td>
