   ...
   if($("#form1").valid()){
	   ...
	   if(json.rtState){
		   $.MsgBox.Alert_auto("保存成功！",function(){
			  window.location.href=contextPath+"/system/core/base/dam/preArchive/manage/index.jsp";
...
//移交
function turnOver(){
	var url=contextPath+"/system/core/base/dam/preArchive/manage/turnOver.jsp?ids="+sid;
   ...
   <div id="toolbar" class="topbar clearfix">
       <div class="fl" style="position:static;">
	    ...
	    <div class = "right fr clearfix">
	       <input type="button" class="btn-win-white fl" onclick="turnOver();" value="移交"/>
