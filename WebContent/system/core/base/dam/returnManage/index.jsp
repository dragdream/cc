...
<body onload="" style="overflow: hidden;padding-left:10px;padding-right:10px;padding-top: 5px">
	...
	<div class="titlebar clearfix" >
		<img class = 'tit_img' style="margin-right:10px" src="<%=contextPath %>/system/core/base/dam/imgs/icon_ghgl.png">
		<p class="title">归还管理</p>
...
<script>
 $.addTab("tab","tab-content",[{title:"待确认",url:contextPath+"/system/core/base/dam/returnManage/dqr.jsp"},
                              {title:"已确认",url:contextPath+"/system/core/base/dam/returnManage/yqr.jsp"},
                              ]); 
