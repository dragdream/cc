...
function personOnClick(event, treeId, treeNode) {
	...
	if(uuid.split(";").length == 2 && uuid.split(";")[1] == 'dept'){
		changePage("<%=contextPath%>/system/core/person/personList.jsp?deptId=" + uuid.split(";")[0] + "&deptName=" + encodeURIComponent(treeNode.name));
		...
		changePage("<%=contextPath%>/system/core/person/personList.jsp?deptId=0&orgId="+uuid.split(";")[0]+"&deptName=" + encodeURIComponent(treeNode.name));
