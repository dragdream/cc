...
function selectMenuGroup(retArray, moduleId,privNoFlag , privOp) {
  ...
  var url =contextPath + "/system/core/orgselect/selectMultiMenuGroupNew.jsp?deptUuid=" + deptId + "&objSelectType=" + objSelectType;
  var has = false;
  if (moduleId) {
...
<table class="TableBlock_page" width="90%" align="center">
  ...
  <tr onClick="setOption('option1')"  style="<%=adminPriv?"cursor: pointer;":"display:none;cursor: pointer;"%>" title="点击展开/收缩选项" >
   ...
   <tbody id="option1"  style="<%=adminPriv?"":"display:none;"%>">
   <tr style="display: none">
