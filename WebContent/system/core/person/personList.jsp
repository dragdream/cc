...
// 	}
	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			url: contextPath + '/personManager/getPersonList.action?sort=userNo&deptId=' + deptId,
		    pagination:true,
		    singleSelect:false,
...
function toAddUpdatePersonList(deptId){
	...
	var url = "<%=contextPath %>/system/core/person/addupdate.jsp?deptId=" + deptId + "&deptName=" + encodeURIComponent(deptName);
