...
function doInit(){
	...
	var url = contextPath +  "/orgSelectManager/selectUserPrivList.action";
	var para = {moduleId:moduleId,privNoFlag:'<%=privNoFlag%>',privOp:'<%=privOp%>'};
	...
	if(jsonRs.rtState){
	    ...
	    for(var i = 0; i < dataList.length; i++){
			...
			var roleName = dataList[i].roleName;
...
<div class="main-block" id="block_dept" style="display:block;">
    <div class="right single" align="center" style="margin:10px 10px 10px 10px;left:5px;padding-top:10px" id="dept_item">
	   <div class="block-right" id="dept_item_0">
		   <a  class='list-group-item-header'>选择角色</a>
			<li  id="addAll" class="list-group-item" style="text-align:center;;cursor:pointer">全部添加</li>
			<li  id="removeAll" class="list-group-item" style="text-align:center;;cursor:pointer">全部删除</li>
	   </div> 
