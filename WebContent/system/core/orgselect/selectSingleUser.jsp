...
function getDeptStr(uuid,isCheckedState,deptName){
	...
	var para = {deptId:uuid,isCheckedState:isCheckedState,userFilter:userFilter,moduleId:moduleId,privNoFlag:privNoFlag};
	var jsonRs = tools.requestJsonRs(url,para);
	if(jsonRs.rtState){
		var dataList = jsonRs.rtData;
...
function getDeptTree(){
	var url =  "<%=contextPath %>/orgSelectManager/getSelectDeptTreeAll.action?moduleId="+moduleId;
	var config = {
