...
function clickEvent(event, treeId, treeNode) {
	if(treeNode.params.type==1){//分类节点
		parent.document.getElementById("right").contentWindow.location=contextPath+"/system/core/workflow/flowtype/manage/list.jsp?sortId="+treeNode.id+"&sortName="+encodeURI(treeNode.name);
	}else if(treeNode.params.type==2){//表单节点
		parent.document.getElementById("right").contentWindow.location=contextPath+"/system/core/workflow/flowtype/manage/tabindex.jsp?flowTypeId="+treeNode.id;
	}
}
