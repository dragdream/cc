...
<table class="TableBlock" width="60%" align="center">
   ...
   <tr>
    <td nowrap class="TableHeader" colspan="2"><img src="<%=imgPath%>/green_arrow.gif" align="absMiddle"><span id = "span"></span></td>
   </tr>
   	<tr>
				...
				<td class="TableData" style="text-align: left;"><input type="hidden"
					name="users" id="users" required="true" value=""> <textarea cols="45"
						name="userNames" id="userNames" rows="10"
   ...
   <tr >
	    <td nowrap class="TableData">发起频率：</td>
