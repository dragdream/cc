...
<meta http-equiv="X-UA-Compatible" content="IE=Edge">
	...
	var userRoleForm;
	$(function() {
		var url = contextPath+"/flowRule/getEntrustRecordList.action";
...
<table id="datagrid" fit="true"></table>
	<div id="toolbar" style="padding-bottom: 5px;padding-top: 5px;"> 
		...
		<tr>
			<td >
				工作名称/文号：
				<input style="height: 25px;" type="text" id="qs" name="qs"/>
				&nbsp;&nbsp;
				<input style="width: 45px;height: 25px;" type='button' class='btn-win-white' value='查询' onclick='query();' >
			</td>
		</tr>
		</table>
		</form>
