...
function doInit(){
	var url = contextPath+"/flowRun/getBackPrcs.action";
	var json = tools.requestJsonRs(url,{flowId:flowId,frpSid:frpSid,runId:runId});
	if(json.rtState){
...
function commit(){
	...
	if($("#isPhoneRemind").attr("checked")=="checked"){
 	...
 	var url = contextPath+"/flowRun/backToFixed.action";
