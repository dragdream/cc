...
function getFileTree(){
	var url =  "<%=contextPath %>/repeatToPub/getPublicFolderTree.action";
	var config = {
...
function doSubmit(){
	if(checkForm()){
		var url = "<%=contextPath %>/repeatToPub/saveToPublicFolder.action";
...
function goBackFunc(){
	var url = contextPath + "/system/core/workflow/flowrun/prcs/repeatTo.jsp?runId="+runId+"&repeatForm="+repeatForm+"&repeatText="+repeatText+"&repeatFormatText="+repeatFormatText+"&repeatAttach="+repeatAttach+"&module=2";
	location.href = url;
}
