...
<meta http-equiv="X-UA-Compatible" content="IE=Edge">
	...
	function initDataGrid(){
		$('#datagrid').datagrid({
			url:contextPath+'/runRel/listCustomer.action',
			pagination:true,
			singleSelect:false,
	...
	function add(){
		...
		for(var i=0;i<selections.length;i++){
			arr.push(selections[i].sid);
		}
		
		var json = tools.requestJsonRs(contextPath+"/runRel/addCustomerRel.action",{ids:arr.join(","),runId:runId});
...
<body onload="doInit()">
	...
	<div id="toolbar" style="padding:5px">
		<div class="moduleHeader">
			<b><i class="glyphicon glyphicon-user"></i>&nbsp;我的客户</b>
		</div>
		客户名称：<input type="text" class="BigInput" id="title"/>
