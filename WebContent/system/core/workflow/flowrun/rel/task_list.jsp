...
<meta http-equiv="X-UA-Compatible" content="IE=Edge">
	...
	function initDataGrid(){
		$('#datagrid').datagrid({
			url:contextPath+'/runRel/listTask.action',
			pagination:true,
			singleSelect:false,
	...
	function add(){
		...
		var json = tools.requestJsonRs(contextPath+"/runRel/addTaskRel.action",{ids:arr.join(","),runId:runId});
...
<body onload="doInit()">
	...
	<div id="toolbar" style="padding:5px">
		<div class="moduleHeader">
			<b><i class="glyphicon glyphicon-tasks"></i>&nbsp;我的任务</b>
		</div>
		任务名称：<input type="text" class="BigInput" id="title"/>
