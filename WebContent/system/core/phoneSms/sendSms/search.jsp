...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/TeeSmsSendPhoneController/datagrid.action',
		pagination:true,
		singleSelect:false,
		...
		columns:[[
			...
			{field:'fromId',title:'短信发送人',width:100},
			{field:'phone',title:'接收人手机',width:100},
			{field:'content',title:'短信内容',width:100},
			{field:'sendTimeDesc',title:'发送时间',width:100},
			{field:'sendFlagDesc',title:'发送状态',width:100},
			{field:'2',title:'操作',formatter:function(e,rowData){
				return "<a href='#' onclick='edit("+rowData.sid+")'>编辑</a>&nbsp;&nbsp;<a href='#' onclick='send("+rowData.sid+")'>发送</a>&nbsp;&nbsp;<a href='#' onclick='showDetail("+rowData.sid+")'>查看</a>";
			}}
		]],
	});
}
...
<body onload="doInit()" style="overflow:hidden;font-size:12px">
	...
	<div id="toolbar">
		<div class="moduleHeader">
			<b><i class="glyphicon glyphicon-sound-stereo"></i>&nbsp;手机短信管理</b>
		</div>
