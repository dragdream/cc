...
<%
	...
	int salYear = cal.get(Calendar.YEAR);
	int salMonth = cal.get(Calendar.MONTH) + 1;
...
function expandNodes() {
 ...
 function onChangSelect(treeNode){
	 ...
	 $("#frame0").attr("src",contextPath+"/system/subsys/salary/report/queryStatistics.jsp?deptId="+deptId + "&accountId=" + accountId + "&salYear=" + salYear + "&salMonth=" + salMonth );
...
<div id="layout">
	...
	<div layout="north" height="50px" style="">
		<div class="moduleHeader">
			<b><i class="glyphicon glyphicon-sound-stereo"></i>&nbsp;员工工资明细统计</b>
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			工资账套：
			...
			工资月份：
       	  ...
       	  &nbsp;&nbsp;
    	  <button class="btn btn-primary" onclick="window.location.href='index.jsp'">返回</button> 
		</div>
	...
	<div layout="center" style="padding-left:10px;padding-bottom:10px;">
		<iframe id="frame0" frameborder="0" style="width:100%;height:100%" src="<%=contextPath %>/system/subsys/salary/report/queryStatistics.jsp"></iframe>
	</div>
</div>
</body>
</html>