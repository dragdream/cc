...
function doInit(){
    ...
    if(jsonRs2.rtState){
        ...
        if(json2!=null){
            PENSION_U_PAY=json2.pensionUPay/100;
            PENSION_U_PAY_ADD=json2.pensionUPayAdd/100;
            PENSION_P_PAY=json2.pensionPPay/100;
            PENSION_P_PAY_ADD=json2.pensionPPayAdd/100;
            HEALTH_P_PAY=json2.healthPPay/100;
            HEALTH_P_PAY_ADD=json2.healthPPayAdd/100;
            HEALTH_U_PAY=json2.healthUPay/100;
            HEALTH_U_PAY_ADD=json2.healthUPayAdd/100;
            UNEMPLOYMENT_P_PAY=json2.unemploymentPPay/100;
            UNEMPLOYMENT_P_PAY_ADD=json2.unemploymentPPayAdd/100;
            UNEMPLOYMENT_U_PAY=json2.unemploymentUPay/100;
            UNEMPLOYMENT_U_PAY_ADD=json2.unemploymentUPayAdd/100;
            HOUSING_P_PAY=json2.housingPPay/100;
            HOUSING_P_PAY_ADD=json2.housingPPayAdd/100;
            HOUSING_U_PAY=json2.housingUPay/100;
            HOUSING_U_PAY_ADD=json2.housingUPayAdd/100;
            INJURY_U_PAY=json2.injuryUPay/100;
            INJURY_U_PAY_ADD=json2.housingPPayAdd/100;
            MATERNITY_U_PAY=json2.maternityUPay/100;
            MATERNITY_U_PAY_ADD=json2.maternityUPayAdd/100; 
...
<table align="center" width="60%" class="TableBlock" enctype="multipart/form-data">
	<tr>
        <td nowrap class="TableHeader" colspan="2" style="text-align:left;">选择批量设置的人员范围:</td>
    </tr>
	<tr>
	    ...
	    <td class="TableData" colspan="3">
			...
			<a href="javascript:void(0);" class="orgClear" onClick="$('postDeptIds').value='';$('postDeptNames').value='';">清空</a>
	    </td>
	</tr>
    <tr>
      ...
      <td class="TableData" colspan="3">
        <input type="hidden" name="postUserRoleIds" id="postUserRoleIds" value="">
	      ...
	      <a href="javascript:void(0);" class="orgClear" onClick="$('postUserRoleIds').value='';$('postUserRoleNames').value='';">清空</a>
      </td>
   </tr>
   <tr>
  ...
  <tr class="TableData">
    ...
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="ALL_BASE" class="BigInputMoney" name="ALL_BASE" value="" size="20" maxlength="14">
  ...
  <tr class="TableLine1">
    ...
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="PENSION_BASE" class="BigInputMoney" name="PENSION_BASE" value="" size="20" maxlength="14">
    </td>                     
  </tr>
  <tr class="TableLine1">
    <td nowrap align="center" width="150">单位养老</td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="PENSION_U" class="BigInputMoney" name="PENSION_U" value="" size="20" maxlength="14">
    </td>                     
  </tr>
  <tr class="TableLine1">
    <td nowrap align="center" width="150">个人养老</td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="PENSION_P" class="BigInputMoney" name="PENSION_P" value="" size="20" maxlength="14">
    </td>                     
  </tr>  
  ...
  <tr class="TableLine2">
    ...
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="MEDICAL_BASE" class="BigInputMoney" name="MEDICAL_BASE" value="" size="20" maxlength="14">
    </td>                     
  </tr>
  <tr class="TableLine2">
    <td nowrap align="center" width="150">单位医疗</td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="MEDICAL_U" class="BigInputMoney" name="MEDICAL_U" value="" size="20" maxlength="14">
    </td>                     
  </tr>
  <tr class="TableLine2">
    <td nowrap align="center" width="150">个人医疗</td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="MEDICAL_P" class="BigInputMoney" name="MEDICAL_P" value="" size="20" maxlength="14">
    </td>                     
  </tr>  
  ...
  <tr class="TableLine1">
    ...
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="FERTILITY_BASE" class="BigInputMoney" name="FERTILITY_BASE" value="" size="20" maxlength="14">
    </td>                     
  </tr>    
  <tr class="TableLine1">
    <td nowrap align="center" width="150">单位生育</td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="FERTILITY_U" class="BigInputMoney" name="FERTILITY_U" value="" size="20" maxlength="14">
    </td>                     
  </tr>    
  <tr class="TableLine2">
    <td nowrap align="center" width="150">失业保险</td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="UNEMPLOYMENT_BASE" class="BigInputMoney" name="UNEMPLOYMENT_BASE" value="" size="20" maxlength="14">
    </td>                     
  </tr>    
  <tr class="TableLine2">
    <td nowrap align="center" width="150">单位失业</td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="UNEMPLOYMENT_U" class="BigInputMoney" name="UNEMPLOYMENT_U" value="" size="20" maxlength="14">
    </td>                     
  </tr>    
  <tr class="TableLine2">
    <td nowrap align="center" width="150">个人失业</td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="UNEMPLOYMENT_P" class="BigInputMoney" name="UNEMPLOYMENT_P" value="" size="20" maxlength="14">
    </td>                     
  </tr>      
  <tr class="TableLine1">
    <td nowrap align="center" width="150">工伤保险</td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="INJURIES_BASE" class="BigInputMoney" name="INJURIES_BASE" value="" size="20" maxlength="14">
    </td>                     
  </tr>      
  <tr class="TableLine1">
    <td nowrap align="center" width="150">单位工伤</td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="INJURIES_U" class="BigInputMoney" name="INJURIES_U" value="" size="20" maxlength="14">
    </td>                     
  </tr>      
  <tr class="TableLine2">
    <td nowrap align="center" width="150">住房公积金</td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="HOUSING_BASE" class="BigInputMoney" name="HOUSING_BASE" value="" size="20" maxlength="14">
    </td>                     
  </tr>      
  <tr class="TableLine2">
    <td nowrap align="center" width="150">单位住房</td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="HOUSING_U" class="BigInputMoney" name="HOUSING_U" value="" size="20" maxlength="14">
    </td>                     
  </tr>    
  <tr class="TableLine2">
    <td nowrap align="center" width="150">个人住房</td>
    <td nowrap align="left">
       <input type="text" style="text-align: right;" id="HOUSING_P" class="BigInputMoney" name="HOUSING_P" value="" size="20" maxlength="14">
    </td>                     
  </tr>
  <c:if test="${fn:length(caiwuList)>0}">
	    <tr class="TableHeader">
		      <td nowrap align="center">财务录入项</td>
		      <td nowrap align="center">金额</td>
		</tr> 
	    <c:forEach items="${caiwuList}" var="caiwuListSort" varStatus="caiwuListStatus">
	        <tr class="TableLine2">
			    <td nowrap align="center" width="150">${caiwuList[caiwuListStatus.index].itemName}</td>
			    <td nowrap align="left">
			       <input type="text" style="text-align: right;" id="add_${caiwuList[caiwuListStatus.index].sid}" class="BigInputMoney" name="add_${caiwuList[caiwuListStatus.index].sid}" value="" size="20" maxlength="14">
			    </td>   
		   </tr>
	    </c:forEach>
    </c:if>   
     <c:if test="${fn:length(bumenList)>0}">
        <tr class="TableHeader">
              <td nowrap align="center">部门上报项</td>
              <td nowrap align="center">金额</td>
        </tr> 
        <c:forEach items="${bumenList}" var="bumenListSort" varStatus="bumenListStatus">
            <tr class="TableLine2">
                <td nowrap align="center" width="150">${bumenList[bumenListStatus.index].itemName}</td>
                <td nowrap align="left">
                   <input type="text" style="text-align: right;" id="add_${bumenList[bumenListStatus.index].sid}" class="BigInputMoney" name="add_${bumenList[bumenListStatus.index].sid}" value="" size="20" maxlength="14">
                </td>   
           </tr>
        </c:forEach>
    </c:if>   
    <c:if test="${fn:length(jisuanList)>0}">
        ...
        <c:forEach items="${jisuanList}" var="jisuanListSort" varStatus="jisuanListStatus">
            <tr class="TableLine2">
                ...
                <td nowrap align="left">
                   <input type="text" style="text-align: right;" id="add_${jisuanList[jisuanListStatus.index].sid}" class="BigInputMoney" name="add_${jisuanList[jisuanListStatus.index].sid}" value="" size="20" maxlength="14">
                   <br>
