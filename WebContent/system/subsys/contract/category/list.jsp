...
<%@ include file="/header/easyui.jsp" %>
	...
	$(function() {
		$('#datagrid').datagrid({
			url:contextPath+'/contractCategory/datagrid.action',
			pagination:true,
			singleSelect:true,
			...
			columns:[[
				...
				{field:'viewPrivNames',title:'查看人员',width:200},
				{field:'managePrivNames',title:'管理人员',width:200},
	...
	function del(sid){
		if(window.confirm("是否要删除该分类？注：删除后会级联删除该分类下的类别和合同！请慎重！")){
			var json = tools.requestJsonRs(contextPath+"/contractCategory/delete.action?sid="+sid,{});
