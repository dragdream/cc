...
<%@ include file="/header/upload.jsp" %>
	...
	function save(){
		...
		var json = tools.requestJsonRs(contextPath+"/contract/add.action",para);
		alert(json.rtMsg);
		if(json.rtState){
			try{
...
<table class="TableBlock" width="760" align="center" id="form1">
  ...
  <tr>
    ...
    <td nowrap align="left" class="TableData" width="180">
    	<input type="text" class="BigInput easyui-validatebox" required id="contractName" name="contractName"/>
    </td>  
  ...
  <tr>
    ...
    <td class="TableData" width="180">
    	<select id="categoryId" name="categoryId" onchange="changeSort(this.value)" class="BigSelect  easyui-validatebox">
    	</select>
    </td>  	
    ...
    <td class="TableData" width="180" colspan="3">
    	<select id="contractSortId" name="contractSortId" class="BigSelect easyui-validatebox" required>
    	</select>
    </td>         
