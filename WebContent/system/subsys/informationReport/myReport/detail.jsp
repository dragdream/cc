...
//历史信息  查看详情
function detail(sid){
	window.location.href=contextPath+"/system/subsys/informationReport/myReport/detail.jsp?taskPubRecordItemId="+sid+"&taskTemplateName="+taskTemplateName+"&taskTemplateId="+taskTemplateId;
}
</script>
</head>
<body onload="doInit();" style="padding-left: 10px;padding-right: 10px;">
    <div class="topbar clearfix" id="toolbar">
	   <div class="fl" style="position:static;">
			<img id="img1" class = 'title_img' src="<%=contextPath %>/system/subsys/informationReport/imgs/icon_hbxq
			.png">
