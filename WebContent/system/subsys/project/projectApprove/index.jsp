...
<script>
 $.addTab("tab","tab-content",[{title:"待审批",url:contextPath+"/system/subsys/project/projectApprove/noApproved.jsp"},
                              {title:"已审批",url:contextPath+"/system/subsys/project/projectApprove/haveApproved.jsp"},
                              ]); 
