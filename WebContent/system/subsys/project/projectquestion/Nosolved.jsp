...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+"/projectQuestionController/getQuestionListByStatus.action?status=0",
		...
		columns:[[
			...
			{field:'opt_',title:'操作',width:100,formatter:function(value,rowData,rowIndex){
				return "<a href='#' onclick=\"questionDetail("+rowData.sid+")\">详情</a>&nbsp;&nbsp;&nbsp;<a href=\"#\" onclick=\"handle("+rowData.sid+")\">办理</a>";
			}},
...
//问题办理
function handle(sid){
	var url=contextPath+"/system/subsys/project/projectquestion/handle.jsp?sid="+sid;
	bsWindow(url ,"问题办理",{width:"600",height:"180",buttons:
		[
