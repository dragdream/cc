...
<body onload="" style="overflow: hidden;padding-left:10px;padding-right:10px;padding-top: 5px">
	...
	<div class="titlebar clearfix" >
		<img class = 'tit_img' style="margin-right:10px" src="<%=contextPath %>/system/subsys/project/img/icon_woderenwu.png">
...
<script>
 $.addTab("tab","tab-content",[{title:"办理中",url:contextPath+"/system/subsys/project/mytask/ongoing.jsp"},
                              {title:"已结束",url:contextPath+"/system/subsys/project/mytask/ended.jsp"}
                              ]); 
