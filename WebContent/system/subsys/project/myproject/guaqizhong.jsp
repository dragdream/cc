...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath + "/projectController/getHangProject.action?status=4",
		...
		columns:[[
			...
			{field:'opt_',title:'操作',width:120,formatter:function(value,rowData,rowIndex){
				return "<a href=\"#\" onclick=\"detail('"+rowData.uuid+"')\">详情</a>&nbsp;&nbsp;<a href=\"#\" onclick=\"restore('"+rowData.uuid+"')\">还原</a>";
			}}
		]]
	});
...
function  restore(uuid){
	$.MsgBox.Confirm ("提示", "是否确认还原该项目？", function(){
