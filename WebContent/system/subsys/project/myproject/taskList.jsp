...
//判断 当前登陆的用户是不是项目的负责人 或者创建人
function isCreaterOrManager(){
...
<body onload="doInit()" style="padding-left: 10px;padding-right: 10px">
    <div id="toolbar" class="topbar clearfix">
        ...
        <div class="right fr">
           <input type="button" id="creBtn" value="创建任务"  class="btn-win-white" style="display: none" onclick="createTask('<%=projectId%>')"/>
        </div>
    </div>
