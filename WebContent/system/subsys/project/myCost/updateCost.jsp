...
function getInfoBySid(){
	var url=contextPath+"/projectCostController/getInfoBySid.action";
...
function commit(){
	if(check()){
		var url=contextPath+"/projectCostController/update.action";
...
<form id="form1">
   ...
   <table class="TableBlock" width="100%">
      ...
      <tr>
          ...
          <td>
             <textarea rows="6" cols="60" id="description" name="description" class="BigTextArea"></textarea>
          </td>
      </tr>
   </table>
</form>
