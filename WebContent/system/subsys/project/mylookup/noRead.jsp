...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath + "/projectCopyController/getMyLookUpByReadFlag.action?readFlag=0",
		...
		columns:[[
			...
			{field:'projectName',title:'项目名称',width:100,formatter:function(value,rowData,rowIndex){
				...
				return "<a href='#' onclick=\"detail('"+rowData.projectId+"',"+rowData.sid+")\">"+rowData.projectName+"</a>";
			}},
