...
<script>
 $.addTab("tab","tab-content",[{title:"项目类型",url:contextPath+"/system/subsys/project/setting/typesetting/projectType.jsp"},
                              {title:"费用类型",url:contextPath+"/system/subsys/project/setting/typesetting/costType.jsp"},
                              ]); 
