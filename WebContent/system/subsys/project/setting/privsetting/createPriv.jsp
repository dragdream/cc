...
//初始化
function doInit(){
	var url=contextPath+"/projectCreatePrivController/getData.action"
...
function  commit(){
	...
	var url = contextPath + "/projectCreatePrivController/setData.action";
 ...
 <form id="form1">
  <div style="margin-top: 15px">
      <table class="TableBlock_page">
        <tr>
           <td style="text-indent: 15px;width: 15%" >授权范围（部门）：</td>
           <td style="width: 85%">
              <input name="deptIds" id="deptIds" type="hidden"/>
			  <textarea class="BigTextarea readonly" id="deptNames" name="deptNames" style="height:80px;width:55%"  readonly></textarea>
			  <span class='addSpan'>
        ...
        <tr>
           <td style="text-indent: 15px;width: 15%">授权范围（角色）：</td>
           <td style="width: 85%">
              <input name="roleIds" id="roleIds" type="hidden"/>
			  <textarea class="BigTextarea readonly" id="roleNames" name="roleNames" style="height:80px;width:55%"  readonly></textarea>
			  <span class='addSpan'>
        ...
        <tr>
           ...
           <td style="width: 85%">
			  ...
			  <textarea class="BigTextarea readonly" id="userNames" name="userNames" style="height:80px;width:55%"  readonly></textarea>
			  <span class='addSpan'>
