...
function map(coordinate,addr){
	...
	bsWindow(url ,"查看地址",{width:"800",height:"400",buttons:
		[
...
<table class="TableBlock_page" width="60%" align="center">
   ...
   <tr>
    <td  class="TableData" width="150" style="text-indent:15px">项目进度：</td>
    <td  class="TableData" align="left" id="progress" name="progress" class="val">
