...
String provinceCode = TeeStringUtil.getString(request.getParameter("provinceCode"), "0");
...
<table align="center" width="90%" class="TableBlock" >
	<tr>
		<td nowrap class="TableData"  width="15%;" >城市编号：<font style='color:red'>*</font></td>
		<td class="TableData" width="35%;" >
			<input type="hidden" name="cityCode" id ="cityCode" value=""/>
			
			<input type="text" name="cityCodeTemp" id="cityCodeTemp" class="BigInput  easyui-validatebox" disabled="disabled" size="2" value="<%=provinceCode.substring(0,2) %>"  maxlength="2">
			...
			<input type="text" name="cityCodeEnd" id="cityCodeEnd" class="BigInput  easyui-validatebox" disabled="disabled" size="2" value="00"  maxlength="2">
			<span id="cityCodeSpan"></span>
		</td>
	</tr>
	<tr>
		<td nowrap class="TableData"  width="15%;" >城市名称：<font style='color:red'>*</font></td>
