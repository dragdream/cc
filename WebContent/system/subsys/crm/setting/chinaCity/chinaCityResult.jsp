...
省份：
<select  name="province" id="province" onchange="getCity();" class="BigSelect easyui-validatebox">
	<option>请选择</option>
</select>
城市：
<select name="city" id="city" onchange="getCounty();" class="BigSelect easyui-validatebox">
	<option>请选择</option>
</select>
县：
