...
<table class="TableBlock" width="80%" align="center">
			<tr class="TableLine1">
				<td nowrap>代码编号：</td>
				<td nowrap>
					<INPUT type=text name="codeNo" id="codeNo" class="easyui-validatebox BigInput" required="true"  maxlength="130"  size="25">
			...
			<tr class="TableLine2">
				<td nowrap>代码名称：</td>
				<td nowrap><input type="text" name="codeName" id="codeName" class="easyui-validatebox BigInput" required="true" size="25">&nbsp;</td>
			</tr>
