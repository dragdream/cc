...
function doInit(){
	...
	//添加例子一
	if(sid > 0){
		var url = "<%=contextPath %>/crmCode/getById.action";
		var para = {sid:sid};
...
function doSaveOrUpdate(callback){
	if (check()){
		var url = "<%=contextPath %>/crmCode/addOrUpdateSysPara.action";
...
<table class="TableBlock" width="80%" align="center">
			...
			<tr class="TableLine1">
				<td nowrap>代码编号：</td>
				<td nowrap>
					<INPUT type=text name="codeNo" id="codeNo" class="easyui-validatebox BigInput" required="true" size="25" maxlength="30" >
			...
			<tr class="TableLine1" style="display:none;">
				<td nowrap>排序号：</td>
				<td nowrap>
					<INPUT type=text name="codeOrder" id="codeOrder" class="easyui-validatebox BigInput" size="25" maxlength="10" value ="0" validType="integeZero[]" >
			...
			<tr class="TableLine2">
				<td nowrap>代码名称：</td>
				<td nowrap>
					<input type='text' name="codeName" id="codeName" maxlength="200" class="easyui-validatebox BigInput" size="25" required="true">&nbsp;
				</td>
			</tr>
<!-- 
