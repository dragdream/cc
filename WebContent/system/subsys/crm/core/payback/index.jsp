...
//新建回款
function add(){
	var url = contextPath+"/system/subsys/crm/core/payback/addOrUpdate.jsp";
	location.href=url;
}
...
<body onload="doInit();"  style="overflow:hidden;padding-left:10px;padding-right:10px;">
 ...
 <div class="titlebar clearfix" >
		<img class = 'tit_img' style="margin-right: 10px;" src="<%=contextPath%>/system/subsys/crm/img/icon_hk.png">
		<p class="title">回款</p>
		<ul id = 'tab' class = 'tab clearfix' style='display:inline-block;'>
		</ul>
	<div class="right fr clearfix" style="padding-top: -1px;">
      <input type="button" value="新建回款" class="btn-win-white" onclick="add();"/>
       ...
       <table class="TableBlock" width="100%"  style="font-size:12px" id="searchTable">
          <tr>
			...
			<td width="40%">
             ...
             <td width="10%">回款编号：</td>
             <td width="40%">
                <input  style="width: 300px;" type="text" name="paybackNo" id="paybackNo"/>
             </td>
          </tr>
          <tr>
            <td width="10%">回款方式：</td>
             <td width="40%">
              <select class="BigSelect" id='paybackStyle' name='paybackStyle' style="width:180px;">
          ...
          <tr>
            <td>回款日期：</td>
             <td>
                 <input type="text" style="width: 180px;" requried id='paybackTimeDesc' onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" name='paybackTimeDesc' class="Wdate BigInput" />
             </td>
              <td>状态：</td>
             <td>
                <select style="width: 180px;" id="paybackStatusDesc" name="paybackStatusDesc" >
                   <option value="0">全部</option>
...
<script type="text/javascript">
var customerId = "<%=sid%>";
 $.addTab("tab","tab-content",[{title:"全部",url:contextPath+"/system/subsys/crm/core/payback/paybackList.jsp?type=1"},
                              {title:"我负责的",url:contextPath+"/system/subsys/crm/core/payback/paybackList.jsp?type=2"},
                              {title:"我下属负责的",url:contextPath+"/system/subsys/crm/core/payback/paybackList.jsp?type=3"},
                              ]); 
