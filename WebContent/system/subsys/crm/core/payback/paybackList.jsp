...
function query(params){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/TeeCrmPaybackController/datagrid.action?type='+type, //回款列表
		pagination:true,
		singleSelect:true,
		queryParams:params,
...
function showDetail(sid,customerName){
	...
	var url = contextPath+"/system/subsys/crm/core/payback/paybackInfo.jsp?sid="+sid+"&customerName="+customerName+"&type="+type;;
	openFullWindow(url);
	//location.href=url;
}
