...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/TeeCrmOrderController/datagrid.action?orderStatus=1',  //订单列表
		pagination:true,
		singleSelect:true,
...
function showDetail(sid,customerName){
	var url = contextPath+"/system/subsys/crm/core/order/approveOrderDetial.jsp?sid="+sid+"&customerName="+customerName;
	openFullWindow(url);
	//location.href=url;
}
