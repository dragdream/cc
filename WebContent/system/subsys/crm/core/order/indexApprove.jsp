...
<script>
 $.addTab("tab","tab-content",[{title:"待确认",url:contextPath+"/system/subsys/crm/core/order/noApproved.jsp"},
                              {title:"已确认",url:contextPath+"/system/subsys/crm/core/order/haveApproved.jsp"},
                              {title:"已驳回",url:contextPath+"/system/subsys/crm/core/order/haveRejected.jsp"}
                              ]); 
