...
function query(params){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/TeeCrmInvoiceController/datagrid.action?type='+type, //开票列表
		pagination:true,
		singleSelect:true,
		queryParams:params,
...
function showDetail(sid,customerName){
	...
	var url = contextPath+"/system/subsys/crm/core/invoice/invoiceInfo.jsp?sid="+sid+"&customerName="+customerName+"&type="+type;;
	openFullWindow(url);
	//location.href=url;
}
