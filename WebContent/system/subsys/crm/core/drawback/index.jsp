...
//新建退款
function add(){
	var url = contextPath+"/system/subsys/crm/core/drawback/addOrUpdate.jsp";
	location.href=url;
}
...
<body onload="doInit();"  style="overflow:hidden;padding-left:10px;padding-right:10px;">
 ...
 <div class="titlebar clearfix" >
		<img class = 'tit_img' style="margin-right: 10px;" src="<%=contextPath%>/system/subsys/crm/img/icon_tk.png">
		<p class="title">退款</p>
       ...
       <table class="TableBlock" width="100%"  style="font-size:12px" id="searchTable">
          <tr>
			...
			<td width="40%">
             ...
             <td width="10%">退款编号：</td>
             <td width="40%">
                <input  style="width: 300px;" type="text" name="drawbackNo" id="drawbackNo"/>
             </td>
          </tr>
          <tr>
            <td width="10%">退款方式：</td>
             <td width="40%">
              <select class="BigSelect" id='drawbackStyle' name='drawbackStyle' style="width:180px;">
          ...
          <tr>
            <td>退款日期：</td>
             <td>
                 <input type="text" style="width: 180px;" requried id='drawbackTimeDesc' onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})" name='drawbackTimeDesc' class="Wdate BigInput" />
             </td>
              <td>状态：</td>
             <td>
                <select style="width: 180px;" id="drawbackStatusDesc" name="drawbackStatusDesc" >
                   <option value="0">全部</option>
...
<script type="text/javascript">
var customerId = "<%=sid%>";
 $.addTab("tab","tab-content",[{title:"全部",url:contextPath+"/system/subsys/crm/core/drawback/drawbackList.jsp?type=1"},
                              {title:"我负责的",url:contextPath+"/system/subsys/crm/core/drawback/drawbackList.jsp?type=2"},
                              {title:"我下属负责的",url:contextPath+"/system/subsys/crm/core/drawback/drawbackList.jsp?type=3"},
                              ]); 
