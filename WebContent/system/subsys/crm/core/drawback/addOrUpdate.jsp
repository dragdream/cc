	...
	if(sid>0){
		    ...
		    var json=tools.requestJsonRs(url,param);
			    if(json.rtState){
			    	  parent.$.MsgBox.Alert_auto(json.rtMsg);
				        window.location.href=contextPath+"/system/subsys/crm/core/drawback/drawbackInfo.jsp?sid="+sid+"&customerName="+cusName;
		...
		if(check()){
		    ...
		    if(json.rtState){
			         ...
			         window.location.href=contextPath+"/system/subsys/crm/core/drawback/index.jsp";
		    	 });
		    	 };	
		}
...
function goBack(){
	...
	if(sid>0){
	    ...
	    url= contextPath+"/system/subsys/crm/core/drawback/index.jsp";
	}
	location.href=url;
}
...
<form method="post" name="form1" id="form1" >
	<table class="TableBlock_page" width="60%" align="center">
        ...
        <tr>
         ...
         <tr>
          <td class="TableData" width="150" style="text-indent:15px">退款金额（元） <span style="color:red;font-weight:bold;">*</span>：</td>
		   <td class="TableData">
				<input non_negative='true' type="text" style="width: 350px;" requried id="drawbackAmount" name="drawbackAmount" class="BigSelect"></select>
		   </td>
        </tr>
        <tr>
	   ...
	   <tr>
		   ...
		   <td class="TableData">
				<textarea id="remark" name="remark" class="BigTextarea" cols='50' rows='6'></textarea>
			</td>
	   </tr>
	   <tr>
