...
function doInit(){
	...
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/TeeCrmCustomerInfoController/datagrid.action?industry='+industryType+"&type="+type,
		pagination:true,
		singleSelect:false,
...
function showDetail(sid){
	var url = contextPath+"/system/subsys/crm/core/customInfo/detail.jsp?sid="+sid+"&industryType="+industryType+"&type="+type;
	location.href=url;
}
function add(){
	var url = contextPath+"/system/subsys/crm/core/customInfo/addOrEditCustomer.jsp?industryType="+industryType;
	location.href=url;
}

function edit(sid){
	datagrid.datagrid("unselectAll");
	var url = contextPath+"/system/subsys/crm/core/customInfo/addOrEditCustomer.jsp?sid="+sid+"&industryType="+industryType;
	location.href=url;
}
		        ...
		        <table class="SearchTable" style="text-align:left;">
								<tr>
									...
									<td>
										...
										<input id='industry' name='industry' value='<%=industryType %>' type="hidden"/>
									</td>
								</tr>
								<tr>
