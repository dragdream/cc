...
function doInit(){
	...
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/TeeCrmCustomerInfoController/datagrid.action?type=1',//type=3代表公海客户，type=2 代表所有的客户，type =1 共享客户  没有type代表我的客户
		pagination:true,
		singleSelect:false,
...
function showDetail(sid){
	var url = contextPath+"/system/subsys/crm/core/customInfo/detail.jsp?sid="+sid+"&type=1";
	location.href=url;
}

function edit(sid){
	openFullWindow(contextPath+"/system/subsys/crm/core/customInfo/addOrEditCustomer.jsp?sid="+sid+"&type=1","编辑客户信息");
}
