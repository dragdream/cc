...
function doInit(){
	...
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/TeeCrmCustomerInfoController/datagrid.action?type=3',//type=3代表公海客户，type=2 代表所有的客户，type =1 共享客户  没有type代表我的客户
		pagination:true,
		singleSelect:false,
		...
		columns:[[
			...
			{field:'2',title:'操作',formatter:function(e,rowData){
				return "<a href='#' onclick='collar("+rowData.sid+")'>领用</a>&nbsp;&nbsp;<a href='#' onclick='showDetail("+rowData.sid+")'>查看</a>";
			}},
...
function showDetail(sid){
	var url = contextPath+"/system/subsys/crm/core/customInfo/detail.jsp?sid="+sid+"&type=3";
	location.href=url;
}
 ...
 */
function collar(sid){
	$.jBox.confirm("确认领用该客户吗？","确认",function(v){
		if(v=="ok"){
			var url = contextPath+"/TeeCrmCustomerInfoController/collarCustomer.action";
