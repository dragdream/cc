...
<script>
 $.addTab("tab","tab-content",[{title:"待确认",url:contextPath+"/system/subsys/crm/core/returnOrder/noApproved.jsp"},
                              {title:"已确认",url:contextPath+"/system/subsys/crm/core/returnOrder/haveApproved.jsp"},
                              {title:"已驳回",url:contextPath+"/system/subsys/crm/core/returnOrder/haveRejected.jsp"}
                              ]); 
