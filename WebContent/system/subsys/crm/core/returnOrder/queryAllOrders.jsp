...
$(function(){
	...
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/TeeCrmOrderController/datagrid.action',
		toolbar : '#toolbar',
		...
		columns:[[
                    {field:'sid',checkbox:true,title:'ID',width:100},
		      	    {field:'2',title:'操作',width:60,formatter:function(e,rowData){
					...
					{field:'orderStatusDesc',title:'状态',align: 'center',width:100},
