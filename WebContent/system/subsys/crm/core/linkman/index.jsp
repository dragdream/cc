...
//新建联系人
function add(){
	var url = contextPath+"/system/subsys/crm/core/linkman/addOrEditContactUser.jsp";
	location.href=url;
}
...
<body onload=""  style="overflow:hidden;padding-left:10px;padding-right:10px;">
 ...
 <div class="titlebar clearfix" >
		<img class = 'tit_img' style="margin-right: 10px;" src="<%=contextPath%>/system/subsys/crm/img/icon_lxrgl--.png">
		<p class="title">联系人</p>
		<ul id = 'tab' class = 'tab clearfix' style='display:inline-block;'>
		</ul>
	<div class="right fr clearfix" style="padding-top: -1px;">
      <input type="button" value="新建联系人" class="btn-win-white" onclick="add();"/>
	 ...
	 <form id="form1" class='ad_sea_Content'>
       <table class="TableBlock" width="100%"  style="font-size:12px" id="searchTable">
        <tr>
           <td width="10%">姓名：</td>
             <td width="40%">
                 <input style="width: 300px;" id="contactName" name="contactName" type='text'/>
             </td>
             <td width="10%">
				公司：
			</td>
           ...
           <td width="10%">邮件：</td>
			...
			<td width="40%">
				<select style="width: 300px;" id="isKeyPerson" name="isKeyPerson" >
          ...
          <tr>
           <td width="10%">性别：</td>
             <td width="40%">
                 <select style="width: 300px;" id="gender" name="gender">
...
<script type="text/javascript">
var customerId = "<%=sid%>";
 $.addTab("tab","tab-content",[{title:"全部",url:contextPath+"/system/subsys/crm/core/linkman/contactsList.jsp?type=1"},
                              {title:"我负责的",url:contextPath+"/system/subsys/crm/core/linkman/contactsList.jsp?type=2"},
                              {title:"我下属负责的",url:contextPath+"/system/subsys/crm/core/linkman/contactsList.jsp?type=3"},
                              ]); 
