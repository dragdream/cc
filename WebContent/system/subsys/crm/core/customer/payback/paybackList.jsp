...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		...
		columns:[[
			...
			{field:'paybackNo',title:'回款编号',width:80,formatter:function(value,rowData,rowIndex){
				return "<a href=\"#\" onclick=\"showDetail("+rowData.sid+",'"+rowData.customerName+"')\">"+rowData.paybackNo+"</a>";
			}},
			{field:'customerName',title:'客户名称',width:120},
			{field:'orderNo',title:'销售订单编号',width:120},
			{field:'paybackStatusDesc',title:'回款状态',width:80},
			{field:'paybackTimeDesc',title:'回款日期',width:100},
			{field:'paybackAmount',title:'回款金额（元）',width:100},
			{field:'managePersonName',title:'负责人',width:80},
			{field:'paybackStyleDesc',title:'回款方式',width:100},
...
function showDetail(sid,customerName){
	var url = contextPath+"/system/subsys/crm/core/customer/payback/paybackInfo.jsp?sid="+sid+"&customerName="+customerName;
	//openFullWindow(url);
	location.href=url;
}
...
function add(){
	  var title = "新建回款";
	  var url = contextPath+"/system/subsys/crm/core/customer/payback/addOrUpdate.jsp?customerId="+cusId+"&customerName="+customerName;
