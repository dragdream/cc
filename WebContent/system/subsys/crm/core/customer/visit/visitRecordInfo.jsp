...
function edit(){
	 var title = "编辑商机";
	  var url = contextPath+"/system/subsys/crm/core/customer/visit/addOrEditVisit.jsp?sid="+sid+"&customerId="+customerId+"&customerName="+customerName;
	  bsWindow(url ,title,{width:"700",height:"300",buttons:
			...
			if(v=="确定"){
				cw.save(function(){
				  ...
				  xparent.datagrid.datagrid("unselectAll");
