	...
	<table class="TableBlock" width="100%" align="center">
	    ...
	    <tr>
          <td class="TableData" width="150" style="text-indent:15px">开票编号 <span style="color:red;font-weight:bold;">*</span>：</td>
		   <td class="TableData">
				<input type="text" style="height:23px; width: 200px;" requried id="invoiceNo" name="invoiceNo" class="BigSelect"></select>
		   </td>
        </tr>
        ...
        <tr>
          <td class="TableData" width="150" style="text-indent:15px">开票金额（元） <span style="color:red;font-weight:bold;">*</span>：</td>
		   <td class="TableData">
				<input non_negative='true' type="text" style="height:23px;width: 200px;" requried id="invoiceAmount" name="invoiceAmount" class="BigSelect"></select>
		   </td>
        </tr>
        <tr>
