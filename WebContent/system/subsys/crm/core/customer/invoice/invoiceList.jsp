...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/TeeCrmInvoiceController/datagrid.action?cusId='+cusId, //开票列表
		pagination:true,
		singleSelect:true,
		...
		columns:[[
			...
			{field:'invoiceNumber',title:'开票号码',width:100},
...
function showDetail(sid,customerName){
	...
	var url = contextPath+"/system/subsys/crm/core/customer/invoice/invoiceInfo.jsp?sid="+sid+"&customerName="+customerName;
	location.href=url;
}

function add(){
	  var title = "新建开票";
	  var url = contextPath+"/system/subsys/crm/core/customer/invoice/addOrUpdate.jsp?customerId="+cusId+"&customerName="+customerName;
