...
function getInvoiceInfoBySid(sid){
	...
	if(json.rtState){
		...
		var invoiceStatus = data.invoiceStatusDesc;
...
function edit(){
	 var title = "编辑开票申请";
	  var url = contextPath+"/system/subsys/crm/core/customer/invoice/addOrUpdate.jsp?sid="+sid+"&customerId="+customerId+"&customerName="+customerName;
