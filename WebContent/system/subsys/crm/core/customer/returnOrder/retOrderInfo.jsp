...
function doInit(){
	...
	if(sid!="" && sid!=null && sid!="null"){
		...
		if(json.rtState){
			...
			returnOrderStatus = json.rtData.returnOrderStatusDesc;
			addMenu(returnOrderStatus);
		}
		
		getProductList(sid,json.rtData.orderId);
	}
}

//获取产品集合
function getProductList(sid,orderId){
...
//同意
function agree(sid){
	 $.MsgBox.Confirm ("提示", "确定退货单信息无误？",function(){
		 var url=contextPath+"/TeeCrmReturnOrderController/agree.action?sid="+sid+"&returnOrderStatus=2";
...
function reject(sid){
	var title = "驳回";
	  var url = contextPath + "/system/subsys/crm/core/returnOrder/reject.jsp?sid="+sid;
...
function deleteById(sid){
	$.MsgBox.Confirm("提示","确定删除这个退货单？删除退货单将删除此退货单下关联的数据，删除后不可恢复！",function(){
		var url = contextPath+ "/TeeCrmReturnOrderController/delById.action?sid="+sid;
...
function edit(){
	 var title = "编辑提货单";
	  var url = contextPath+"/system/subsys/crm/core/customer/returnOrder/addOrUpdateOrder.jsp?sid="+sid+"&customerId="+customerId+"&customerName="+customerName;
...
<div class="topbar clearfix" id="toolbar">
    <div class="fl" style="position:static;">
		...
		<span class="title">{<%=customerName %>}--退货单详情</span>
	</div>
	...
	<table style="width: 100%;margin-top: 10px;">
		...
		<tr>
            <td width="150" style="text-indent:15px;line-height: 30px;">退货单编号：</td>
            <td align="left" name="returnOrderNo" id="returnOrderNo">
           </td>
        </tr>
        <tr class='TableData' align='left'>
			<td width="150" style="text-indent:15px;line-height: 30px;">
        ...
        <tr>
           <td width="150" style="text-indent:15px;line-height: 30px;">退单日期：</td>
		   <td id="returnTimeDesc" name="returnTimeDesc">
		   </td>
        </tr>
        <tr>
           <td width="150" style="text-indent:15px;line-height: 30px;">退货原因：</td>
		   <td id="returnReasonDesc" name="returnReasonDesc">
		   </td>
        </tr>
        <tr>
	   ...
	   <tr>
			<td width="150" style="text-indent:15px;line-height: 30px;">退货备注：
			</td>
		    <td name="returnRemark" id="returnRemark">
            </td>
	</tr>
  </table>
</br>	  
 <table style="width: 100%;">
	...
	<tr>
		    ...
		    <td name="returnOrderStatusDesc" id="returnOrderStatusDesc">
            </td>
	</tr>
 ...
 <table style="width: 100%;margin-top: 10px;">
	    <div style="margin-top: 15px;margin-bottom: 5px;">
	         <img src="<%=contextPath %>/common/zt_webframe/imgs/zsjl/ggtxb/icon_fenzu.png" alt="" style="vertical-align: text-top;"/>
		    &nbsp;<span style="font-size: 16px;line-height: 16px;color: #0050aa;font-family: 'MicroSoft YaHei';">退货产品</span>
		    <span style="padding-top: 10px;padding-bottom: 5px;" class="basic_border_grey fl"></span> 
		...
		<tr>
	    	...
	    	<td colspan="2"  align="left" style="text-align: left;"> 
	    		 <div style="padding:0px 25px 0px 25px;">
	    			 ...
	    			 <table class="TableBlock_page" style="width:100%" align="center" >
		    		 	<tr>
