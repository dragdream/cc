...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/TeeCrmReturnOrderController/datagrid.action?cusId='+cusId,  //订单列表
		pagination:true,
		singleSelect:true,
...
function showDetail(sid,customerName){
	var url = contextPath+"/system/subsys/crm/core/customer/returnOrder/retOrderInfo.jsp?sid="+sid+"&customerName="+customerName;
	location.href=url; 
}
...
function add(){
	  var title = "新建退货单";
	  var url = contextPath+"/system/subsys/crm/core/customer/returnOrder/addOrUpdateOrder.jsp?customerId="+cusId+"&customerName="+customerName;
