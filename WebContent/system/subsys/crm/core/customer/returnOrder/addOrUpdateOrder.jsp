...
/* 	item_number_input.validatebox({ 
	...
	//价格
	var item_price_input = $("<input type='text' non_negative='true' required style='line-height:20px;width:60px;'>").addClass("")
...
function goBack(){
	...
	if(sid>0){
	    ...
	    url= contextPath+"/system/subsys/crm/core/returnOrder/index.jsp";
	}
	location.href=url;
}
