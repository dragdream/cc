		    ...
		    var json=tools.requestJsonRs(url,param);
			    if(json.rtState){
			    	 ...
			    	 /*  parent.$.MsgBox.Alert_auto(json.rtMsg,function(){
				        ...
				        //window.location.href=contextPath+"/system/subsys/crm/core/customer/customerList.jsp";
			    	  }); */
			          }else{
...
function checkCustomerIsExist(){
	...
	var json=tools.requestJsonRs(url,{customerName:customerName});
	if(json.rtState){
		var data=json.rtData;
		if(data==1){
...
function goBack(){
	...
	if(sid>0){
	    ...
	    url= contextPath+"/system/subsys/crm/core/customer/customerList.jsp";
	}
	location.href=url;
}
	  ...
	  <tr>
	      <td class="TableData" width="150" style="text-indent:15px">负责人：</td>
			<td class="TableData">
				...
				<input name="managePersonName" id="managePersonName" style="height:23px;width:350px;"   class="BigInput" wrap="yes" readonly />
				   <span class='addSpan'>
