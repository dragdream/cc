...
function winOrder(sid){
	 $.MsgBox.Confirm ("提示", "确定赢单？",function(){
...
function deleteById(sid){
	$.MsgBox.Confirm("提示","确定删除这个商机？删除商机将删除此商机下关联的订单，删除后不可恢复！",function(){
...
function edit(){
	 var title = "编辑商机";
	  var url = contextPath+"/system/subsys/crm/core/customer/chances/addOrEditChances.jsp?sid="+sid+"&customerId="+customerId+"&customerName="+customerName;
...
<div class="topbar clearfix" id="toolbar">
    <div class="fl" style="position:static;">
		<img id="img1" class = 'title_img' src="<%=contextPath %>/system/subsys/crm/img/icon_khsjxq.png">
