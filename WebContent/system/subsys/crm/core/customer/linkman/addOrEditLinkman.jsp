...
function checkContactsIsExist(){
	var contactName=document.getElementById("contactName").value;
		...
		var json=tools.requestJsonRs(url,{contactName:contactName});
		if(json.rtState){
...
function goBack(){
	...
	if(sid>0){
		//history.go(-1);
		url= contextPath+"/system/subsys/crm/core/customer/linkman/linkmanInfo.jsp?sid="+sid+"&customerId="+customerId+"&customerName="+customerName;
	}else{
	    url= contextPath+"/system/subsys/crm/core/customer/linkman/linkmanList.jsp?customerId="+customerId+"&customerName="+customerName;
	}
	location.href=url;
}
...
<form method="post" name="form1" id="form1" >
	<table class="TableBlock" width="100%" align="center">
        ...
        <tr>
          <td class="TableData" width="150" style="text-indent:15px">姓名<span style="color:red;font-weight:bold;">*</span>：</td>
		   <td class="TableData">
				<input style="height: 23px;width: 350px;" type="text" id="contactName" name="contactName" class="BigSelect"></select>
		   </td>
        </tr>
        <tr>
          <td class="TableData" width="150" style="text-indent:15px">所属部门：</td>
			<td>
				<input style="height: 23px;width: 350px;" type="text"  id="department" name="department" class="BigInput"/>
			</td>
        </tr>
        <tr>
          <td class="TableData" width="150" style="text-indent:15px">职务：</td>
			<td>
				<input style="height: 23px;width: 350px;" type="text"  id="duties" name="duties" class="BigInput"/>
			</td>
        </tr>
        <tr>
	        <td class="TableData" width="150" style="text-indent:15px">关键决策人：</td>
			<td class="TableData">
				<select style="height: 23px;width: 200px;" id="isKeyPerson" name="isKeyPerson" class="BigSelect">
	...
	<table class='TableBlock' align="center">
		...
		<tr class='TableData' align='left'>
			...
			<td>
				<input style="height: 23px;width: 350px;" type="text" class="BigInput" name="mobilePhone" id="mobilePhone" validType='mobile'/>
			</td>
		</tr >
		<tr class='TableData' align='left'>
			<td class="TableData" width="150" style="text-indent:15px">邮箱：</td>
			<td>
				<input style="height: 23px;width: 350px;" type="text" name="email" id="email"  class="BigInput" validType='email'> 
			</td>
		</tr>
			<tr class='TableData' align='left'>
			<td class="TableData" width="150" style="text-indent:15px">地址：</td>
			<td>
				<input style="height: 23px;width: 350px;" type="text" name="address" id="address"  class="BigInput"> 
			</td>
		</tr>
	</table>
		<table class='TableBlock' align="center">
	   ...
	   <tr>
	       <td class="TableData" width="150" style="text-indent:15px">性别：</td>
			<td>
				<select style="height: 23px;width: 200px;" id="gender" name="gender" class="BigSelect">
	   ...
	   <tr>
	       ...
	       <td>
				<input style="height: 23px;width: 350px;" type="text" name=companyName id="companyName"  class="BigInput"> 
			</td>
	   </tr>
	   <tr>
	      	<td class="TableData" width="150" style="text-indent:15px">介绍人：</td>
			<td>
				<input style="height: 23px;width: 350px;" id='introduceName' name='introduceName' class="BigInput" type='text' readonly="readonly"/>
