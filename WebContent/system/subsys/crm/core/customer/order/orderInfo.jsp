...
function deleteById(sid){
	$.MsgBox.Confirm("提示","确定删除这个订单？删除订单将删除此订单下相关联的数据，删除后不可恢复！",function(){
...
function edit(){
	 var title = "编辑订单";
	  var url = contextPath+"/system/subsys/crm/core/customer/order/addOrUpdateOrder.jsp?sid="+sid+"&customerId="+customerId+"&customerName="+customerName;
...
<div class="topbar clearfix" id="toolbar">
    <div class="fl" style="position:static;">
		<img id="img1" class = 'title_img' src="<%=contextPath %>/system/subsys/crm/img/icon_khddxq.png">
