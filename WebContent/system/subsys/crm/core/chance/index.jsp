...
function doInit(){
 	$.addTab("tabs","tabs-content",[{title:"我的机会",url:contextPath+"/system/subsys/crm/core/chance/manage.jsp",active:true},
 	                               {title:"查看共享机会",url:contextPath+"/system/subsys/crm/core/chance/share.jsp",active:false}
	                                ]);
}
