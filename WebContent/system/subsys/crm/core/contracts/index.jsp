...
//新建合同
function add(){
	var url = contextPath+"/system/subsys/crm/core/contracts/addOrUpdate.jsp";
	location.href=url;
}
...
<body onload="doInit();"  style="overflow:hidden;padding-left:10px;padding-right:10px;">
 ...
 <div class="titlebar clearfix" >
		<img class = 'tit_img' style="margin-right: 10px;" src="<%=contextPath%>/system/subsys/crm/img/icon_ht.png">
		<p class="title">合同</p>
	 ...
	 <form id="form1" class='ad_sea_Content'>
       <table class="TableBlock" width="100%"  style="font-size:12px" id="searchTable">
          ...
          <tr>
            <td width="10%">合同编号：</td>
             <td width="40%">
                 <input style="height:23px; width: 300px;" type="text" name="contractsNo" id="contractsNo"/>
             </td>
             <td>合同标题：</td>
             <td>
                 <input style="height:23px; width: 300px;" type="text" name="contractsTitle" id="contractsTitle"/>
             </td>
          </tr>
          <tr>
              <td>状态：</td>
             <td>
                <select style="width: 180px;" id="contractsStatusDesc" name="contractsStatusDesc" >
...
<script type="text/javascript">
var customerId = "<%=sid%>";
 $.addTab("tab","tab-content",[{title:"全部",url:contextPath+"/system/subsys/crm/core/contracts/contractsList.jsp?type=1"},
                              {title:"我负责的",url:contextPath+"/system/subsys/crm/core/contracts/contractsList.jsp?type=2"},
                              {title:"我下属负责的",url:contextPath+"/system/subsys/crm/core/contracts/contractsList.jsp?type=3"},
                              ]); 
