...
<title>合同回款</title>
	...
	$(function() {
		...
		datagrid = $('#datagrid').datagrid({
			url : contextPath + '/crmContractRecvPaymentsController/manager.action' ,
			toolbar : '#toolbar',
			title : title,
			//iconCls : 'icon-save',
			iconCls:'',
...
<div id="toolbar" style=""> 
	...
	<div style="margin-bottom:10px;margin-top:10px;">
		<button type="button" class="btn btn-warning" onclick="batchRecvPayment()">批量回款</button>
		...
		<button type="button" class="btn btn-primary" onclick="toDetail()">查看</button>
		<button type="button" class="btn btn-primary" onclick="toAddOrUpdate(0)">新建回款</button>
