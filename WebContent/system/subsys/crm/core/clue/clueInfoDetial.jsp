...
function addMenu(data){
	...
	if(data == "待处理"||data=="已处理"){
		...
		str =   '<li class="hasMenu" style="position:relative;" onclick=""><a href="javascript:void(0);" >处理</a>'+
			  		'<ul class="secondMenu">'+
			  		'<li onclick="followUp('+sid+');"><a href="javascript:void(0);" >跟进中</a></li>'+
			  		'<li onclick="transClue('+sid+');"><a href="javascript:void(0);" >转换线索</a></li>'+
		...
		str =   '<li class="hasMenu" style="position:relative;" onclick=""><a href="javascript:void(0);" >处理</a>'+
			  		'<ul class="secondMenu">'+
			  		'<li onclick="followUp('+sid+');"><a href="javascript:void(0);" >跟进中</a></li>'+
			  		'<li onclick="transClue('+sid+');"><a href="javascript:void(0);" >转换线索</a></li></ul>'+'</li>'+
			  '<li onclick="edit();"><a href="javascript:void(0);" >编辑</a></li>'+
			  '<li class="modal-menu-test" onclick="setValue();$(this).modal();"><a href="javascript:void(0);" >更换负责人</a></li>'+
			  '<li onclick="deleteById('+sid+');"><a href="javascript:void(0);" >删除</a></li>';
...
function followUp(sid){
	var title = "已联系继续跟进";
	  var url = contextPath + "/system/subsys/crm/core/clue/followUp.jsp?sid="+sid;
...
function transClue(sid){
	var title = "转换线索";
	  var url = contextPath + "/system/subsys/crm/core/clue/transfromClue.jsp?sid="+sid;
	  bsWindow(url ,title,{width:"600",height:"300",buttons:
			[
			 {name:"确定",classStyle:"btn-alert-blue"},
...
function invalid(sid){
	var title = "线索无效";
	  var url = contextPath + "/system/subsys/crm/core/clue/invalid.jsp?sid="+sid;
	  bsWindow(url ,title,{width:"600",height:"300",buttons:
			[
			 {name:"确定",classStyle:"btn-alert-blue"},
		 	 {name:"关闭",classStyle:"btn-alert-gray"}
...
//编辑
function edit(){
	window.location.href = "<%=contextPath%>/system/subsys/crm/core/clue/addOrEditClue.jsp?sid=" + sid +"&customerName="+customerName;
}
...
function changeManager(){
	if(check()){
		var url=contextPath+"/TeeCrmClueController/changeManage.action?sid="+sid;
		...
		<div class="modal-test">
			...
			<div class="modal-body">
				<table class="TableBlock" width="100%">
					<br/>
				 <tr>
				      <td style="text-indent:15px">更换为：</td>
						<td >
