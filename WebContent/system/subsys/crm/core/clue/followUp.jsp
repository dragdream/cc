...
function checkForm(){
  /*   var check= $("#form1").valid(); 
	...
	if(dealResult==""||dealResult==null){
		parent.$.MsgBox.Alert_auto("请输入处理结果！");
		return false;	
	}
	return true;
}
...
function doSaveOrUpdate(callback){
  if(checkForm()){
    var url = "<%=contextPath%>/TeeCrmClueController/followUpClue.action";
...
<table align="center" width="100%" class="TableBlock" >
	<tr>
		<td style="text-indent:10px;" nowrap class="TableData"  width="10%;" >处理结果：<font style='color:red'>*</font></td>
		<td class="TableData" width="60%;" colspan="3">
		      <textarea id="dealResult" name="dealResult" required style="font-family: MicroSoft YaHei; font-size: 12px;width: 350px;" rows="5" cols="50"></textarea>
		</td>
	</tr>
