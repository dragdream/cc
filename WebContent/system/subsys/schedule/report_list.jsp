...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/scheduleReported/datagrid.action',
...
function detail(uuid,scheduleId){
	tools.requestJsonRs(contextPath+"/scheduleReported/read.action",{uuid:uuid},true,function(){
...
<div id="toolbar"  class = "topbar clearfix">
    <div class="fl" style="position:static;">
		...
		<span class="title">批阅计划 </span>
	</div>
<!-- <div class="base_layout_top" style="position:static">
		<table width="100%">
			<tr>
				<td>
					<span class="easyui_h1"><i class="glyphicon glyphicon-sound-stereo"></i>&nbsp;批阅计划</span>
				</td>
				<td align=right>
