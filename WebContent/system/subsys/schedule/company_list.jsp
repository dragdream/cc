...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/schedule/datagrid.action?type=3',
		...
		columns:[[
			...
			{field:'rangeType',title:'类型',width:100,sortable:true,formatter:function(data,rows,index){
				if(data==1){
					return "日计划";
				}else if(data==2){
					return "周计划";
...
function add(){
	window.location = "manage/addOrUpdate.jsp?type=3";
}

function edit(uuid){
	window.location = "manage/addOrUpdate.jsp?type=3&scheduleId="+uuid;
}
...
<!-- <div class="base_layout_top" style="position:static">
		<table width="100%">
			<tr>
				<td>
					<span class="easyui_h1"><i class="glyphicon glyphicon-sound-stereo"></i>&nbsp;公司计划</span>
				</td>
				<td align=right>
