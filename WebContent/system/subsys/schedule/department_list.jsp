...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/schedule/datagrid.action?type=2',
...
function add(){
	window.location = "manage/addOrUpdate.jsp?type=2";
}

function edit(uuid){
	window.location = "manage/addOrUpdate.jsp?type=2&scheduleId="+uuid;
}
...
<div id="toolbar" class = "topbar clearfix">
	...
	<!-- <div class="base_layout_top" style="position:static">
		<table width="100%">
			<tr>
				<td>
					<span class="easyui_h1"><i class="glyphicon glyphicon-sound-stereo"></i>&nbsp;部门计划</span>
				</td>
				<td align=right>
