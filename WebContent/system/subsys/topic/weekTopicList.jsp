...
function getInfoList(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+"/TeeTopicController/getWeekTopicList.action",
...
function showInfoFunc(sid,topicSectionId){
  var url = contextPath + "/system/subsys/topic/topicManage/topicDetail.jsp?returnFlag=3&topicSectionId="+topicSectionId+"&uuid=" + sid;
