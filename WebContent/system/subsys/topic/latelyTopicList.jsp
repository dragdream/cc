...
function getInfoList(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+"/TeeTopicController/getLatelyTopicList.action",
...
function showInfoFunc(sid,topicSectionId){
  var url = contextPath + "/system/subsys/topic/topicManage/topicDetail.jsp?returnFlag=2&topicSectionId="+topicSectionId+"&uuid=" + sid;
