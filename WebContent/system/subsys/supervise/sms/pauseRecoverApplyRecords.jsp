...
function getList(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath + "/supervisionApplyController/getPauseOrRecoverApplyListBySupId.action?supId="+supId,
		...
		columns:[[
			...
			{field:'type',title:'申请类型',width:120,formatter:function(value,rowData,rowIndex){
...
<body onload="doInit()" style="padding-left: 10px;padding-right: 10px">
   <div id="toolbar" class="topbar clearfix">
      <div class="fl" style="position:static;">
		...
		<span class="title">暂停/恢复申请记录 </span>
	</div>
   </div>
