...
<body onload="doInit()" style="padding-left: 10px;padding-right: 10px">
   <div id="toolbar" class="topbar clearfix">
      <div class="fl" style="position:static;">
		<img id="img1" class = 'title_img' src="<%=contextPath %>/system/subsys/supervise/imgs/icon_fklb.png">
		<span class="title"><span id="supName"></span>反馈列表 </span>
	</div>
   </div>
