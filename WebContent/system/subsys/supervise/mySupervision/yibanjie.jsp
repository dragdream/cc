...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath + "/supervisionController/getMySupListByStatus.action?option=ybj",
		...
		columns:[[
			...
			{field:'leaderName',title:'责任领导',width:120},
			{field:'managerName',title:'主办人',width:120},
