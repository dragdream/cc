...
function doInit(){
	...
	tools.requestJsonRs(contextPath+"/myModule/getFormHtml.action",{moduleId:moduleId,bisKey:bisKey,view:1},true,function(json){
...
<div style="background:#f0f0f0;position:absolute;top:0px;height:30px;left:0px;right:0px;padding:5px;text-align:left;border-bottom:1px solid #e2e2e2">
	<button class="btn btn-danger" onclick="backTo()">返回</button>
</div>
