...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+'/TeeEvalTypeController/datagrid.action',
		pagination:true,
		singleSelect:false,
...
function add(){
	...
	var url = contextPath+"/system/subsys/evaluation/setting/addOrEditEvalType.jsp";
	bsWindow(url,"考核类型",{width:"500",height:"200",submit:function(v,h){
...
function edit(sid){
	datagrid.datagrid("unselectAll");
	var url = contextPath+"/system/subsys/evaluation/setting/addOrEditEvalType.jsp?sid="+sid;
	bsWindow(url,"考核类型",{width:"500",height:"200",submit:function(v,h){
		var cw = h[0].contentWindow;
		if(cw.commit()){
			datagrid.datagrid("unselectAll");
...
function del(){
	...
	top.$.jBox.confirm("确认删除选中信息吗","确认",function(v){
		if(v=="ok"){
			...
			var url = contextPath+"/TeeEvalTypeController/deleteById.action";
...
<body onload="doInit()" style="overflow:hidden;font-size:12px">
	...
	<div id="toolbar">
		<div class="moduleHeader">
			<b><i class="glyphicon glyphicon-sound-stereo"></i>&nbsp;考核类型管理</b>
		</div>
