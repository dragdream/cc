...
function doInit(){
	...
	datagrid = $('#datagrid').datagrid({
		...
		columns:[[
			...
			{field:'typeDesc',title:'类型',width:50},
			...
			{field:'2',title:'操作',formatter:function(e,rowData){
				...
				}else if(visitPriv(rowData.uuid)){
...
function showDetail(sid){
	...
	bsWindow(contextPath+"/system/subsys/timeline/manage/detail.jsp?sid="+sid,"查看详情",{width:"700",height:"300",buttons:[{name:"关闭",classStyle:"btn btn-primary"}],submit:function(v,h){return true;}});
}
function add(){
	bsWindow(contextPath+"/system/subsys/timeline/manage/addOrEditTimeline.jsp" ,"添加大事记",{width:"650",height:"350",buttons:
		[
...
function eventList(timelineUuid,title){
	var url = contextPath+"/system/subsys/timeline/manage/eventList.jsp?timelineUuid="+timelineUuid+"&title="+encodeURI(title)+"&type=1";
	location.href=url;
}
function edit(sid){
...
<div id="toolbar" class = "topbar clearfix">
	<div class="fl" style="position:static;">
		...
		<span class="title">大事记管理</span>
	</div>
	<div class = "right fr t_btns">
	    <button style="cursor: pointer;"  onclick="add()"><span style="padding-right: 13px;">新建</span></button>&nbsp;&nbsp;
		<button type="button" onclick="$(this).modal();" value="高级检索" class="modal-menu-test"
		style="background-image:url(/common/zt_webframe/imgs/xzbg/dsjgl/icon_search1.png);cursor: pointer;"
		>&nbsp;高级查询</button>
    </div>
