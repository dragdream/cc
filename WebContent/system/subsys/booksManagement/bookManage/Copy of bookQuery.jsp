...
<div class="base_layout_top" style="position:static">
	<table width="100%">
		<tr>
			<td>
				<span class="easyui_h1">图书录入</span>
			</td>
			<td align=right>
...
<br/>
<table  class="none-table"  id = "searchInput">
 	...
 	<tr>
	  ...
	  <tr>
	    ...
	    <td class="TableData" colspan="3">
	      <input type="text" name="bookName" id="bookName" size="60" maxlength="300" class="BigInput easyui-validatebox" value="" >
	    </td>
	  	</tr>
	  <tr>
	    <td nowrap class="TableData"> 图书编号：<font style='color:red'></font></td>
	    <td class="TableData" colspan="3">
	      <input type="text" name="bookNo" id="bookNo" size="60" maxlength="300" class="BigInput easyui-validatebox" value="" >
	    </td>
	  </tr>
	    ...
	    <td class="TableData" colspan="3">
	      <input type="text" name="author" id="author" size="60" maxlength="300" class="BigInput easyui-validatebox" value="" >
	    </td>
	  </tr>
	  	  <tr>
	    <td nowrap class="TableData"> ISBN号：<font style='color:red'></font></td>
	    <td class="TableData" colspan="3">
	      <input type="text" name="ISBN" id="ISBN" size="60" maxlength="300" class="BigInput easyui-validatebox" value="" >
	    </td>
	  </tr>
	  	  <tr>
	    <td nowrap class="TableData"> 出版社：<font style='color:red'></font></td>
	    <td class="TableData" colspan="3">
	      <input type="text" name="pubHouse" id="pubHouse" size="60" maxlength="300" class="BigInput easyui-validatebox" value="" >
	    </td>
	  </tr>
 	 <tr>
	    <td nowrap class="TableData"> 存放地点：<font style='color:red'></font></td>
	    <td class="TableData" colspan="3">
	      <input type="text" name="area" id="area" size="60" maxlength="300" class="BigInput easyui-validatebox" value="" >
	    </td>
	 </tr>
     <tr>
     <tr>
