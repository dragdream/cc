...
function doInit(){
	...
	$.addTab("tabs","tabs-content",[{title:"报表管理",url:contextPath+"/system/subsys/report/senior_manage/list.jsp",active:true},
	                                {title:"分类设置",url:contextPath+"/system/subsys/report/senior_manage/cat_list.jsp",active:false}]);
}
