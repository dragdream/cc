...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath+"/zhiDaoQuestionController/getMyParticipate.action",
...
<div id="toolbar" class = "topbar clearfix">
	<div class="fl" style="position:static;">
		<img id="img1" class = 'title_img' src="<%=contextPath %>/system/subsys/zhidao/img/icon_cy.png">
		<span class="title">我的参与</span>
	</div>
