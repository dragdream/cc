...
function doInit(){
	...
	datagrid = $('#datagrid').datagrid({
		url:contextPath+"/zhiDaoQuestionController/getNoHandledQuestion.action",
...
<div id="toolbar" class = "topbar clearfix">
	<div class="fl" style="position:static;">
		<img id="img1" class = 'title_img' src="<%=contextPath %>/system/subsys/zhidao/img/icon_nohandle.png">
		<span class="title">待解决的问题</span>
	</div>
