	...
	datagrid = $('#datagrid').datagrid({
		...
		columns:[[
			...
			{field:'2',title:'操作',width:50,align:'center',formatter:function(value, rowData, rowIndex){
				var str = "<a href='#' onclick='showQueryInfoFunc("+rowData.DEPTID + "," + rowData.YEAR +")'>详情 </a>";
				return str;
			}}
		]]
	});
...
<body onload="doInit()" style="overflow:hidden;font-size:12px">
	...
	<div id="toolbar">
		<div class="base_layout_top" style="position:static">
			<span class="easyui_h1">部门计划查询</span>
		</div>
					...
					<div class="modal-body">
						<table class="none-table" >
							...
							<tr>
								...
								<td class="TableData">
									<input type='text' class="BigInput  easyui-validatebox" validType='pointTwoNumber[]' id='amountMax' name='amountMax' style="width:180px;"  maxlength="10" />
								</td>
							</tr>
							<tr>
								<td class="TableData">费用金额小于：</td>
								<td class="TableData">
									<input type='text' class="BigInput  easyui-validatebox" validType='pointTwoNumber[]' id='amountMin' name='amountMin' style="width:180px;"  maxlength="10" />
								</td>
							</tr>
							<tr>
								<td colspan='4' >
