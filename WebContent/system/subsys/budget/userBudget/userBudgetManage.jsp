	...
	datagrid = $('#datagrid').datagrid({
		...
		columns:[[
			...
			{field:'2',title:'操作',width:50,formatter:function(value, rowData, rowIndex){
				var str = "<a href='#' onclick='showManageInfoFunc("+rowData.USERID + "," + rowData.YEAR +")'>详情 </a>";
				str += "&nbsp;&nbsp;<a href='#' onclick=\"toAddOrUpdate('"+rowData.USERID + "','" + rowData.YEAR +"','" + 0 +"')\">编辑</a>";
				str += "&nbsp;&nbsp;<a href='#' onclick=\"deleteObjFunc('"+rowData.USERID + "','" + rowData.YEAR +"')\">删除</a>";
				return str;
			}}
		]]
	});
