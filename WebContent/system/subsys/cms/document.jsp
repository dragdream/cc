...
function clickIt(siteId,channelId,type,hasPriv){
	...
	if(type=="site"){
		...
		if(hasPriv=="1"||hasPriv==1){
			$("#frame").attr("src",contextPath+"/system/subsys/cms/documents.jsp?siteId="+siteId+"&channelId="+channelId);
		}else{
...
<div id="layout">
	<div height="40" style="position: absolute;height: 40px;width: 100%;top:15px">
		<div style="vertical-align: middle;">
			<img id="img1" class = 'title_img' src="<%=contextPath %>/system/subsys/cms/image/wd.png">
