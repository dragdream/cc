...
//初始化地图
function doInit(){
	var url=contextPath + "/TeeFootPrintController/findFootPrintList.action";
	var para = {startTime:startTime,endTime:endTime};
	...
	var data1=jsonObj.rows;
	 ...
	 for(var i=0;i<data1.length;i++){
		 points.push(new BMap.Point(data1[i].coordinateY,data1[i].coordinateX));
	 }
	 
	 //获取中心点的 坐标
	 var centerX=jsonObj.footer[1];
	 var centerY=jsonObj.footer[0];
	 // 百度地图API功能
	  ...
	  for(var i=0;i<data1.length;i++){
		 var new_point = new BMap.Point(data1[i].coordinateY,data1[i].coordinateX);
