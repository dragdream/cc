...
function doInit(){
	datagrid = $('#datagrid').datagrid({
		url:contextPath + "/TeeFootPrintController/findFootPrintList.action",
...
//图形化展示
function viewImg(){
	var url="<%=contextPath%>/system/subsys/footprint/footPrintImg.jsp?startTime="+startTime+"&&endTime="+endTime;
	openFullWindow(url);
}
</script>
</head>
...
<div id="toolbar" class = "topbar clearfix">
   ...
   <div class = "right fr clearfix">
	    ...
	    <input class="btn-win-white" type="button" value="返回" onclick="window.location='query.jsp';"/>
	</div>
