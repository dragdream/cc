...
function doInit(){
	...
	if((data.contentPriv&2)==2 && json.rtData.docId){
		tabArray.push({title:"正文",url:contextPath+"/system/subsys/doc/daishou/print/zhengwen.jsp"});
	}
	if((data.contentPriv&4)==4){
		tabArray.push({title:"版式正文",url:contextPath+"/system/subsys/doc/daishou/print/bszw.jsp"});
	}
	if((data.contentPriv&8)==8){
		tabArray.push({title:"附件",url:contextPath+"/system/subsys/doc/daishou/print/fj.jsp"});
	}
...
<body  id="messDiv" onload="doInit()" style="overflow: hidden;padding-left:10px;padding-right:10px;padding-top: 5px">
