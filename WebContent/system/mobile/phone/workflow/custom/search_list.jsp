	...
	<script>
		...
		function detail(){
			...
			//window.location = "../flow_run_view.jsp?runIdSearch="+runId+"&runId="+runId0+"&frpSid="+frpSid+"&flowId="+flowId+"&view=47&flowTypeId=<%=flowTypeId%>&runName="+encodeURI(runName);
			 OpenWindow("流程办理","/system/mobile/phone/workflow/flow_run_view.jsp?runIdSearch="+runId+"&runId="+runId0+"&frpSid="+frpSid+"&flowId="+flowId+"&view=47&flowTypeId=<%=flowTypeId%>&runName="+encodeURI(runName),true);
		}
		...
		mui.ready(function() {
			...
			backBtn.addEventListener("tap",function(){
				var  url = "search.jsp?flowTypeId=<%=flowTypeId%>";
