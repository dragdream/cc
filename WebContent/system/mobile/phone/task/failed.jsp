...
<div id="muiContent" class="mui-content">
	...
	<div class="mui-input-group" id="redoDiv">
		...
		<div class="app-row-content">
			<textarea id="failedTextarea" name='failedTextarea' style='border:1px solid #fff000;' placeholder="请填写失败原因"></textarea>
			<br/><br/>
			<button class="mui-btn mui-btn-primary" onclick="failedSubmit(<%=taskId%>)">确定失败</button>
		</div>
	</div>
</div>
