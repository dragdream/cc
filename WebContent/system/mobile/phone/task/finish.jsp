...
<div id="muiContent" class="mui-content">
	...
	<div class="mui-input-group" id="redoDiv">
		...
		<div class="app-row-content">
			<input type="text" id="score" name="score" placeholder="请填写任务评分"  />
		</div>
	</div>
	<div class="mui-input-group" id="redoDiv">
		<div class="mui-input-row">
		...
		<div class="app-row-content">
			<input type="text" id="relTimes" name="relTimes" placeholder="请填写确认工时" />
		</div>
	</div>
	<div class="mui-input-group" id="redoDiv">
		<div class="mui-input-row">
		...
		<div class="app-row-content">
			<textarea id="finishTextarea" name='finishTextarea' style='border:1px solid #fff000;' placeholder="请填写总结信息"></textarea>
			<br/><br/>
			<button class="mui-btn mui-btn-primary" onclick="finishSubmit(<%=taskId%>)">确定</button>
		</div>
	</div>
</div>
