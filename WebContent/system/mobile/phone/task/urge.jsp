...
<div id="muiContent" class="mui-content">
	...
	<div class="mui-input-group" id="redoDiv">
		...
		<div class="app-row-content">
			<textarea id="urgeTextarea" name='urgeTextarea' style='border:1px solid #fff000;' placeholder="请填写督办内容"></textarea>
			<br/><br/>
			<button class="mui-btn mui-btn-primary" onclick="urgeSubmit(<%=taskId%>)">确定督办</button>
		</div>
	</div>
</div>
