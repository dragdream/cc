...
<div id="muiContent" class="mui-content">
	...
	<div class="mui-input-group" id="redoDiv">
		...
		<div class="app-row-content">
			<input type="text" id="progress" name="progress" placeholder="请填写进度百分比" style='width:80%;' />%
		</div>
	</div>
	<div class="mui-input-group" id="redoDiv">
		<div class="mui-input-row">
		...
		<div class="app-row-content">
			<textarea id="reportTextarea" name='reportTextarea' style='border:1px solid #fff000;' placeholder="请填写汇报内容"></textarea>
			<br/><br/>
			<button class="mui-btn mui-btn-primary" onclick="reportSubmit(<%=taskId%>)">确定</button>
		</div>
	</div>
</div>
