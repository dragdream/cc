...
<body>
		...
		mui.ajax(url,{
			...
			success:function(json){
				...
				for(var i=0;i<json.rows.length;i++){
					...
					render.push("<span>用品名称:"+item.productName+"</span></p>");
					render.push("<p style='font-size:12px'>申请类型:"+item.regTypeDesc+"</p>");
					render.push("<p style='font-size:12px'>数量:"+item.regCount+"</p>");
					render.push("</div>");
					render.push("</li>");
				}
	...
	function detail(){
		...
		window.location.href="../diaoDuDetail.jsp?sid="+uuid+"&status="+status;
	}
