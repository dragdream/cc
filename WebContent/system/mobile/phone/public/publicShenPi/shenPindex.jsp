...
<body onload="doInit();">
		<header class="mui-bar mui-bar-nav">
			...
			<h1 class="mui-title">用品审核</h1>
		</header>
		<div class="mui-content">
			<div id="wrapper">
				<ul class="mui-table-view">
				<li class="mui-table-view-cell mui-media">
					<a href="list/indexList.jsp?status=1" class="">
				...
				<li class="mui-table-view-cell mui-media">
					<a href="list/indexList.jsp?status=2" class="">
				...
				<li class="mui-table-view-cell mui-media">
					<a href="list/indexList.jsp?status=3" class="">
                ...
                <li class="mui-table-view-cell mui-media">
					<a href="list/indexList.jsp?status=4" class="">
				...
				<li class="mui-table-view-cell mui-media">
					<a href="list/indexList.jsp?status=5" class="">
