...
<body>
	<header class="mui-bar mui-bar-nav">
		...
		<h1 class="mui-title">销售订单（<%=typeDesc %>）</h1>
	...
	function pulldownRefresh() {
		...
		var url="";
		if(type!=0||type!=null){
			url = contextPath+'/TeeCrmOrderController/datagrid.action?type='+type;//订单列表
		}
	...
	function detail(){
		...
		window.location = "/system/mobile/phone/crm/orders/ordersInfo.jsp?sid="+uuid+"&customerName="+customerName+"&type="+type;
	}
