...
<%
	...
	int orderStatus=TeeStringUtil.getInteger(request.getParameter("orderStatus"),1);
%>
<!DOCTYPE HTML>
<html>
<head>
...
//保存/提交
function save(){
	var url=contextPath+"/TeeCrmOrderController/reject.action";
