...
<body>
	<header class="mui-bar mui-bar-nav">
		...
		<h1 class="mui-title">拜访记录（<%=typeDesc %>）</h1>
		...
		mui.ajax(url,{
			...
			success:function(json){
				...
				for(var i=0;i<json.rows.length;i++){
					...
					render.push("<p style='font-size:12px'>所属客户："+item.customerName+"<span style='padding-left:15px;'>"+item.visitStatusDesc+"</span></p>");
	...
	function detail(){
		...
		window.location = contextPath+"/system/mobile/phone/crm/visit/visitInfo.jsp?sid="+uuid+"&customerName="+customerName+"&type="+type;
	}
	...
	mui.ready(function() {
		...
		addBtn.addEventListener("tap",function(){
			window.location.href = contextPath+"/system/mobile/phone/crm/visit/addOrUpdate.jsp?type="+type;
		});//新建
