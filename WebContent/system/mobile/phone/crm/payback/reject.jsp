...
<%
	...
	int paybackStatus=TeeStringUtil.getInteger(request.getParameter("paybackStatus"),1);
%>
<!DOCTYPE HTML>
<html>
<head>
...
//保存/提交
function save(){
	var url=contextPath+"/TeeCrmPaybackController/reject.action";
	var param=formToJson("#form1");
	param['sid']=sid;
	param['paybackStatus']=3;
	param["isPhone"]=1;
	mui.ajax(url,{
	type:"post",
	dataType:"html",
	...
	success:function(json){
		json = eval("("+json+")");
		if(json.rtState){
			window.location.href=contextPath+"/system/mobile/phone/crm/payback/indexApprove.jsp?paybackStatus="+paybackStatus;
		}
			}
		});
}
