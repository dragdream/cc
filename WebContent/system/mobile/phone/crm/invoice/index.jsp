...
<body>
	<header class="mui-bar mui-bar-nav">
		...
		<h1 class="mui-title">开票（<%=typeDesc %>）</h1>
	...
	function pulldownRefresh() {
		...
		var url="";
		if(type!=0||type!=null){
			url = contextPath+'/TeeCrmInvoiceController/datagrid.action?type='+type;//开票申请列表
		}
	...
	function detail(){
		...
		window.location = "/system/mobile/phone/crm/invoice/invoiceInfo.jsp?sid="+uuid+"&customerName="+customerName+"&type="+type;
	}
