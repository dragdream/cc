...
<body>
	<header class="mui-bar mui-bar-nav">
		...
		<h1 class="mui-title">合同（<%=typeDesc %>）</h1>
		...
		mui.ajax(url,{
			...
			success:function(json){
				...
				for(var i=0;i<json.rows.length;i++){
					...
					render.push("<p style='font-size:12px'>所属客户："+item.customerName+"<span style='padding-left:15px;'>"+item.contractsStatusDesc+"</span></p>");
	...
	function detail(){
		...
		window.location = "/system/mobile/phone/crm/contract/contractInfo.jsp?sid="+uuid+"&customerName="+customerName+"&type="+type;
	}
