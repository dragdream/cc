...
<body>
	<header class="mui-bar mui-bar-nav">
		...
		<h1 class="mui-title">退货单（<%=typeDesc %>）</h1>
	...
	function pulldownRefresh() {
		...
		var url="";
		if(type!=0||type!=null){
			url = contextPath+'/TeeCrmReturnOrderController/datagrid.action?type='+type;//退货单列表
		}
	...
	function detail(){
		...
		window.location = "/system/mobile/phone/crm/returnOrders/returnOrdersInfo.jsp?sid="+uuid+"&customerName="+customerName+"&type="+type;
	}
