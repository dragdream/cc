...
<!DOCTYPE HTML>
<%
   int orderId=TeeStringUtil.getInteger(request.getParameter("orderId"), 0);
...
function doInit(){
	...
	var url = contextPath+'/TeeOrderProductsController/getOrderProductsInfoList.action';//产品列表
...
function doSearch(){
	...
	mui.ajax(url,{
		type:"post",
		dataType:"html",
		data:{productsName:name,sid:orderId},
		timeout:10000,
		success:function(json){
			json = eval("("+json+")");
			var render = [];
