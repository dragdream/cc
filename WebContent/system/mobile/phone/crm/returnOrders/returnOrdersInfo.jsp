...
function doInit(){
	...
	//返回
 	backBtn.addEventListener("tap",function(){
		window.location = contextPath+'/system/mobile/phone/crm/returnOrders/index.jsp?type='+type;
	}); 
	...
	mui.ajax(url,{
		...
		success:function(json){
			...
			if(json.rtState){
				...
				var returnOrderStatus = json.rtData.returnOrderStatusDesc;
				if(data.orderStatus==3){
					$("#reasons").show();
				}
				
				renderOptBtns(returnOrderStatus);
				//渲染产品信息
