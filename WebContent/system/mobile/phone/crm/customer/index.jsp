...
<body>
	<header class="mui-bar mui-bar-nav">
		...
		<h1 class="mui-title">客户信息（<%=typeDesc %>）</h1>
		...
		mui.ajax(url,{
			...
			success:function(json){
				...
				for(var i=0;i<json.rows.length;i++){
					...
					render.push("<span>"+item.customerName+"</span></p>");
					render.push("<p style='font-size:12px'><span>"+item.managePersonName+"</span><span style='padding-left:10px;'>"+item.customerStatus+"</span></p>");
					render.push("<p style='font-size:12px'>"+item.addTime+"</p>");
					render.push("</div>");
					render.push("</li>");
				}
	...
	function detail(){
		...
		window.location = "/system/mobile/phone/crm/customer/customerInfo.jsp?sid="+uuid+"&customerName="+customerName+"&type="+type;
	}
