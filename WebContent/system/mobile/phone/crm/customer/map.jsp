	...
	map.addEventListener("click", function(e){        
		...
		if(window.confirm("确认选取该点吗？")){
			geoc.getLocation(pt, function(rs){
		        ...
		        parent.document.getElementById('addressDesc').value=desc;
		        parent.document.getElementById("coordinate").value=coordinate;
		        $(parent.mapFrameDiv).hide();
			});
		}
	});
}
