...
<body>
		...
		mui.ajax(url,{
			...
			success:function(json){
				...
				for(var i=0;i<json.rows.length;i++){
					...
					render.push("<span>"+item.chanceName+"</span></p>");
					render.push("<p style='font-size:12px'>"+item.managePersonName+"<span style='padding-left:10px;'>"+item.chanceStatusDesc+"</span></p>");
	...
	function detail(){
		...
		window.location = contextPath+"/system/mobile/phone/crm/customer/customerChances/chancesDetail.jsp?sid="+sid+"&customerId="+cusId+"&customerName="+customerName+"&type="+type;
	}
	...
	mui.ready(function() {
		...
		addBtn.addEventListener("tap",function(){
			window.location.href = contextPath+"/system/mobile/phone/crm/customer/customerChances/addOrUpdate.jsp?customerId="+cusId+"&customerName="+customerName+"&type="+type;
		});//新建
