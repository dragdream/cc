...
function save(){
	if(check()){
		...
		success:function(json){
			...
			if(json.rtState){
				if(sid>0){
					window.location.href=contextPath+"/system/mobile/phone/crm/drawback/drawbackInfo.jsp?sid="+sid+"&customerName="+cusName+"&type="+type;
				}else{
					window.location.href=contextPath+"/system/mobile/phone/crm/drawback/index.jsp?type="+type;
				}
			}
		}
	});	
