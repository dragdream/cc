...
<body>
	<header class="mui-bar mui-bar-nav">
		...
		<h1 class="mui-title">退款（<%=typeDesc %>）</h1>
	...
	function pulldownRefresh() {
		...
		var url="";
		if(type!=0||type!=null){
			url = contextPath+'/TeeCrmDrawbackController/datagrid.action?type='+type;//退款列表
		}
	...
	function detail(){
		...
		window.location = "/system/mobile/phone/crm/drawback/drawbackInfo.jsp?sid="+uuid+"&customerName="+customerName+"&type="+type;
	}
