...
<%
   ...
   int sid=TeeStringUtil.getInteger(request.getParameter("sid"), 0);//主键
   String customerName=TeeStringUtil.getString(request.getParameter("customerName"),"");//客户名称
%>
<!DOCTYPE HTML>
<html>
<head>
	...
	if (check()) {
		...
		mui.ajax(url,{
			...
			success:function(json){
				...
				if (json.rtState) {
					alert("更换负责人成功！");
					window.location.href = "<%=contextPath%>/system/mobile/phone/crm/contacts/contactsInfo.jsp?sid="+sid+"&customerName="+customerName;
				}
			}
		});
