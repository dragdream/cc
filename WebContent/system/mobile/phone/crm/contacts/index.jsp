...
<body>
	<header class="mui-bar mui-bar-nav">
		...
		<h1 class="mui-title">联系人（<%=typeDesc %>）</h1>
		<a class="mui-action-menu mui-icon mui-icon-more mui-pull-right" href="#topPopover"></a>
		<span class="mui-icon mui-icon-plusempty mui-pull-right" id="addBtn" style="cursor: pointer;"></span>
	...
	function pulldownRefresh() {
		...
		var url="";
		if(type!=0||type!=null){
			url = contextPath+'/TeeCrmContactsController/datagrid.action?type='+type;
		}
		...
		mui.ajax(url,{
			...
			success:function(json){
				...
				for(var i=0;i<json.rows.length;i++){
					...
					render.push("<p style='font-size:12px'>所属客户："+item.customerName+"<span style='padding-left:15px;'>"+item.contactsStatusDesc+"</span></p>");
	...
	function detail(){
		...
		window.location = "/system/mobile/phone/crm/contacts/contactsInfo.jsp?sid="+uuid+"&customerName="+customerName+"&type="+type;
	}
