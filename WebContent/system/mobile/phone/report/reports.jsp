...
function doInit(){
	loader = new lazyLoader({
		url:contextPath+"/seniorReport/datagridViews.action?catId="+catId,
		placeHolder:"",
		...
		rowRender:function(data){
			var render = [];
			render.push("<li onclick=\"detail('"+data.uuid+"')\" style='height:inherit;padding:10px;font-size:16px'>");
			render.push("<span>"+data.tplName+"</span>");
...
function detail(uuid){
	window.location.href = contextPath + "/system/mobile/phone/report/show.jsp?reportId="+uuid;
}
