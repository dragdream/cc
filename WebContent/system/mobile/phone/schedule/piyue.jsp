...
<body>
	<header class="mui-bar mui-bar-nav">
			<a class="mui-pull-left app-title" href="#myPopover">批阅计划
		...
		<script>
			...
			function getReportSchedules(){
				var url = contextPath+"/scheduleReported/getReportSchedules.action";
				mui.ajax(url,{
					type:"GET",
					dataType:"JSON",
					data:{},
			...
			function getList(){
				var url = contextPath+"/scheduleReported/datagrid.action";
				loader = null;
