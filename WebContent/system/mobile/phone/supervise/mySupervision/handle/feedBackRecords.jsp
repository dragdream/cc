...
<body onload="doInit()">
	...
	function detail(){
		...
		window.location = "fbDetail.jsp?sid="+sid+"&&supId="+supId+"&&option="+option;
	}
	...
	function reply(){
		window.event.cancelBubble=true;
		var sid = this.getAttribute("sid");
		window.location="addfbReply.jsp?fbId="+sid+"&&supId="+supId+"&&option="+option;
	}
	...
	function update(){
		window.event.cancelBubble=true;
		var sid = this.getAttribute("sid");
		window.location="doFeedBack.jsp?sid="+sid+"&&supId="+supId+"&&option="+option;
	}
