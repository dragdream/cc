...
function doInit(){
// 	if(window.external){
// 		window.external.setTitle("收件详情");
// 	}
	
	
	
	var json = tools.requestJsonRs(contextPath+"/doc/getDeliveryInfo.action?uuid="+uuid);
	data = json.rtData;
	$("#bt").html(data.bt);
	$("#zh").html(data.zh);
	$("#fwdw").html(data.fwdw);
   ...
   <div align="center" style="border-bottom:1px solid #F5F5F5;padding-top: 10px; ">
	...
	<div id="div1" style="padding-bottom:10px;padding-top: 10px;border-bottom:1px solid #F5F5F5;width: 100%">
	   <table style="width: 100%">
	       <tr>
	          <td id="bdTd" width="20%" style="text-indent:2px;display: none"></span><span style="vertical-align:middle;display:inline-block; background:url(images/icon_bd.png) top left no-repeat; width:20px; height:20px;"></span><a style="text-decoration:none;" href="#" id="bd">表单</a></td>
	          <td id="qpdTd" width="25%" style="display: none"><span style="vertical-align:middle;display:inline-block; background:url(images/icon_qpd.png) top left no-repeat; width:20px; height:20px;"></span><a style="text-decoration:none;" href="#" id="qpd"  >签批单</a></td>
