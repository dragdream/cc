	...
	<table class="TableBlock" width="520px" align="center">
		...
		<tr class="TableData" id="userIdTr">
			...
			<td nowrap align="left">
				...
				<input name="userNames" id="userNames" class="BigInput" readonly="readonly" value="<%=userName %>">
...
<!-- 				<a href="javascript:void(0);" class="orgClear"onClick="clearData('userIds','userNames')">清空</a> -->
		...
		<tr>
			...
			<td class="TableData"><input type="text" id="endDate"
				...
				onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"
				class="BigInput" value="<%=date%> 23:59"></td>
		</tr>
		<tr class="TableData">
			<td nowrap>事务类型：</td>
		...
		<tr>
			...
			<td class="TableData"><textarea id="content" name="content"
					cols="42" rows="3" class="BigInput easyui-validatebox"
...
<!-- 			        &nbsp;&nbsp;<a href="javascript:void(0);" class="orgAdd" onClick="selectUser('actorIds','actorNames')">选择</a>&nbsp;&nbsp; -->
			         <a href="javascript:void(0);" class="orgClear" onClick="clearData('actorIds','actorNames')">清空</a>
				<br/><br/>
				<iframe id="" style="width:100%;height:200px" frameborder="no" src="/system/mobile/userselect.jsp?single_select=0&to_id_field=actorIds&to_name_field=actorNames">
				</iframe>
