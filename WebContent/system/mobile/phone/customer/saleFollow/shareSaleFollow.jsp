...
<body>
	<header class="mui-bar mui-bar-nav">
		<a class="mui-pull-left app-title" href="#myPopover">共享跟单
...
function getPageList(){
	$('#pagination-demo1').pagination({
		dataSource: contextPath+'/TeeCrmSaleFollowController/datagrid.action?shareFlag=1',
		pageSize: 20,
...
function showInfoFunc(sid){
	var  url = contextPath + "/system/mobile/phone/customer/saleFollow/detail.jsp?returnFlag=1&sid=" + sid;
