...
<body>
	<header class="mui-bar mui-bar-nav">
		<a class="mui-pull-left app-title" href="#myPopover">共享联系人
	...
	<div id="myPopover" class="mui-popover" style="width:120px">
	  <ul class="mui-table-view">
	    <li class="mui-table-view-cell" onclick="window.location = 'myContactUser.jsp';">我的联系人</li>
	    <li class="mui-table-view-cell" onclick="window.location = 'shareContactUser.jsp';">共享联系人</li>
	  </ul>
	</div>
...
function getPageList(){
	$('#pagination-demo1').pagination({
		dataSource: contextPath+'/TeeCrmContactUserController/datagrid.action?shareFlag=1',
		pageSize: 20,
...
function showInfoFunc(sid){
	var  url = contextPath + "/system/mobile/phone/customer/contactUser/detail.jsp?returnFlag=1&sid=" + sid;
