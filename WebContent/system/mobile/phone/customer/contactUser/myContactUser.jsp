...
<body>
	<header class="mui-bar mui-bar-nav">
		<a class="mui-pull-left app-title" href="#myPopover">我的联系人
...
function getPageList(){
	$('#pagination-demo1').pagination({
		dataSource: contextPath+'/TeeCrmContactUserController/datagrid.action',
		pageSize: 20,
...
function showInfoFunc(sid){
	var  url = contextPath + "/system/mobile/phone/customer/contactUser/detail.jsp?sid=" + sid;
