...
<body>
	<header class="mui-bar mui-bar-nav">
		<a class="mui-pull-left app-title" href="#myPopover">共享合同
...
function getPageList(){
	$('#pagination-demo1').pagination({
		dataSource: contextPath+'/teeCrmContractController/manager.action?shareFlag=1',
		pageSize: 20,
...
function showInfoFunc(sid){
	var  url = contextPath + "/system/mobile/phone/customer/contract/detail.jsp?returnFlag=1&sid=" + sid;
