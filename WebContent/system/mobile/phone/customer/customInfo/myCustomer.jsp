...
<body>
	<header class="mui-bar mui-bar-nav">
		<a class="mui-pull-left app-title" href="#myPopover">我的客户
...
function getPageList(){
	$('#pagination-demo1').pagination({
		dataSource: contextPath+'/TeeCrmCustomerInfoController/datagrid.action',
		pageSize: 20,
				...
				var html = "<ul class='mui-table-view'>";
				 jQuery.each(list,function(i,sysPara){
					html+="<li class=\"mui-table-view-cell mui-media\" onclick=\"showInfoFunc('" + sysPara.sid + "');\" >"
							...
							+"		<p class='mui-ellipsis'>"
							+"			<span>负责人：" + sysPara.managePersonName + "</span>"
							+"		</p>"
							+"		<p class='mui-ellipsis'>"
...
function showInfoFunc(sid){
	var  url = contextPath + "/system/mobile/phone/customer/customInfo/detail.jsp?sid=" + sid;
