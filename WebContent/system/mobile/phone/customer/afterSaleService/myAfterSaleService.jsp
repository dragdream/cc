...
<body>
	<header class="mui-bar mui-bar-nav">
		<a class="mui-pull-left app-title" href="#myPopover">我的售后
...
function getPageList(){
	$('#pagination-demo1').pagination({
		dataSource: contextPath+'/crmAfterSaleServController/getManageInfoList.action',
		pageSize: 20,
...
function showInfoFunc(sid){
	var  url = contextPath + "/system/mobile/phone/customer/afterSaleService/detail.jsp?sid=" + sid;
