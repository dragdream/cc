...
<body>
	...
	function pulldownRefresh() {
		page = 1;
	    var url=contextPath + "/TeeTimelineController/datagrid.action";
		mui.ajax(url,{
			type:"post",
			dataType:"html",
			...
			success:function(json){
				...
				for(var i=0;i<json.rows.length;i++){
					...
					render.push("<p style='font-size:12px'>"+item.typeDesc+"</p>");
					render.push("<p style='font-size:12px'>标签:"+item.tag+"</p>");
					render.push("</div>");
					render.push("</li>");
				}
	...
	function detail(){
		...
		window.location.href="guanindex.jsp?timelineUuid="+uuid;
	}
