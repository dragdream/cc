...
<!-- 代码 开始 -->
<div class="head-warp" style="margin-top: 46px;">
  <div class="head">
        <div class="nav-box">
...
var url = contextPath+"/TeeTimelineEventController/getEvent.action";
mui.ajax(url,{
	type:"post",
	dataType:"html",
	data:{timelineUuid:timelineUuid},
	timeout:10000,
	success:function(json){
		json = eval("("+json+")");
		if(json.rtState){
