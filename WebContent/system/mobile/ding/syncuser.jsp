...
// 		});
		bsWindow(contextPath+"/dingding/syncPerson.action?oper="+oper+"&ids="+ids.join(",")+"&deptIds="+deptIds.join(","),"同步详情",{});
...
<body onload="doInit();">
	<fieldset>
		...
		<span class="help-block">注：将OA系统中的用户信息同步到钉钉通讯录之前，请务必保证该OA用户设置了手机号。</span>
