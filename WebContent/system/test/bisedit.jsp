...
<head>
	...
	var bisId = "<%=request.getParameter("bisId")%>";
	function doInit(){
		var json = tools.requestJsonRs(contextPath+"/bisDataFetch/dfget.action",{bisTableName:"bis_test",bisKeyName:"BIS_ID",bisKeyValue:bisId});
		bindJsonObj2Cntrl(json.rtData);
		$("#BIRTHDAY").attr("value",getFormatDateStr(json.rtData.BIRTHDAY,"yyyy-MM-dd"));
	}
	
	function commit(){
		var param = tools.formToJson($("#form"));
		param["bisTableName"] = "bis_test";
		param["bisKeyValue"] = bisId;
		var json = tools.requestJsonRs(contextPath+"/bisDataFetch/dfupdate.action",param);
		if(json.rtState){
