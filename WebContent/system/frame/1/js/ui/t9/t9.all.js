(function($) {
  window.T9 = {
    ...
    fitTouchDevice: function() {
      ...
      document.addEventListener("touchstart", function(e) {
        if (!simMouseEvt("mousedown", e.target, e.changedTouches[0])) {
          e.preventDefault();
          setTimeout(function() {
            if (e.target instanceof HTMLElement && !e.target.getAttribute("t9movement")) {
      ...
      document.addEventListener("touchmove", function(e) {
        e.target instanceof HTMLElement && e.target.setAttribute("t9movement", "move");
        simMouseEvt("mousemove", e.target, e.changedTouches[0]) || e.preventDefault();
      });
      document.addEventListener("touchend", function(e) {
        var timer;
        if (e.target instanceof HTMLElement) {
          if (e.target.getAttribute("t9dbclick")) {
            clearTimeout(timer);
            e.target.removeAttribute("t9dbclick");
            simMouseEvt("dblclick", e.target, e.changedTouches[0]);
          }
          else {
            e.target.setAttribute("t9dbclick", "dbclick");
            timer = setTimeout(function() {
              e.target.removeAttribute("t9dbclick");
            }, 1000);
          }
          e.target.removeAttribute("t9movement");
        }
    ...
    getAutoID: function(prefix) {
      T9.autoID = T9.autoID || 0;
      T9.autoID++;
      return (prefix || "t9Auto") + T9.autoID;
    },
    /**
     * json对象转化为String
     ...
     */
    isCmp: function(o) {
      return !!(T9.register[o && o.xtype] && o.status && o.render);
    },
    /**
    ...
    topZIndex: function(layer) {
      T9.zIndex++;
      return {
        "upper": T9.zIndex + 5000,
        "middle": T9.zIndex + 3000,
        "lower": T9.zIndex + 1000
      } [layer] || T9.zIndex;
    },
    /**
     * 关闭/打开js错误提示函数
    ...
    error: function(type) {
      if (type == "close") {
        T9.error.originalEvent = T9.error.originalEvent || window.onerror;
        window.onerror = function(e, url, line) {
          T9.console.error(url + "  " + line + "  " + e);
          return true;
        };
      }
      else {
        window.onerror = T9.error.originalEvent;
      }
    }
  };
   ...
   */
  T9.createComponent("Component", null, {
    /**
    ...
    "initialize": function() {
      ...
      this.id = this.id || T9.getAutoID(this.autoIdPrefix);
      this.el.attr("id", this.id);
      //注册组件
      T9.addCmp(this.id, this);
    ...
    "doListeners": function() {
      if (this.listeners) {
        ...
        $.each(this.listeners, function(k, v) {
          if (typeof v === "function") {
            T9.Event.add(self, "bind", k, false, v);
          }
          else if (typeof v === "object"){
            $.each(v, function(key, value) {
              T9.Event.add(self, "bind", k, key, value);
            });
          }
        });
      }
    ...
    "doLoader": function() {
      ...
      if (this.loader.xtype === "loader") {
        ...
        var loader = new T9.Loader(this.loader);
        o = loader.load();
      }
  ...
  if (top == window && T9.isTouchDevice) {
              ...
              try {
                ...
                i.onload = function() {
                  ...
                  try {
                    ...
                    s.innerHTML = "function close() {parent.T9.getCmp('" + id + "').close();}";
    ...
    window.open = function (url, name, features, replace) {
      ...
      $.extend(true, cfg, parseFeatures(features));
      var win = new T9.Window(cfg);
      win.show();
    }
    
  }
  else if (T9.isTouchDevice){
    window.showModalDialog = function () {
      top.T9 && top.showModalDialog.apply(this, arguments);
    }

    window.open = function () {
      top.T9 && top.open.apply(this, arguments);
    }
  }
})(jQuery);
(function($) {
  ...
  T9.createComponent.call(T9.layouts, "AutoLayout", autoOpts, {
    initialize: function() {
    ...
    doDroppable: function(item) {
      if (this.droppable) {
        if (item) {
          ...
          T9.Event.del(item, "drop");
          T9.Event.add(item, 'bind', 'drop', null, function(evt, ui, t) {
        ...
        */
        ...
        $.each(this.droppableCmps, function(i, e) {
          ...
          T9.Event.add(e, 'bind', 'drop', null, function(evt, ui, t) {
            if (ui.draggable.filter(self.droppable.accept)[0]) {
              drop && drop(evt, ui, t);
            }
          });
        ...
        $(dropCtn).bind('drop', function(e, ui) {
          if (!cmp) {
            for(var e in self.items) {
              if (T9.isCmp(e) && e.contentEl == ui.draggable) {
                cmp = e;
                break;
              }
            }
    ...
    doSortable: function() {
      ...
      $.each(this.sortableCmps, function(i, e) {
        e.setEvtActor(e.contentEl);
        T9.Event.add(e, 'bind', 'sortremove', null, function(e, ui, cmp) {
          cmp.removeItem(T9.getCmp(ui.item.attr('id')), true);
        });
        
        T9.Event.add(e, 'bind', 'sortreceive', null, function(e, ui, cmp) {
          cmp.receiveItem(T9.getCmp(ui.item.attr('id')));
        });
  ...
  T9.createComponent.call(T9.layouts, "CardLayout", opts, T9.layouts.AutoLayout.prototype, {
    initComponent: function() {
      var self = this;
    ...
    doTabs: function() {
      if (this.tabs) {
        var self = this;
        var tabHeader = new T9.Container({
          layout: 'floatlayout',
          height: 'auto',
          cls: 'tab-header',
          items: []
  ...
  T9.createComponent.call(T9.layouts, "ColumnLayout", opts, T9.layouts.AutoLayout.prototype, {
    initComponent: function() {
  ...
  T9.createComponent.call(T9.layouts, "FloatLayout", opts, T9.layouts.AutoLayout.prototype, {
    initComponent: function() {
      this.el = $(this.el);
      this.el.parent().css({
        width: 'auto'
  ...
  T9.createComponent.call(T9.layouts, "GridLayout", opts, T9.layouts.ColumnLayout.prototype, {
    initComponent: function() {
      T9.layouts.ColumnLayout.prototype.initComponent.call(this);
    },
    initTable: function() {
      this.tr = [];
    ...
    verifyMerge: function() {
      ...
      */
      var cmp = T9.getCmp(td.data("cmpId"));
      ...
      self.table.find('td' + cls).each(function(i, e) {
        var cmp = T9.getCmp($(e).data("cmpId"));
    ...
    mergeCells: function() {
      ...
      self.table.find('td' + cls).each(function(i, e) {
         if (i == 0) {
           $(e).attr('colspan', cols);
           $(e).attr('rowspan', rows);
           var cmp = T9.getCmp($(e).find('div:first').attr('id'));
           if (cmp) {
             cmp.colSpan = cols;
             cmp.rowSpan = rows;
  ...
  T9.createComponent('Container', opts, T9.Component.prototype, {
    initComponent: function() {
      this.locate();
      this.el.css({
        width: this.width,
    ...
    doLayout: function() {
      var self = this;
      if (this.layout) {
        //暂时的容错处理        if (T9.layouts.register[this.layout]) {
          if (!T9.isCmp(this.layoutMgr)) {
            this.layoutCfg.el = this.contentEl;
            this.layoutCfg.items = this.items;
            this.layoutCfg.owner = this;
            this.layoutMgr = new T9.layouts.register[this.layout](this.layoutCfg);
          }
 
          T9.compose(this, this.layoutMgr);
        }
      }
    },
    /**
    ...
    doPlugins: function() {
      ...
      $.each(this.plugins, function(i, e){
        if (T9.Plugins[e]) {
          T9.Plugins[e].apply(t, arguments);
        }
      });
    },
    compose: function() {
  ...
  T9.createComponent("Menu", menuOpts, T9.Component.prototype, {
    initComponent: function() {
    ...
    createUL: function(items, lv, container) {
      ...
      $.each(items, function(i, e) {
        ...
        var span = $('<span style="margin-left:15px"></span>').html(e.text);
        a.append(span);
...
//        }
  ...
  T9.createComponent('Grid', gridOpts, T9.Component.prototype, {
    initComponent: function() {
      var t = this;
      this.initRows();
      this.el.css({
  ...
  $.extend(T9.Image.prototype, new T9.Component(), {
    initialize: function() {
      this.el.css({
        'text-align': 'center'
      });
  ...
  T9.createComponent('Custom', customOpts, T9.Component.prototype, {
    initComponent: function() {
    }
  });
  ...
  T9.createComponent('ImgBox', imgBoxOpts, T9.Component.prototype, {
    'initComponent': function() {
      this.el.addClass("t9-imgbox");
      this.container = $('<div class="t9-imgbox-container"></div>');
      
      this.imgs = $('<div class="t9-imgbox-imgs"></div>');
      var div = $('<div class="t9-imgbox-texts"></div>');
      this.texts = $("<ul></ul>")
  ...
  $(window).resize(function() {
    $.each(T9.components, function(k, v) {
  ...
  T9.createComponent("Panel", panelOpts, T9.Component.prototype, {
    'initComponent': function() {
      ...
      //解决ie6的select框问题
      if (T9.browser.isIE6 && this["float"]) {
    ...
    "refresh": function() {
      ...
      T9.Component.prototype.refresh.apply(this, arguments);
    },
    'doRender': function() {
      var css = {'height': 'auto'};
    ...
    'setPosCenter': function(ctn) {
      ...
      //暂时不处理窗口打开位置叠加的问题
      this.top = (ctn.height() - this.el.height() - 100) / 2 + scrollTop + (T9.Panel.lastTop += 0);
      this.left = (ctn.width() - this.el.width()) / 2 + (T9.Panel.lastLeft += 0);
...
(function ($) {
  ...
  T9.createComponent('Tip', tipOpts, T9.Panel.prototype, {
    'initComponent': function() {
      if (!this.target) {
        this.destroy();
        return;
      ...
      T9.Panel.prototype.initComponent.apply(this, arguments);
