				...
				renderCalendar : function(t) {
					...
					while (n++ < q) {
						...
						for (var x = 0; x < 7; x++) {
							var j = m.getMonth() == B;
							var y = d(C("td"))
									.html("<div class='d1'>"+(j ? m.getDate(): "")+"</div>")
									.addClass(
											(j ? "current-month "
													: "other-month ")
													+ (m.isWeekend() ? "weekend "
...
//							}
									...
									.append(d("<div></div>")
											...
											.append(
													...
													d(
															...
															.append(
																	d(
																			'<a id="dp-nav-prev-year" href="#" title="'
																	...
																	d(
																			'<a id="dp-nav-prev-month" href="#" title="'
													...
													d(
															...
															.append(
																	d(
																			'<a id="dp-nav-next-year" href="#" title="'
																	...
																	d(
																			'<a id="dp-nav-next-month" href="#" title="'
						...
						_applyRenderCallbacks : function() {
							var e = this;
							if(this.settings.onChangeDate){
								this.settings.onChangeDate(e.displayedMonth+1,e.displayedYear);
							}
							d("td", this.context)
									.each(
											function() {
