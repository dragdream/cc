...
function solarDay2(){
    var sDObj = new Date(SY,SM,SD);
    var lDObj = new Lunar(sDObj);
    var cl = '<font color="" STYLE="font-size:12px;"><i class="glyphicon glyphicon-dashboard"></i>&nbsp;&nbsp;';
...
function refreshCalendarClock() //
{
 ...
 document.all.time.innerHTML = new Date().toLocaleString()+' 星期'+'日一二三四五六'.charAt(new Date().getDay())+"&nbsp;&nbsp;"+solarDay2()+"&nbsp;&nbsp;"+solarDay3();
}
//显示当前时间
