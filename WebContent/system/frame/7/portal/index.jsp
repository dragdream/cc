...
<!-- jQuery库 -->
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.min.js"></SCRIPT>
...
<!-- Bootstrap通用UI组件 -->
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/bootstrap.min.js"></SCRIPT>
<LINK href="<%=contextPath %>/system/frame/7/个人桌面_files/bootstrap-ie7.css" rel="stylesheet" type="text/css">
<LINK href="<%=contextPath %>/system/frame/7/个人桌面_files/bootstrap.css" rel="stylesheet" type="text/css">
<!-- JBOX通用UI组件 -->
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.jBox-2.3.min.js" type="text/javascript"></SCRIPT>
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.jBox-zh-CN.js" type="text/javascript"></SCRIPT>
<LINK href="<%=contextPath %>/system/frame/7/个人桌面_files/jbox.css" rel="stylesheet" type="text/css">
<SCRIPT></SCRIPT>
<!-- 其他工具库类 -->
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/tools.js"></SCRIPT>
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/sys.js"></SCRIPT>
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/sysUtil.js"></SCRIPT>
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/orgselect.js"></SCRIPT>
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/easyuiTools.js" type="text/javascript"></SCRIPT>
<!-- jQuery Tooltip -->
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.tooltip.min.js" type="text/javascript"></SCRIPT>
<LINK href="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.tooltip.css" rel="stylesheet"
	type="text/css">
<!-- 图片预览器 -->
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.mousewheel.js" type="text/javascript"></SCRIPT>
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/picexplore.js" type="text/javascript"></SCRIPT>
<LINK href="<%=contextPath %>/system/frame/7/个人桌面_files/picexplore.css" rel="stylesheet" type="text/css">
<SCRIPT type="text/javascript">
	/** 常量定义 **/
	var TDJSCONST = {
		YES : 1,
...
<TITLE>个人桌面</TITLE>
<LINK href="<%=contextPath %>/system/frame/7/个人桌面_files/personal.css" rel="stylesheet" type="text/css">
<STYLE>
table {
...
<!-- jQuery库 -->
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.ui.core.js" type="text/javascript"></SCRIPT>
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.ui.widget.js" type="text/javascript"></SCRIPT>
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.ui.mouse.js" type="text/javascript"></SCRIPT>
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.ui.draggable.js" type="text/javascript"></SCRIPT>
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.ui.droppable.js" type="text/javascript"></SCRIPT>
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.ui.resizable.js" type="text/javascript"></SCRIPT>
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.ui.selectable.js" type="text/javascript"></SCRIPT>
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.ui.sortable.js" type="text/javascript"></SCRIPT>
<SCRIPT src="<%=contextPath %>/system/frame/7/个人桌面_files/jquery.ux.slidebox.js" type="text/javascript"></SCRIPT>
...
<SCRIPT type="text/javascript">
	...
	function addModule(screen, module) {
		...
		var img = $("<div class='img'><p><img src='" + contextPath + "/system/frame/7/icons/" + icon+ "' /></p></div>");
	...
	function openAppBox() {
		var title = "桌面应用设置";
		var index = 0;
		var url = "<%=contextPath%>/system/frame/7/portal/setting.jsp?index=" + index;
		bsWindow(url, title, {
			width : "800",
			height : "360",
			buttons : [
