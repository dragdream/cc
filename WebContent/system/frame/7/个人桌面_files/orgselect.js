...
function selectUser(retArray , moduleId,privNoFlag ,filter,callBackPara,confirmCallBack) {
  ...
  var url = contextPath + "/oa/core/orgselect/selectMultiUser.jsp?objSelectType=" + objSelectType;
  if (moduleId) {
...
function selectUserWorkFlow(retArray , moduleId,privNoFlag ,filter,callBackPara) {
  ...
  objSelectType  = retArray[2] || "";
  var url = contextPath + "/oa/core/orgselect/selectMultiUserWorkFlow.jsp?objSelectType=" + objSelectType;
  if (moduleId) {
    url += "&moduleId=" + moduleId;
    if (!privNoFlag) {
      privNoFlag = 0;
...
function selectSingleUser(retArray,moduleId,privNoFlag,filter,callBackPara) {
	 userRetNameArray = retArray;
	 objSelectType  = retArray[2] || "";
	 var url = contextPath + "/oa/core/orgselect/selectSingleUser.jsp?isSingle=true&objSelectType=" + objSelectType;
	 if (moduleId) {
	    url += "&moduleId=" + moduleId;
	    if (!privNoFlag) {
	      privNoFlag = 0;
...
function selectSingleUserWorkFlow(retArray,moduleId,privNoFlag,filter,callBackPara) {
	 userRetNameArray = retArray;
	 objSelectType  = retArray[2] || "";
	 var url = contextPath + "/oa/core/orgselect/selectSingleUserWorkFlow.jsp?isSingle=true&objSelectType=" + objSelectType;
	 if (moduleId) {
	    url += "&moduleId=" + moduleId;
	    if (!privNoFlag) {
	      privNoFlag = 0;
...
function selectDept(retArray , moduleId,privNoFlag , noAllDept) {
  ...
  objSelectType  = retArray[2] || "";
  var url = contextPath + "/oa/core/orgselect/selectMultiDept.jsp?objSelectType=" + objSelectType;
  var has = false;
  if (moduleId) {
    url += "&moduleId=" + moduleId ;
  }
...
function selectSingleDept(retArray , moduleId,privNoFlag , noAllDept) {
  deptRetNameArray = retArray;
  objSelectType  = retArray[2] || "";
  var url = contextPath + "/oa/core/orgselect/selectMultiDept.jsp?objSelectType=" + objSelectType + "&isSingle=1";
  var has = false;
  if (moduleId) {
    url += "&moduleId=" + moduleId ;
  }
...
function selectRole(retArray, moduleId,privNoFlag , privOp) {
  ...
  objSelectType = retArray[2] || "";
  var url =contextPath + "/oa/core/orgselect/selectMultiRole2.jsp?objSelectType=" + objSelectType ;
  if (moduleId) {
    url += "&moduleId=" + moduleId;
    if (!privNoFlag) {
      privNoFlag = 0;
...
function selectSingleRole(retArray, moduleId,privNoFlag , privOp) {
	  roleRetNameArray = retArray;
	  objSelectType = retArray[2] || "";
	  var url =contextPath + "/oa/core/orgselect/selectMultiRole.jsp?objSelectType=" + objSelectType + "&isSingle=1";
	  if (moduleId) {
	    url += "&moduleId=" + moduleId;
	    if (!privNoFlag) {
	      privNoFlag = 0;
...
function selectMenuGroup(retArray, moduleId,privNoFlag , privOp) {
  ...
  var url =contextPath + "/oa/core/orgselect/selectMultiMenuGroup.jsp?objSelectType=" + objSelectType;
  var has = false;
  if (moduleId) {
    url += "?moduleId=" + moduleId;
    if (!privNoFlag) {
...
function selectSysMenu(retArray , moduleId,privNoFlag ,filter,callBackPara) {
  ...
  objSelectType  = retArray[2] || "";
  var url = contextPath + "/oa/core/orgselect/selectMultiSysMenu.jsp?objSelectType=" + objSelectType;
  if (moduleId) {
    url += "&moduleId=" + moduleId;
    if (!privNoFlag) {
      privNoFlag = 0;
...
function selectSysModule(retArray , moduleId,callBackPara) {
    ...
    objSelectType  = retArray[2] || "";
    var url = contextPath + "/oa/core/orgselect/selectSysModule.jsp?objSelectType=" + objSelectType;
    if (moduleId) {
	    url += "&moduleId=" + moduleId;
	    if (!privNoFlag) {
	      privNoFlag = 0;
...
function selectMeetingEquipment(retArray , moduleId,callBackPara) {
    ...
    objSelectType  = retArray[2] || "";
    var url = contextPath + "/oa/core/orgselect/selectMeetingEquipment.jsp?objSelectType=" + objSelectType;
    if (moduleId) {
	    url += "&moduleId=" + moduleId;
	    if (!privNoFlag) {
	      privNoFlag = 0;
