...
function createNewWork(flowId,initData){
	...
	if(json.rtState){
		window.openFullWindow(contextPath+"/oa/core/workflow/flowrun/prcs/index.jsp?runId="+json.rtData.runId+"&frpSid="+json.rtData.frpSid+"&flowId="+flowId+"&isNew=1","流程办理");
	}else{
		alert(json.rtMsg);
	}
}
