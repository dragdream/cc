...
//      $(".menu_active_blue").css("background-color","#af302b");
...
//初始化桌面
function doInitDeskTop(){
    var url = contextPath+"/teePortalTemplateController/datagrid.action?type=1";
    var json = tools.requestJsonRs(url,{});
    for (var i = 0; i < json.rows.length; i++) {
         $("#desktopDiv").append("<li onclick=\"switchDesktop("+json.rows[i].sid+")\" ><img src=\"imgs/index/page.png\" >"+json.rows[i].templateName+"</li>");
    } 
}
...
<!--------------- 系统头部 -------------->
    ...
    if(!"".equals(TOP_BANNER_TEXT)){//有标题，则优先显示标题
        ...
        <%
            if(!"1".equals(TeeSysProps.getString("NO_LOGO"))){
                ...
                %>
                <img src="imgs/index/logo_01.png"/>
                <%
            }
        %>
    ...
    %>
        ...
        <div class = 'fl menuListRight'>
                    ...
                    <ul class = ' clearfix fl'>
                        ...
                        <li><img class='sms' id='tip_alert' src="imgs/index/alert.png">
                          <!--  <p class="top_fot" title="消息事务">消息事务</p> -->
                           <div class="sign_in_tid" style="display:none">新的消息！</div>
                        
                        </li>
                        <li><img class="sign_img" src="imgs/index/sign.png">
    ...
    <div class="section">
        ...
        <div class="mainContent">
            <iframe id='mainIframe'  frameborder="0" style="box-sizing: border-box;" src="<%=contextPath%>/system/frame/default/mainForSimple.jsp">
...
<!--                <img class='setIcon12' src="imgs/index/set.png"> -->
    ...
    function renderSecondMenu(data){//具有折叠功能二级菜单
        ...
        // setInterval(shake1('tip_alert'),500);

        //搜索左拉
        // function serchFunc(){
        //  $(".search_input").animate({width:"170px",});
        // };
        ...
        //  $(".positionBlock").slideToggle(50);
        // });
        // $(".positionBlock").on("mouseleave",function(){
        //  $(".positionBlock").slideToggle(50);
        // });
        //登记登出
