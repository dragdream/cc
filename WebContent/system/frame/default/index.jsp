...
<iframe frameborder=0 src="<%=contextPath %>/system/core/base/quicksearch/search_result.jsp" id="searchDataDiv" style="position:absolute;display:none;border:1px solid gray;height:300px;width:175px;right:40px;top:58px;z-index:100"></iframe>
    ...
    <div class="nav clearfix" style="padding-left:15px;">
    	<div class="nav_l fl">
        	<div class="clearfix">
        		<a class="fl" style="cursor:pointer;" title="部门：<%=currUserDeptName%>角色：<%=currUserRoleName%>"><img src="images/status_online.png" /><%=userName %>，您好！</a><a href="javascript:void(0);" class="fl"  id="currDate"></a>
        ...
        <ul class="nav_r fr clearfix">
            ...
            <li><span class="span_border_none" title="我的桌面" onclick="addNewTabs('我的桌面', '<%=contextPath %>/system/frame/default/main.jsp')"><img src="images/nav_l_bg.png" /></span></li>
            <li><span class="span_border_none" title="消息事务" onclick="addNewTabs('消息事务', '<%=contextPath %>/system/core/sms/index.jsp')"><img id="msgImg" src="images/icon_msg.png" /></span></li>
            <li><span class="span_border_none" title="收藏夹" onclick="addNewTabs('收藏夹', '<%=contextPath %>/system/core/fav/manage.jsp')"><img src="<%=contextPath %>/common/images/favorite_click.png" /></span></li>
            <li><span class="span_border_none" title="控制面板" onclick="addNewTabs('控制面板', '<%=contextPath %>/system/core/person/setdescktop/')"><img src="images/icon_setting.png" /></span></li>
            <li><span onclick="doLogout();"  title="注销" class="span_border_none"><img src="images/door_open.png" /></span></li>
        </ul>
