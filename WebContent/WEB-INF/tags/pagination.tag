...
<%@ attribute name="page" type="com.tianee.oa.core.base.email.util.Page" required="true"%>
...
<div class="pagination pagination-centered">
	<ul>
		<li class="disabled"><a>共${page.totalCount }封邮件</a></li>
		<li class=""><a href="javascript:void(0);" onclick="WdatePicker({el:'toDate',onpicking:function(dp){ dp.cal.getNewDateStr();setDate(dp.cal.getNewDateStr());}})" >转到</a></li>
