...
var natureJsons = [];
var levelJsons = [];
var personJsons = [{codeNo:'1',codeName:'无'},
                   {codeNo:'2',codeName:'1-5'},
                   {codeNo:'3',codeName:'6-10'},
                   {codeNo:'4',codeName:'大于10'}];
var listdata = {
		isShowColumn: [
...
function isTerm(){
	if(dataParams.name != null && dataParams.name != ""){
		var $table= $("#condition");
		var vTr= "<span class='tagbox-label' title=机关全称："+dataParams.name+" style=\"float:left;height: 26px;line-height: 26px;margin: 5px 2px 4px 4px;\" id='nameTag'>&nbsp;机关全称" +
	...
	if(dataParams.nature != null && dataParams.nature != ""){
		...
		var vTr= "<span class=\"tagbox-label\" title=机关性质："+natureStr+" style=\"float:left;height: 26px;line-height: 26px;margin: 5px 2px 4px 4px;\" id=\"natureTag\">&nbsp;机关性质" +
	...
	if(dataParams.administrativeDivision != null && dataParams.administrativeDivision != ""){
		...
		var vTr= "<span class=\"tagbox-label\" title=行政区划："+administrativeDivisionStr+" style=\"float:left;height: 26px;line-height: 26px;margin: 5px 2px 4px 4px;\" id=\"administrativeDivisionTag\">&nbsp;行政区划" +
	...
	if(dataParams.deptLevel != null && dataParams.deptLevel != ""){
		var $table= $("#condition");
		var strid = dataParams.deptLevel;
		var stridStr = (strid.substring(strid.length-1)==',')?strid.substring(0,strid.length-1):strid
		var str = dataParams.deptLevelName;
		var deptLevelStr = (str.substring(str.length-1)=='，')?str.substring(0,str.length-1):str
		var vTr= "<span class=\"tagbox-label\" title=所属层级："+deptLevelStr+" style=\"float:left;height: 26px;line-height: 26px;margin: 5px 2px 4px 4px;\" id=\"deptLevelTag\">&nbsp;所属层级" +
				"<a href=\"javascript:;\" onclick=\"thisRemove('deptLevel','checkbox','"+stridStr+"')\" class=\"tagbox-remove\"></a></span>";
		$table.append(vTr);
	}
	if(dataParams.departmentCode != null && dataParams.departmentCode != ""){
		var $table= $("#condition");
		var vTr= "<span class=\"tagbox-label\" title=统一社会信用代码："+dataParams.departmentCode+" style=\"float:left;height: 26px;line-height: 26px;margin: 5px 2px 4px 4px;\" id=\"departmentCodeTag\">&nbsp;统一社会信用代码" +
				"<a href=\"javascript:;\" onclick=\"thisRemove('departmentCode','textbox')\" class=\"tagbox-remove\"></a></span>";
		$table.append(vTr);
	}
	if(dataParams.representative != null && dataParams.representative != ""){
		var $table= $("#condition");
		var vTr= "<span class=\"tagbox-label\" title=法定代表人："+dataParams.representative+" style=\"float:left;height: 26px;line-height: 26px;margin: 5px 2px 4px 4px;\" id=\"representativeTag\">&nbsp;法定代表人" +
				"<a href=\"javascript:;\" onclick=\"thisRemove('representative','textbox')\" class=\"tagbox-remove\"></a></span>";
		$table.append(vTr);
	}
	if(dataParams.personNo != null && dataParams.personNo != ""){
		...
		var vTr= "<span class=\"tagbox-label\" title=监督人员数量："+personStr+" style=\"float:left;height: 26px;line-height: 26px;margin: 5px 2px 4px 4px;\" id=\"personNoTag\">&nbsp;监督人员数量" +
