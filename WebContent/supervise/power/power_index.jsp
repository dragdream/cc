...
<%@ include file="/header/easyui2.0.jsp"%>
    <script type="text/javascript"  src="<%=contextPath%>/supervise/power/js/power_index.js"></script>
    ...
    <div id="toolbar" class="titlebar clearfix">
        ...
        <div class="fl left">
            <img id="img1" class='title_img'
                ...
                <span class="title">行政职权查询</span>
        </div>
        <div class="right fr t_btns">
            <button style="VISIBILITY: hidden;" class="easyui-linkbutton" onclick="add()">
                <span style="padding-right: 13px; width: 30px;">新建</span>
            </button>
            &nbsp;&nbsp;
        </div>
    </div>
                ...
                <table class="none_table" style="width: 100%;">
                    <tr>
                        ...
                        <td style="width: 100px;">
                            <input class="easyui-textbox" id="powerCode" style="width: 100px;"
