...
<body onload="doInitIndex()" style="padding-right: 10px;padding-left: 10px;padding-top: 5px">
        ...
        <div id="outwarp">
            ...
            <div class="right fr t_btns">
                ...
                <c:if test="${deptIdExists && subIdExists && fn:contains(menuGroupStrNames,'提交人员')}">
                    <button class="easyui-linkbutton" onclick="commonCaseSubmit(1)">
    ...
    <script type="text/javascript" src="<%=contextPath%>/supervise/caseManager/commonCase/js/common_case_index.js"></script>
</body>
</html>