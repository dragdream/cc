...
<body onload="doAddPowerInit()" fit="true">
        ...
        <div id="outwarp">
            <div class="left fl setHeight">
                <form id="selectFormalPower_form">
                    <input type="hidden" id="actSubject" value="${actSubject}"/>
                    <input type="hidden" id="powerType" value="${powerType}"/>
    ...
    <table id="select_common_case_addPower_table" fit="true"></table>
    <script type="text/javascript" src="<%=contextPath%>/supervise/caseManager/commonCase/js/common_case_addPower.js"></script>
