...
<script type="text/javascript" src="<%=contextPath%>/supervise/Department/js/department_index.js"></script>
...
<body onload="doInit()" style="padding-right: 10px;padding-left: 10px;padding-top: 5px">
	...
	<div id="toolbar" class="titlebar clearfix">
		...
		<div class="div1" style="padding-top: 5px; padding-bottom: 5px">
			...
			&nbsp;&nbsp;<button type="button" class="easyui-linkbutton" onclick="queryS()"><i class="fa fa-search"></i>&nbsp;查&nbsp;询</button>
		</div>
		</form>
	</div>
