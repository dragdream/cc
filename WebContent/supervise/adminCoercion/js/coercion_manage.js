...
function initBaseParams() {
    ...
    if (result.rtState) {
        ...
        departmentId = relation.businessDeptId;
        subjectId = relation.businessSubjectId;
...
function initDatagrid(params) {
    datagrid = $('#coercionManage_datagrid').datagrid(
            {
...
//                        editor: 'text',
                        formatter: function(e, rowData) {
                           var list = '';
                           if(rowData.caseCode=='null'||rowData.caseCode==null){
                              rowData.caseCode='';
                           }
                           list = rowData.caseCode;
//                           list = "<span href='#' onclick='isEditCoercion(\"" + rowData.id + "\")'>" + rowData.caseCode + "</span>";
                           return list;
                        },
                    },
                    {
                    ...
                    },
                    {
                        ...
                        formatter : function(e, rowData){
                           var optStr = '';
                           if(rowData.isForce==1){
                              optStr = optStr + '强制措施、';
                           } 
                           if(rowData.punishDecisionExecuteWay=='02'){
                              optStr = optStr + '行政机关执行、';
                           }else if(rowData.punishDecisionExecuteWay=='03'){
                              optStr = optStr + '申请法院强制执行、';
                           }
                    ...
                    },
                    {
                        ...
                        formatter : function(e, rowData) {
                            var optStr = 
                            "<span title='编辑'><a href=\"#\" onclick=\"editCoercionInfo('"
                            + rowData.id+"','"+rowData.isForce+"','"+rowData.punishDecisionExecuteWay
                            + "')\"><i class='fa fa-pencil common-yellow'></i></a></span>&nbsp;&nbsp;&nbsp;"
                            +"<span title='查看'><a href=\"#\" onclick=\"doOpenShowPage('"
                            + coercionCaseId +"','"+rowData.id
...
function doOpenShowPage(id,caseSourceId) {
    var params = {
    		...
    		subjectId:subjectId,
    		caseSourceType :200,
    		parentPage :"/supervise/adminCoercion/coercion_manage.jsp"
    }
    location.href = contextPath+"/coercionCaseSearchCtrl/seeCoercionCaseInfoPage.action?" + $.param(params);
 ...
 * 打开编辑强制信息的页面
 */
function editCoercionInfo(id,isForce,punishDecisionExecuteWay){
   var params={
      id : id,
      isForce : isForce,
      punishDecisionExecuteWay : punishDecisionExecuteWay
   };
   location.href = contextPath+"/supervise/adminCoercion/coercion_add.jsp?" + $.param(params);
}
...
//            alert("jsajjs");
//            console.log(data.rtData);
//            $('#caseSource_children').val(data.rtData.caseSourceJsonStr);
...
// * @param id
// */
//function editOpenMeasurePage(id) {
//    var params = {
//            id: id,
//            caseSourceId: srcCaseId,
//            caseSourceType: srcCaseType,
...
//}
//
//function editOpenPerformPage(id) {
//    var params = {
//            caseSourceId : srcCaseId,
//            caseSourceType : srcCaseType,
//            departmentId: departmentId,
...
// * 法院强制执行维护
// */
//function doOpenCountPerformPage(id){
//    var params = {
//        caseSourceId : srcCaseId,
//        caseSourceType : srcCaseType,
//        subjectId : subjectId,
