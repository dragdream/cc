...
<body onload="doInitIndex()" style="padding-right: 10px;padding-left: 10px;padding-top: 5px; min-width: 1130px;">
    <div id="toolbar" class="titlebar clearfix">
        ...
        <div class="fl left">
            ...
            <span class="title">许可办件维护</span>
        </div>
        <!-- 右上角按钮 -->
        <div class="right fr t_btns">
            <button class="easyui-linkbutton" onclick="permissionListAdd()">
                <span style="padding-right: 2px; width: 30px;"><i class="fa fa-plus"></i> 新 增</span>
            </button>
            <button class="easyui-linkbutton" onclick="permissionListBatchDelete()">
    ...
    <script type="text/javascript" src="<%=contextPath%>/supervise/permission/js/permission_list_index.js"></script>
</body>
</html>