...
function doSearchAddPower() {
    ...
    $('#select_permission_item_add_power_table').datagrid('reload', params)
}

function doInitAddPowerDataGird(params) {
    datagrid = $('#select_permission_item_add_power_table').datagrid({
...
function getSelectedPower() {
    var formalPowers = $('#select_permission_item_add_power_table').datagrid('getSelections');
    return formalPowers;
}