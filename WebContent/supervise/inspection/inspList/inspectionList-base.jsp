...
<script type="text/javascript" src="<%=contextPath%>/supervise/inspection/inspList/js/inspectionList-base.js"></script>
...
<body onload="doInit()" style=" padding-left: 10px; padding-right: 10px; padding-top: 5px">
    ...
    <div id="outwarp">
        <div class="fl left">
            ...
            <span class="title">检查单模版维护</span>
        </div>
        <div class="fr">
            <button class="easyui-linkbutton" onclick="doOpenInputPage(0)"><i class="fa fa-plus"></i>&nbsp;新增</button>
...
<!--             &nbsp;&nbsp; -->
        ...
        <div>
            模版名称：<input type="text" id='inspListName' name='inspListName' class="easyui-textbox"  />
