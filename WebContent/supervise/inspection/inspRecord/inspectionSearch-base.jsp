...
<script type="text/javascript" src="<%=contextPath%>/supervise/inspection/inspRecord/js/inspectionSearch-base.js"></script>
...
<body onload="doInit()" style=" padding-left: 10px; padding-right: 10px; padding-top: 5px">
    <div id="toolbar" class="titlebar clearfix">
        ...
        <div class="fl left">
            ...
            <span class="title">检查单查询</span>
        </div>
        <div class="fr">
            <!-- <button class="easyui-linkbutton" onclick="doOpenInputPage()"><i class="fa fa-plus"></i>&nbsp;新增</button> -->
            &nbsp;&nbsp;
<!--            <button class="easyui-linkbutton" ><i class="fa fa-pencil"></i>删除</button> -->
        </div>
        </div>
