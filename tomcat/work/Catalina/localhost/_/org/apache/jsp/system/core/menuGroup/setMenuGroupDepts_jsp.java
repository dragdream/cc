...
public final class setMenuGroupDepts_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(cookie!=null){
	skinNew = cookie.getValue();
      ...
      out.write(".ztree li span.unit_ico_open:before, .ztree li span.unit_ico_close:before, .ztree li span.unit_ico_docu:before {content: \"\\f19c\";font-size:120%;} \r\n");
      out.write(".ztree li span.dept_ico_open:before, .ztree li span.dept_ico_close:before, .ztree li span.dept_ico_docu:before {content: \"\\f0c0\";font-size:120%;} \r\n");
      out.write("\r\n");
      out.write("</style>\r\n");
      out.write("<script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\r\n");
      out.write("\tvar url = contextPath +  \"/teeMenuGroup/getOrgTreeByLoginPerson.action\";\r\n");
      ...
      out.write("\t\t};\r\n");
      out.write("\t\r\n");
      out.write("\tvar zNodes = jsonRs.rtData;\r\n");
      out.write("\r\n");
      ...
      out.write("\tvar zTreeObj = $.fn.zTree.getZTreeObj(\"tree\");  \r\n");
      ...
      out.write("\tvar jsonObj = tools.requestJsonRs(url,{groupId:uuid,deptsIdStr:checkedIdArr.join(\",\")});\r\n");
      ...
      out.write("\t<div class='zTreeBackground'>\r\n");
