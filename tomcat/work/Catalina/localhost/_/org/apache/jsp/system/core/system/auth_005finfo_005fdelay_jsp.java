...
public final class auth_005finfo_005fdelay_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(cookie!=null){
	...
	Map<String,String> delayInfo = TeeAuthUtil.getDelayInfo();
      ...
      out.write("\t   <img class=\"title_img\" src=\"/system/core/system/imgs/icon_yqsqxx.png\" alt=\"\">\r\n");
      out.write("\t   &nbsp;<span class=\"title\">延期授权信息</span>\r\n");
      out.write("\t   \r\n");
      out.write("\t   <button class=\"btn-win-white fr\" onclick=\"window.location='auth_info.jsp'\">返回</button>\t   \r\n");
      out.write("\t</div>\r\n");
      out.write("\r\n");
      out.write("\t<table class=\"TableBlock_page\" style=\"width:100%\">\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td>授权机器码：</td>\r\n");
      out.write("\t\t\t<td>");
      out.print(delayInfo==null?"":delayInfo.get("machineCode"));
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td>试用开始日期：</td>\r\n");
      out.write("\t\t\t<td>");
      out.print(delayInfo==null?"":delayInfo.get("beginTime"));
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td>试用结束日期：</td>\r\n");
      out.write("\t\t\t<td>");
      out.print(delayInfo==null?"":delayInfo.get("endTime"));
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td>移动端人数限制：</td>\r\n");
      out.write("\t\t\t<td>");
      out.print(delayInfo==null?"30":delayInfo.get("imLimit"));
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td>即时通讯PC端人数限制：</td>\r\n");
      out.write("\t\t\t<td>");
      out.print(delayInfo==null?"30":delayInfo.get("pcLimit"));
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td>OA用户数限制：</td>\r\n");
      out.write("\t\t\t<td>");
      out.print(delayInfo==null?"30":delayInfo.get("personLimit"));
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<td>上传延期文件：</td>\r\n");
      out.write("\t\t\t<td style=\"text-align:left\">\r\n");
      out.write("\t\t\t\t<form action=\"");
      out.print(contextPath );
      out.write("/registAuth/uploadDelayFile.action\" method=\"post\" enctype=\"multipart/form-data\">\r\n");
