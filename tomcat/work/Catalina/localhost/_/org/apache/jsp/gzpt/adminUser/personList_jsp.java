...
if(__cookie!=null){
	__skinNew = __cookie.getValue();
      ...
      out.write("\t\t\turl: contextPath + '/personManager/getPersonList.action?sort=userNo&isAdmin=1&deptId=' + deptId,\r\n");
      ...
      out.write("\tvar url = \"");
      out.print(contextPath );
      out.write("/gzpt/adminUser/addupdate.jsp?deptId=\" + deptId + \"&deptName=\" + encodeURIComponent(deptName);\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("function toAddUpdatePerson(personUuid){\r\n");
      out.write("\tvar url = contextPath +  \"/gzpt/adminUser/addupdate.jsp?uuid=\" + personUuid ;\r\n");
      out.write("\t//openWindow(url,\"addupdatePerson\",870,540);\r\n");
      out.write("\twindow.parent.changePage(url);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
