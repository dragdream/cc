...
public final class acceptencelist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(__cookie!=null){
	__skinNew = __cookie.getValue();
      ...
      out.write("\t<link rel=\"stylesheet\" type=\"text/css\" href=\"/xzfy/css/iconfont.css\" />\r\n");
      out.write("</head>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t 申请人：\r\n");
      out.write("\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t<input class=\"BigInput\" type=\"text\" name=\"name\" id=\"name\" onkeyup=\"this.value=this.value.replace(/[^\\u4e00-\\u9fa5a-zA-Z0-9\\w]/g,'')\"/>\r\n");
      out.write("\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<span class='form-item'>\r\n");
      out.write("\t\t\t\t\t\t\t<span class='form-label'>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t申请日期：\r\n");
      out.write("\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"beginTime\" id=\"beginTime\" readonly onclick=\"WdatePicker({dateFmt:'yyyy-MM-dd'})\" class=\"date-input\"\r\n");
      out.write("\t\t\t\t\t\t\t /> &nbsp;至\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t 审批状态：\r\n");
      out.write("\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t<select class=\"BigInput\" id=\"approveType\" name=\"approveType\" >\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"\">---请选择---</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"0\">未审批</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=\"1\">审批中</option>\r\n");
      ...
      out.write("\t   \t<span id=\"needDeal\" class='actived-tables' onclick=\"change(this,'1')\">我的待办</span>\r\n");
      out.write("\t   \t<span id=\"alreadyDeal\" class='case-tab' onclick=\"change(this,'0')\">我的已办</span>\r\n");
      out.write("   \t</div> -->\r\n");
      out.write("\t\r\n");
      out.write("    <table id=\"datagrid\" fit=\"true\" ></table> \r\n");
      out.write("    \r\n");
      out.write("    <iframe id=\"exportIframe\" style=\"display:none\"></iframe>\r\n");
      out.write("    <script type=\"text/javascript\" src=\"/xzfy/js/caseAcceptence/acceptencelist.js\"></script>\r\n");
      out.write("\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
