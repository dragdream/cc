...
if(__cookie!=null){
	__skinNew = __cookie.getValue();
      ...
      out.write("\t<title>组织机构人员列表</title>\r\n");
      ...
      out.write("\t\t    <span class=\"title\">组织机构人员列表 </span>\r\n");
      out.write("\t    </div>\r\n");
      ...
      out.write("\t \t\t\t\t<tr>\r\n");
      out.write("\t \t\t\t\t\t<td class=\"TableData TableBG\">姓名：</td>\r\n");
      ...
      out.write("\t \t\t\t\t\t</td>\r\n");
      out.write("\t \t\t\t\t\t<td class=\"TableData TableBG\" >职级：</td>\r\n");
      out.write(" \t\t\t\t\t\t<td class=\"TableData\">\r\n");
      out.write("\t \t\t\t\t\t\t<select class=\"BigSelect\" id=\"staffing\" name=\"staffing\">\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t \t\t\t\t\t</td>\r\n");
      out.write("\t \t\t\t\t\t<td class=\"TableData\">是否显示全部:</td>\r\n");
      out.write("\t \t\t\t\t\t<td class=\"TableData\">\r\n");
      out.write("\t \t\t\t\t\t\t<input type=\"checkbox\" name=\"isShowAll\" id=\"isShowAll\" value=\"1\">\r\n");
      out.write("\t \t\t\t\t\t</td>\r\n");
      out.write("\t \t\t\t\t\t\r\n");
      ...
      out.write("    <script type=\"text/javascript\" src=\"/xzfy/js/organperson/personlist.js\"></script>\r\n");
      out.write("    \r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
