package org.apache.jsp.xzfy.jsp.caseClose;
...
public final class closelist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(__cookie!=null){
	__skinNew = __cookie.getValue();
      ...
      out.write("   \t\t\t<input type=\"button\" class=\"btn-win-white\" onclick=\"batchClose()\" value=\"批量结案\"/>\r\n");
      out.write("\t    </div>\r\n");
      ...
      out.write("    <script type=\"text/javascript\" src=\"/xzfy/js/caseClose/closelist.js\"></script>\r\n");
      out.write("    \r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
