package org.apache.jsp.xzfy.jsp.organperson;
...
if(cookie!=null){
	skinNew = cookie.getValue();
      ...
      out.write("            </tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\" style=\"text-indent: 10px\">组织机构：</td>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\">\r\n");
      out.write("\t\t\t\t    <input type=\"hidden\" id=\"personId\" name=\"personId\" />\r\n");
      out.write("\t\t\t\t    <input type=\"hidden\" id=\"orgId\" name=\"orgId\" />\r\n");
      out.write("\t\t\t\t    <input type=\"text\" name=\"orgName\" id=\"orgName\" maxlength=\"3\"\r\n");
      out.write("\t\t\t\t        class=\"easyui-validatebox BigInput\" size=\"10\"\r\n");
      out.write("\t\t\t\t\t    required=\"true\" readonly=\"readonly\" />\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("                <td nowrap class=\"TableData\" style=\"text-indent: 10px\">姓名：</td>\r\n");
      out.write("                <td nowrap class=\"TableData\">\r\n");
      out.write("                \t<input type=\"text\" name=\"personName\" id=\"personName\" \r\n");
      out.write("                \t    class=\"easyui-validatebox BigInput\" \r\n");
      out.write("                \t    required=\"true\" validType=\"personNameCheck\"/>\r\n");
      out.write("                </td>\r\n");
      out.write("            </tr>\r\n");
      out.write("            \r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\" style=\"text-indent: 10px\">性别：</td>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\">\r\n");
      out.write("\t\t\t\t\t<select class=\"easyui-validatebox BigSelect\" name=\"sex\" id=\"sex\" required=\"true\">\r\n");
      out.write("\t\t\t\t\t\t<option value=\"\">--请选择--</option>\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\" style=\"text-indent: 10px\">身份证：</td>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"idCard\" id=\"idCard\" size=\"25\" maxlength=\"18\" \r\n");
      out.write("\t\t\t\t\t    class=\"easyui-validatebox BigInput\" \r\n");
      out.write("\t\t\t\t\t    required=\"true\" validType=\"idCardCheck\" />&nbsp;\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\" style=\"text-indent: 10px\">人员编制：</td>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\">\r\n");
      out.write("                    <input id=\"staffingName\" name=\"staffingName\"  type=\"hidden\"/>\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<select class=\"easyui-validatebox BigSelect\" name=\"staffing\" id=\"staffing\" required=\"true\">\r\n");
      out.write("\t\t\t\t\t\t<option value=\"\">--请选择--</option>\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\" style=\"text-indent: 10px\">职级：</td>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\">\r\n");
      out.write("                    <input id=\"levelName\" name=\"levelName\"  type=\"hidden\"/>\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<select class=\"easyui-validatebox BigSelect\" name=\"levelCode\" id=\"levelCode\" required=\"true\">\r\n");
      out.write("\t\t\t\t\t\t<option value=\"\">--请选择--</option>\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\" style=\"text-indent: 10px\">学历：</td>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\">\r\n");
      out.write("                    <input id=\"easyui-validatebox educationName\" name=\"educationName\"  type=\"hidden\"/>\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<select class=\"easyui-validatebox BigSelect\" name=\"educationCode\" id=\"educationCode\" required=\"true\">\r\n");
      out.write("\t\t\t\t\t\t<option value=\"\">--请选择--</option>\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\" style=\"text-indent: 10px\">是否获取法律证书：</td>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\">\r\n");
      out.write("\t\t\t\t\t<label class=\"btn btn-default\" >\r\n");
      out.write("\t\t\t\t    \t<input type=\"radio\" name=\"isLaw\" id=\"option1\" value=\"1\" checked=\"checked\"/>是\r\n");
      out.write("\t\t\t\t  \t</label>\r\n");
      out.write("\t\t\t\t \t<label class=\"btn btn-default\" >\r\n");
      out.write("\t\t\t\t    \t<input type=\"radio\" name=\"isLaw\" id=\"option2\" value=\"0\" />否\r\n");
      out.write("\t\t\t\t  \t</label>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\" style=\"text-indent: 10px\">是否党员：</td>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\">\r\n");
      out.write("\t\t\t\t\t<label class=\"btn btn-default\" >\r\n");
      out.write("\t\t\t\t    \t<input type=\"radio\" name=\"isParty\" id=\"option1\" value=\"1\" checked=\"checked\"/>是\r\n");
      out.write("\t\t\t\t  \t</label>\r\n");
      out.write("\t\t\t\t \t<label class=\"btn btn-default\" >\r\n");
      out.write("\t\t\t\t    \t<input type=\"radio\" name=\"isParty\" id=\"option2\" value=\"0\" />否\r\n");
      out.write("\t\t\t\t  \t</label>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t    class=\"easyui-validatebox BigInput\"\r\n");
      out.write("\t\t\t\t    required=\"true\" validType=\"phoneCheck\" />&nbsp;\r\n");
      out.write("               </td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td nowrap class=\"TableData\" style=\"text-indent: 10px\">邮箱：</td>\r\n");
      out.write("\t\t\t\t<td class=\"TableData\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"email\" id=\"email\" class=\"BigInput\" />&nbsp;\r\n");
      out.write("               </td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t<!--  \r\n");
      out.write("\t\t\t\t\t<span id=\"deleteDeptSpan\" style=\"display:none;\"> \r\n");
      out.write("\t\t\t\t\t    <input type=\"button\" value=\"删除当前部门/下级部门\" \r\n");
      out.write("\t\t\t\t\t        class=\"btn-win-white\" onclick=\"deleteDeptAndSubDept();\"/>&nbsp;&nbsp;  \r\n");
      out.write("\t\t\t\t\t</span>-->\r\n");
      out.write("\t\t\t\t  </div>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t</form>\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"/xzfy/js/organperson/addupdate.js\"></script>\r\n");
      out.write("\t<script type=\"text/javascript\" src=\"/xzfy/js/organperson/check.js\"></script>\r\n");
      out.write("</body>\r\n");
      out.write("\r\n");
      out.write("</html>");
    } catch (Throwable t) {
