...
public final class result_005fsuccess_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(cookie!=null){
	skinNew = cookie.getValue();
      ...
      out.write("<style>\r\n");
      out.write("td{\r\n");
      out.write("border:1px solid #dddad5;\r\n");
      out.write("}\r\n");
      out.write("</style>\r\n");
      out.write("<script>\r\n");
      out.write("function doInit(){\r\n");
      out.write("\tmessageMsg(\"已提交授权文件，请<a href='index.jsp' target='_top'>返回登录页面</a>重新登录。\",\"mess\",\"info\");\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("</head>\r\n");
      out.write("<body id=\"content\" onload=\"doInit()\">\r\n");
      out.write("\t<div id=\"mess\" style=\"padding-top: 20px\"></div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>\r\n");
    } catch (Throwable t) {
