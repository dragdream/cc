...
if(cookie!=null){
	skinNew = cookie.getValue();
      ...
      out.print(contextPath);
      out.write("/gzpt/adminUser/query.jsp');\r\n");
      ...
      out.write("\t\tchangePage(\"");
      out.print(contextPath);
      out.write("/gzpt/adminUser/personList.jsp?deptId=\" + uuid.split(\";\")[0] + \"&deptName=\" + encodeURIComponent(treeNode.name));\r\n");
      out.write("\t}else if(uuid.split(\";\").length == 2 && uuid.split(\";\")[1] == 'personId'){\r\n");
      out.write("\t\t//parent.personinput.location = \"");
      out.print(contextPath);
      out.write("/gzpt/adminUser/personList.jsp?uuid=\" + uuid.split(\";\")[0] ;\r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t\tchangePage(\"");
      out.print(contextPath);
      out.write("/gzpt/adminUser/personList.jsp?deptId=0&orgId=\"+uuid.split(\";\")[0]+\"&deptName=\" + encodeURIComponent(treeNode.name));\r\n");
      out.write("\t\t\r\n");
      out.write("\t}\r\n");
      out.write("};\r\n");
      out.write("\r\n");
