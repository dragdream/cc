package org.apache.jsp.xzfy.jsp.caseTrial.caseHearing;
...
if(__cookie!=null){
	...
	caseId="e6fb0bc86fad41408384a4f5b89699b5";//测试用例
      ...
      out.write("\t<span class=\"title\" style=\"padding-top: 4px;\">听证管理</span>\r\n");
      ...
      out.write("</div>\r\n");
      out.write("<!-- 这是列表页 -->\t\r\n");
      out.write("<div class=\"easyui-panel case-common-panel-body1\" title=\"听证管理列表\" style=\"width: 100%; margin-bottom: 10px; height: 180px!important;\" id=\"common_case_add_person_div\"\r\n");
      ...
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td nowrap class=\"TableData\"  width=\"15%;\" >听证人：</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"TableData\" width=\"35%;\" >\r\n");
      out.write("\t\t\t\t\t\t<input value=\"\" id=\"hearingWitness\" name=\"hearingWitness\" class=\"BigInput\"  title=\"听证人\"/>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td nowrap class=\"TableData\"  width=\"15%;\" >主持人：</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"TableData\" width=\"35%;\" >\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"presenter\" id=\"presenter\" value=\"\" class=\"BigInput\" style=\"height:25px;width: 174px;\" maxlength=\"100\" title=\"主持人\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td nowrap class=\"TableData\"  width=\"15%;\" >开始时间：<font style='color:red'>*</font></td>\r\n");
      out.write("\t\t\t\t\t<td class=\"TableData\" width=\"35%;\" >\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"startTime\" id=\"startTime\" value=\"\" class=\"easyui-datetimebox easyui-validatebox\" data-options=\"required:true,missingMessage:'请选择开始时间' \"  style=\"height:25px;width: 180px;\" maxlength=\"100\" onfocus=\"WdatePicker({dateFmt:'yyyy-MM-dd'})\" title=\"开始时间\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td nowrap class=\"TableData\"  width=\"15%;\" >结束时间：</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"TableData\" width=\"35%;\" >\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"endTime\" id=\"endTime\" value=\"\" class=\"easyui-datetimebox\" data-options=\"editable:false,\" validType=\"compareTime['#startTime']\" style=\"height:25px;width: 174px;\" maxlength=\"100\" onfocus=\"WdatePicker({dateFmt:'yyyy-MM-dd'})\" title=\"结束时间\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td nowrap class=\"TableData\"  width=\"15%;\" >记录人：</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"TableData\" width=\"35%;\" >\r\n");
      out.write("\t\t\t\t\t\t<input value=\"\" id=\"clerk\" name=\"clerk\" class=\"BigInput\" title=\"记录人\"/>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td nowrap class=\"TableData\"  width=\"15%;\" >听证地点：<font style='color:red'>*</font></td>\r\n");
      out.write("\t\t\t\t\t<td class=\"TableData\" width=\"35%;\" >\r\n");
      out.write("\t\t\t\t\t\t<input value=\"\" id=\"place\" name=\"place\" class=\"BigInput easyui-validatebox\" data-options=\"required:true,missingMessage:'请输入听证地点' \" title=\"听证地点\" style=\"height:25px;width: 174px;\"/>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td nowrap class=\"TableData\"  width=\"15%;\" >参加人名：</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"TableData\" width=\"35%;\" >\r\n");
      out.write("\t\t\t\t\t\t<input value=\"\" id=\"participant\" name=\"participant\" class=\"BigInput\" title=\"参加人名\"/>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td nowrap class=\"TableData\"  width=\"15%;\" >告知权利与义务：</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"TableData\" width=\"35%;\" >\r\n");
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"notice\" id=\"notice\" value=\"\" class=\"BigInput\" style=\"height:25px;width: 174px;\" maxlength=\"100\" title=\"告知权利与义务\">\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t<td nowrap class=\"TableData\"  width=\"15%;\" >是否申请回避：</td>\r\n");
      out.write("\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" name=\"avoid\" value=\"1\">是\r\n");
      out.write("\t\t\t\t\t\t<input type=\"radio\" name=\"avoid\" value=\"0\">否\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td nowrap class=\"TableData\"  width=\"15%;\" >被申请人阐述：</td>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"5\">\r\n");
      out.write("\t\t\t\t\t\t<textarea class=\"textstyle\" style=\"height:40px;width:900px\" data-options=\"multiline:true\" name=\"respondentExposition\" id=\"respondentExposition\" placeholder=\"被申请人阐述\"></textarea>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td nowrap class=\"TableData\"  width=\"15%;\" >申请人阐述：</td>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"5\">\r\n");
      out.write("\t\t\t\t\t\t<textarea class=\"textstyle\" style=\"height:40px;width:900px\" data-options=\"multiline:true\" name=\"applicantExplanation\" id=\"applicantExplanation\" placeholder=\"申请人阐述\"></textarea>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td nowrap class=\"TableData\"  width=\"15%;\" >辩论：</td>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"5\">\r\n");
      out.write("\t\t\t\t\t\t<textarea class=\"textstyle\" style=\"height:40px;width:900px\" data-options=\"multiline:true\" name=\"debate\" id=\"debate\" placeholder=\"辩论\"></textarea>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td nowrap class=\"TableData\"  width=\"15%;\" >质证：</td>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"5\">\r\n");
      out.write("\t\t\t\t\t\t<textarea class=\"textstyle\" style=\"height:40px;width:900px\" data-options=\"multiline:true\" name=\"witness\" id=\"witness\" placeholder=\"质证\"></textarea>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td nowrap class=\"TableData\"  width=\"15%;\" >审查意见：</td>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"5\">\r\n");
      out.write("\t\t\t\t\t\t<textarea class=\"textstyle\" style=\"height:40px;width:900px\" data-options=\"multiline:true\" name=\"result\" id=\"result\" placeholder=\"审查意见\"></textarea>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      ...
      out.write("<script type=\"text/javascript\" src=\"");
      out.print(contextPath );
      out.write("/xzfy/js/caseTrial/caseHearing/caseHearing.js\"></script>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("var title = \"\";\r\n");
      ...
      out.write("\t\turl : '");
      out.print(contextPath);
      out.write("/hearingController/getListByCaseId.action?caseId='+caseId ,\r\n");
      ...
      out.write("    \t\t\t},\r\n");
      out.write("    \t\t {\r\n");
      out.write(" \t\t\t\tfield : 'hearingWitness',\r\n");
      out.write(" \t\t\t\ttitle : '听证人',\r\n");
      out.write(" \t\t\t\twidth : 170,\r\n");
      out.write(" \t\t\t\talign:'center',\r\n");
      out.write(" \t\t\t\t/* formatter:function(value,rowData,rowIndex){\r\n");
      out.write("\t\t\t\t return \"<a style=''  href='javascript:void(0);' onclick='toLook(\"+rowIndex+\")'>\"+rowData.hearingWitness+\"</a>\"; \r\n");
      out.write("\t\t\t} */\r\n");
      out.write("  \t\t },\r\n");
      out.write("\t\t    {\r\n");
      out.write("\t\t\tfield : 'place',\r\n");
      out.write("\t\t\ttitle : '听证地点',\r\n");
      out.write("\t\t\twidth : 120,\r\n");
      out.write("\t\t\talign:'center'\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t    },  \r\n");
      ...
      out.write("\t    //结束时间>起始时间\r\n");
      out.write("\t    compareTime:{\r\n");
      out.write("\t        validator:function(value,param){\r\n");
      out.write("\t            var startTime =$(param[0]).datetimebox('getValue');\r\n");
      out.write("\t            if(startTime<value){\r\n");
      out.write("\t                return true;\r\n");
      out.write("\t            }else{\r\n");
      out.write("\t\t\t\t\talert(\"结束时间应大于开始时间\");\r\n");
      out.write("\t\t\t\t\t//清空该文本框\r\n");
