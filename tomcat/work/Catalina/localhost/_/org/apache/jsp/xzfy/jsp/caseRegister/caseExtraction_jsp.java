...
public final class caseExtraction_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(__cookie!=null){
	__skinNew = __cookie.getValue();
      ...
      out.write("\t \t\t\t\t\t</td>\r\n");
      out.write("\t \t\t\t\t\t\r\n");
      out.write("\t \t\t\t\t\t<td class=\"TableData TableBG\">被申请人：\r\n");
      out.write("\t \t\t\t\t\t    <input class=\"BigInput\" type=\"text\" name=\"respondentName\" id=\"respondentName\"\r\n");
      out.write("\t \t\t\t\t\t        onkeyup=\"this.value=this.value.replace(/[^\\u4e00-\\u9fa5a-zA-Z0-9\\w]/g,'')\" />\r\n");
      out.write("\t \t\t\t\t\t</td>\r\n");
      out.write("\t \t\t\t\t\t\r\n");
      out.write("\t \t\t\t\t\t<td class=\"TableData TableBG\">接待人：\r\n");
      out.write("\t \t\t\t\t\t    <input class=\"BigInput\" type=\"text\" name=\"dealMan1Id\" id=\"dealMan1Id\"\r\n");
      out.write("\t \t\t\t\t\t        onkeyup=\"this.value=this.value.replace(/[^\\u4e00-\\u9fa5a-zA-Z0-9\\w]/g,'')\" />\r\n");
      out.write("\t \t\t\t\t\t</td>\r\n");
      out.write("\t \t\t\t\t\t\r\n");
      out.write("\t \t\t\t\t<tr>\t\r\n");
      ...
      out.write("\t \t\t\t\t\t\r\n");
      out.write("\t \t\t\t\t\t \t<input type=\"text\" name=\"startTime\" id=\"startTime\" readonly onclick=\"WdatePicker({dateFmt:'yyyy-MM-dd'})\" \r\n");
      out.write("\t \t\t\t\t\t \t\tclass=\"Wdate BigInput\" style=\"width:172px;height: 20px\"/>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t<td class=\"TableData TableBG\">结束时间：\r\n");
      out.write("\r\n");
      out.write("\t \t\t\t\t\t\t<input type=\"text\" name=\"endTime\" id=\"endTime\" readonly onclick=\"WdatePicker({minDate:'#F{$dp.$D(\\'startTime\\',{d:0});}',dateFmt:'yyyy-MM-dd'})\" \r\n");
      out.write("\t\t\t\t\t\t\t    class=\"Wdate BigInput\" style=\"width:172px;height: 20px\"/>\r\n");
      out.write("\t \t\t\t\t\t</td>\r\n");
      out.write("\t \t\t\t\t\t\r\n");
      out.write(" \t\t\t\t\t\t<td class=\"TableData\">\r\n");
      out.write(" \t\t\t\t\t\t    <button class=\"btn-win-white\" type=\"button\" onclick=\"search()\">查询</button>&nbsp;\r\n");
      out.write(" \t\t\t\t\t\t    <button class=\"btn-win-white\" type=\"button\" onclick=\"formReset()\">重置</button>&nbsp;\r\n");
      ...
      out.write("    <script type=\"text/javascript\" src=\"/xzfy/js/caseRegister/caseExtraction.js\"></script>\r\n");
      out.write("\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
