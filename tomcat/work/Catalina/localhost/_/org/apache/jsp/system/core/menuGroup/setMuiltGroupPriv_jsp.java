...
public final class setMuiltGroupPriv_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String secUserMem = TeeSysProps.getString("SEC_USER_MEM");
      ...
      out.write("<script type=\"text/javascript\" src=\"");
      out.print(contextPath );
      out.write("/common/jquery/ztree/js/jquery-1.4.4.min.js\"></script>\r\n");
      out.write("<script type=\"text/javascript\" src=\"");
      out.print(contextPath );
      ...
      out.write("\tvar url = \"");
      out.print(contextPath );
      out.write("/teeMenuGroup/getMenuGroupAllPriv.action\";\r\n");
      out.write("\tvar config = {\r\n");
      out.write("\t\t\tzTreeId:\"ztree\",\r\n");
      out.write("\t\t\trequestURL:url,\r\n");
      out.write("\t\t\tcheckController:{\r\n");
      out.write("\t\t\t\tenable : true,\r\n");
      out.write("\t\t\t\tchkboxType: { \"Y\": \"ps\", \"N\": \"s\" }\r\n");
      out.write("               },\r\n");
      ...
      out.write("    var menuGroupOptType = \"0\";\r\n");
      out.write("   \r\n");
      out.write("    if(document.getElementById(\"menuGroupOptType1\").checked == true){\r\n");
      out.write("    \tmenuGroupOptType = \"1\";\r\n");
      out.write("    }\r\n");
      out.write("\tvar menuUuids = getSelectIds();\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\tvar menuGroupStr = getMenuGroupA();\r\n");
      out.write("\tif(menuGroupStr == ''){\r\n");
      out.write("\t\talert(\"请至少选择一个角色权限！\");\r\n");
      out.write("\t\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("\tif(menuUuids==''){\r\n");
      out.write("\t\talert(\"请至少选择一个菜单！\");\r\n");
      out.write("\t\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("\tvar url = \"");
      out.print(contextPath );
      out.write("/teeMenuGroup/setMuiltMenuGroupPriv.action\";\r\n");
      out.write("\tvar jsonObj = tools.requestJsonRs(url,{uuids:menuGroupStr,menuIds:menuUuids,opt:menuGroupOptType});\r\n");
      ...
      out.write("}\r\n");
      out.write("/**\r\n");
      out.write(" * 获取选中所有节点Id\r\n");
      out.write(" */\r\n");
      out.write("function getSelectIds(){\r\n");
      out.write("\tvar id = ZTreeTool.getSelectCheckedNodeIds(true,true);\r\n");
      out.write("\treturn id;\r\n");
      out.write("}\r\n");
      out.write("/**\r\n");
      out.write(" * 获取菜单组\r\n");
      ...
      out.write(" *  滚动条事件\r\n");
      out.write(" */\r\n");
      out.write("window.onscroll = window.onresize = function(){\r\n");
      out.write("\t  var opBtn = document.getElementById(\"OP_BTN\");\r\n");
      out.write("\t  if(!opBtn){\r\n");
      out.write("\t    return false;\r\n");
      out.write("\t  } else {\r\n");
      out.write("\t    opBtn.style.left = (document.documentElement.clientWidth + document.documentElement.scrollLeft - 180) + 'px';\r\n");
      out.write("\t    opBtn.style.top = (document.documentElement.scrollTop + 10) + 'px';\r\n");
      out.write("\t  }\r\n");
      out.write("\t};\r\n");
      out.write("\r\n");
      out.write("</SCRIPT>\r\n");
      ...
      out.print(contextPath );
      out.write("/common/jquery/ztree/css/zTreeStyle/img/diy/1_open.png) no-repeat scroll 0 0 transparent; vertical-align:top; *vertical-align:middle}\r\n");
      out.write(".ztree li span.button.pIcon01_ico_close{margin-right:2px; background: url(");
      out.print(contextPath );
      out.write("/common/jquery/ztree/css/zTreeStyle/img/diy/1_close.png) no-repeat scroll 0 0 transparent; vertical-align:top; *vertical-align:middle}\r\n");
      out.write(".ztree li span.button.pIcon02_ico_open, .ztree li span.button.pIcon02_ico_close{margin-right:2px; background: url");
      out.print(contextPath );
      out.write("/common/jquery/ztree/css/zTreeStyle/img/diy/2.png) no-repeat scroll 0 0 transparent; vertical-align:top; *vertical-align:middle}\r\n");
      out.write(".ztree li span.button.icon01_ico_docu{margin-right:2px; background: url");
      out.print(contextPath );
      out.write("/common/jquery/ztree/css/zTreeStyle/img/diy/3.png) no-repeat scroll 0 0 transparent; vertical-align:top; *vertical-align:middle}\r\n");
      out.write(".ztree li span.button.icon02_ico_docu{margin-right:2px; background: url(");
      out.print(contextPath );
      out.write("/common/jquery/ztree/css/zTreeStyle/img/diy/4.png) no-repeat scroll 0 0 transparent; vertical-align:top; *vertical-align:middle}\r\n");
      out.write(".ztree li span.button.icon03_ico_docu{margin-right:2px; background: url(");
      out.print(contextPath );
      out.write("/common/jquery/ztree/css/zTreeStyle/img/diy/5.png) no-repeat scroll 0 0 transparent; vertical-align:top; *vertical-align:middle}\r\n");
      out.write(".ztree li span.button.icon04_ico_docu{margin-right:2px; background: url(");
      out.print(contextPath );
      out.write("/common/jquery/ztree/css/zTreeStyle/img/diy/6.png) no-repeat scroll 0 0 transparent; vertical-align:top; *vertical-align:middle}\r\n");
      out.write(".ztree li span.button.icon05_ico_docu{margin-right:2px; background: url(");
      out.print(contextPath );
      out.write("/common/jquery/ztree/css/zTreeStyle/img/diy/7.png) no-repeat scroll 0 0 transparent; vertical-align:top; *vertical-align:middle}\r\n");
      out.write(".ztree li span.button.icon06_ico_docu{margin-right:2px; background: url(");
      out.print(contextPath );
      out.write("/common/jquery/ztree/css/zTreeStyle/img/diy/8.png) no-repeat scroll 0 0 transparent; vertical-align:top; *vertical-align:middle}\r\n");
      out.write("\t</style>\r\n");
      out.write("\r\n");
      out.write("</HEAD>\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("<div align=\"\" style=\"padding-top:10px; padding-left:10px;\">\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("<table >\r\n");
      out.write("  <tr>\r\n");
      out.write("    <td>\r\n");
      out.write("  <span class=\"Big3\"> 添加/删除菜单权限</span>&nbsp;&nbsp;\r\n");
      out.write("    </td>\r\n");
      out.write("    <td align=\"right\">\r\n");
      out.write("    <div id=\"OP_BTN\" style=\"width:150px;top:5px;right:30px;position:absolute;\">\r\n");
      out.write("    <input type=\"button\" value=\"保存\" class=\"btn btn-primary\" title=\"保存\" name=\"button\" onclick=\"doSubmit();\">&nbsp;&nbsp;\r\n");
      out.write("<!--     <input type=\"button\" value=\"返回\" class=\"BigButtonA\" onclick=\"location='manageGroup.jsp'\"> -->\r\n");
      out.write("    </div>\r\n");
      out.write("    \r\n");
      out.write("    </td>\r\n");
      out.write("  </tr>\r\n");
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<table class=\"TableBlock\" width=\"100%\">\r\n");
      out.write("  <tr class=\"TableData\">\r\n");
      out.write("    <td width=\"100px;\">\r\n");
      out.write("     <b>操作：</b>\r\n");
      out.write("    </td>\r\n");
      out.write("    <td >\r\n");
      out.write("<input type=\"radio\" name=\"menuGroupOptType\" id=\"menuGroupOptType0\" value=\"0\" checked/> 添加菜单\r\n");
      out.write("     &nbsp;&nbsp;\r\n");
      out.write("     <input type=\"radio\" name=\"menuGroupOptType\" id=\"menuGroupOptType1\" value=\"1\"/> 删除菜单\r\n");
      out.write("    \r\n");
      out.write("    </td>\r\n");
      out.write("  </tr>\r\n");
      out.write("    <tr class=\"TableData\">\r\n");
      ...
      out.write("</table>\r\n");
      out.write("\r\n");
      out.write("<ul id=\"ztree\" class=\"ztree\" style=\"overflow:hidden;border:0px;background:#ffffff;\" ></ul>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("</BODY>\r\n");
