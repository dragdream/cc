...
if(__cookie!=null){
	__skinNew = __cookie.getValue();
      ...
      out.write("\t    </div>\r\n");
      out.write("\t    <div class = \"right fr clearfix\" id=\"register\" style=\"display: none;\">\r\n");
      ...
      out.write("\t    </div>\r\n");
      out.write("\t    <div class = \"right fr clearfix\" id=\"accept\" style=\"display: none;\">\r\n");
      out.write("\t        <input type=\"button\" class=\"btn-win-white\" onclick=\"mergeCase();\" value=\"并案\"/>&nbsp;\r\n");
      out.write("\t\t\t<input type=\"button\" class=\"btn-win-white\" onclick=\"acceptBace()\" value=\"受理撤回\"/>&nbsp;\r\n");
      out.write("\t\t\t<input type=\"button\" class=\"btn-win-white\" onclick=\"selectNext()\" value=\"选择审理人\"/>&nbsp;\r\n");
      out.write("   \t\t\t<input type=\"button\" class=\"btn-win-white\" onclick=\"changeNext()\" value=\"变更承办人\"/>&nbsp;\r\n");
      out.write("\t    </div>\r\n");
      out.write("\t    <div class = \"right fr clearfix\" id=\"trial\" style=\"display: none;\">\r\n");
      out.write("\t        <input type=\"button\" class=\"btn-win-white\" onclick=\"changeNext()\" value=\"变更承办人\"/>&nbsp;\r\n");
      out.write("\t    </div>\r\n");
      ...
      out.write("\t\t\t\t<button id=\"accSerach\" class=\"btn-win-white\" type=\"button\" onclick=\"accSearch()\">精确查询</button>\r\n");
      out.write("\t            <table class=\"none_table\" width=\"100%\" height=\"65\">\r\n");
      out.write("\t            \t<tr id=\"keysearchTr\">\r\n");
      out.write("\t            \t\t<td>关键字：\r\n");
      ...
      out.write("\r\n");
      out.write("\t            \t</tr>\r\n");
      out.write("\t \t\t\t\t<tr id=\"accsearchTr1\" style=\"display: none;\">\r\n");
      out.write("\t \t\t\t\t\t<td>案件编号：\r\n");
      out.write("\t \t\t\t\t\t    <input class=\"BigInput\" type=\"text\" name=\"caseNum\" id=\"caseNum\"\r\n");
      out.write("\t \t\t\t\t\t        onkeyup=\"this.value=this.value.replace(/[^\\u4e00-\\u9fa5a-zA-Z0-9\\w]/g,'')\" />\r\n");
      out.write("\t \t\t\t\t\t</td>\r\n");
      out.write("\t \t\t\t\t\t<td >案件状态：\r\n");
      out.write("\t \t\t\t\t\t\t<select class=\"BigSelect\" id=\"caseStatus\" name=\"caseStatus\">\r\n");
      ...
      out.write("\t \t\t\t\t\t</td>\r\n");
      out.write("\t \t\t\t\t</tr>\t\r\n");
      out.write("\t \t\t\t\t<tr id=\"accsearchTr2\" style=\"display: none;\">\t\r\n");
      out.write("\t \t\t\t\t\t<td>开始时间：\r\n");
      out.write("\t \t\t\t\t\t\r\n");
      ...
      out.write("\t\t<div class=\"\" style=\"padding-top: 5px;display:inline-block;\">\r\n");
      out.write("            <span style=\"float:left;height: 26px;line-height: 26px;margin:4px;\">&nbsp;已选条件：</span>\r\n");
      out.write("            <span id=\"condition\"></span>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div id=\"optionCom\" >\r\n");
      out.write("            <span class=\"isshow\"><i class=\"optional fa fa-bars fa-lg\"></i>可选列  </span> \r\n");
      out.write("            <span class=\"tip\">可根据需要\"隐藏/显示\"所选列</span> \r\n");
      out.write("            <ul class=\"panList\"></ul>\r\n");
      out.write("        </div>\r\n");
      out.write("   \t</div>\r\n");
      ...
      out.write("    <script type=\"text/javascript\" src=\"/xzfy/js/caseList/caselist.js\"></script>\r\n");
      out.write("   <!--  \r\n");
      out.write("    <script type=\"text/javascript\" src=\"/xzfy/js/caseTrial/trial.js\"></script>\r\n");
      out.write("    -->\r\n");
      out.write("    \r\n");
      out.write("</body>\r\n");
      out.write("</html>");
