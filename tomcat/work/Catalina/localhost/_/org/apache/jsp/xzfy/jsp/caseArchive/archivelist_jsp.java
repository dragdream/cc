package org.apache.jsp.xzfy.jsp.caseArchive;
...
public final class archivelist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(__cookie!=null){
	__skinNew = __cookie.getValue();
      ...
      out.write("\t\t    <span class=\"title\">受理列表 </span>\r\n");
      out.write("\t    </div>\r\n");
      out.write("\t    <div class = \"right fr clearfix\">\r\n");
      out.write("   \t\t\t<input type=\"button\" class=\"btn-win-white\" onclick=\"batchArchive()\" value=\"批量全卷归档\"/>\r\n");
      out.write("\t    </div>\r\n");
      ...
      out.write("\t \t\t\t\t\t\t<select class=\"BigSelect\" id=\"postType\" name=\"postType\">\r\n");
      ...
      out.write("\t \t\t\t\t\t \t\tclass=\"Wdate BigInput\" style=\"width:100px;height: 20px\"/>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      ...
      out.write("    <script type=\"text/javascript\" src=\"/xzfy/js/caseArchive/archivelist.js\"></script>\r\n");
      out.write("    \r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
