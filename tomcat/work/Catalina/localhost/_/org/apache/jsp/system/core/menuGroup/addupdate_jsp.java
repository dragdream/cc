...
public final class addupdate_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  String uuid = request.getParameter("uuid") == null ? "" : request.getParameter("uuid");
      ...
      out.print(uuid);
      out.write("';\r\n");
      out.write("var parentWindowObj = window.dialogArguments;\r\n");
      out.write("function doInit(){\r\n");
      out.write("\t//添加例子一\r\n");
      out.write("\tif(uuid != \"\"){\r\n");
      out.write("\t\tvar url = \"");
      out.print(contextPath );
      out.write("/teeMenuGroup/getMenuGroup.action\";\r\n");
      ...
      out.write("\t//parentWindowObj.window.location = parentWindowObj.window.location ;\r\n");
      out.write("\tCloseWindow();\r\n");
      out.write("}\r\n");
      ...
      out.write("\t\t<td>\r\n");
      out.write("\t       <select class=\"BigSelect\" id=\"menuGroupType\" name=\"menuGroupType\">\r\n");
      out.write("\t         <option value=\"00\">其他</option>\r\n");
      out.write("\t         <option value=\"01\">执法</option>\r\n");
      out.write("\t         <option value=\"02\">监督</option>\r\n");
      out.write("\t         <option value=\"03\">复议</option>\r\n");
      out.write("\t       </select>\r\n");
      out.write("\t    </td>\r\n");
      out.write("\t  </tr>\r\n");
      out.write("\t  <tr class=\"TableData\">\r\n");
      out.write("\t\t<td>权限名称</td>\r\n");
      out.write("\t\t<td><input type=\"text\" name=\"menuGroupName\" class=\"easyui-validatebox BigInput\" required=\"true\"  maxlength=\"100\"/></td>\r\n");
      out.write("\t  </tr>\r\n");
      out.write("\t  <tr  class=\"TableData\">\r\n");
      out.write("\t    <td>权限排序</td> \r\n");
      out.write("\t\t<td><input  type=\"text\" name=\"menuGroupNo\" class=\"easyui-validatebox BigInput\"  required=\"true\"   maxlength=\"3\" maxlengthvalidType ='positivIntege[]'/>整数类型</td>\r\n");
      out.write("\t  </tr>\r\n");
      out.write("      <tr  class=\"TableData\">\r\n");
      out.write("\t    <td colspan=\"2\" align=\"center\"><input type=\"button\" value=\"保存\" class=\"btn btn-primary\" onclick=\"doSave();\">&nbsp;&nbsp;\r\n");
      out.write("\t\t  <input type=\"text\" id=\"uuid\" name=\"uuid\" style=\"display:none;\" value='0'/>\r\n");
      out.write("\t      <input type=\"button\" value=\"关闭\" class=\"btn btn-primary\" onclick=\"closeWindow();\">&nbsp;&nbsp;\r\n");
      out.write("\t    </td>\r\n");
      out.write("\t   </tr>\r\n");
      out.write("\t </table>\r\n");
      out.write("   </form>\r\n");
