...
if(cookie!=null){
	skinNew = cookie.getValue();
      ...
      out.write("\t<link rel=\"stylesheet\" type=\"text/css\" href=\"/xzfy/css/organ/organ.css\" />\r\n");
      out.write("</head>\r\n");
      out.write("<body onload=\"doInit()\" style=\"overflow:hidden;font-size:12px;\">\r\n");
      out.write("<div id=\"layout\" >\r\n");
      out.write("\r\n");
      out.write("\t<iframe id=\"frame\" frameborder=0 style=\"width:100%;height:880px;\"></iframe>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t//创建组织机构树\r\n");
      out.write("\t$(\"#frame\").attr(\"src\", '/xzfy/jsp/organ/tree.jsp?type=2');\r\n");
      out.write("\t//获取组织机构列表\r\n");
      out.write("\t$(\"#frame0\").attr(\"src\", '/xzfy/jsp/organperson/personlist.jsp');\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
