...
public final class organlist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(__cookie!=null){
	__skinNew = __cookie.getValue();
      ...
      out.write("\t\t    <span class=\"title\">机构列表 </span>\r\n");
      out.write("\t    </div>\r\n");
      ...
      out.write("\t            <input type=\"hidden\" id=\"treeId\" value=\"\" >\r\n");
      out.write("\t            <table class=\"none_table\" width=\"100%\">\r\n");
      out.write("\t \t\t\t\t<tr>\r\n");
      out.write("\t \t\t\t\t\t<td class=\"TableData TableBG\" >机关层级：</td>\r\n");
      out.write(" \t\t\t\t\t\t<td class=\"TableData\">\r\n");
      out.write("\t \t\t\t\t\t\t<select class=\"BigSelect\" id=\"organLevel\" name=\"organLevel\">\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t \t\t\t\t\t</td>\r\n");
      out.write("\t \t\t\t\t\t<td class=\"TableData TableBG\">机关名称：</td>\r\n");
      out.write("\t \t\t\t\t\t<td class=\"TableData\">\r\n");
      out.write("\t \t\t\t\t\t    <input class=\"BigInput\" type=\"text\" name=\"organName\" id=\"organName\"\r\n");
      out.write("\t \t\t\t\t\t        onkeyup=\"this.value=this.value.replace(/[^\\u4e00-\\u9fa5a-zA-Z0-9\\w]/g,'')\" />\r\n");
      out.write("\t \t\t\t\t\t</td>\r\n");
      out.write("\t \t\t\t\t\t<td class=\"TableData TableBG\">联系人：</td>\r\n");
      out.write("\t \t\t\t\t\t<td class=\"TableData\">\r\n");
      out.write("\t \t\t\t\t\t    <input class=\"BigInput\" type=\"text\" name=\"contacts\" id=\"contacts\"\r\n");
      out.write("\t \t\t\t\t\t        onkeyup=\"this.value=this.value.replace(/[^\\u4e00-\\u9fa5a-zA-Z0-9\\w]/g,'')\" />\r\n");
      out.write("\t \t\t\t\t\t</td>\r\n");
      out.write("\t \t\t\t\t\t\r\n");
      ...
      out.write("    <script type=\"text/javascript\" src=\"/xzfy/js/organ/organlist.js\"></script>\r\n");
      out.write("    \r\n");
      out.write("</body>\r\n");
      out.write("</html>");
    } catch (Throwable t) {
